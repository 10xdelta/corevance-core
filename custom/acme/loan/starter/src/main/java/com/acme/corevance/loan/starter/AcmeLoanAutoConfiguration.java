...
import com.acme.corevance.loan.processor.AcmeLoanRepaymentScheduleTransactionProcessor;
...
@AutoConfiguration
@ComponentScan(basePackages = { "com.acme.corevance.loan.cob", "com.acme.corevance.loan.processor", "com.acme.corevance.loan.job" })
