...
import com.corevance.command.test.sample.data.DummyError;
...
public class DummyExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleRuntimeException(Throwable ex) {
        ...
        problemDetails.setType(URI.create("https://corevance.apache.org/validation"));
        problemDetails.setTitle(messageSource.getMessage("com.corevance.common.validation.error", null, Locale.US)); // TODO:
                                                                                                                           // check
                                                                                                                           // this,
                                                                                                                           // get
                                                                                                                           // locale
