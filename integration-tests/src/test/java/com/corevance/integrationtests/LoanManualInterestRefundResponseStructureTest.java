...
import com.corevance.integrationtests.client.feign.modules.LoanTestData.SupportedInterestRefundTypesItem;
...
public class LoanManualInterestRefundResponseStructureTest extends FeignLoanTestBase {
    ...
    private PostLoansLoanIdTransactionsResponse makeLoanMerchantIssuedRefund(Long loanId, String transactionDate, Double amount) {
        com.corevance.client.models.PostLoansLoanIdTransactionsRequest request = new com.corevance.client.models.PostLoansLoanIdTransactionsRequest()
