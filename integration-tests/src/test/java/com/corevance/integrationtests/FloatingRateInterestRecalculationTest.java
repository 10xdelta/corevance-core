...
import com.corevance.client.models.FloatingRatePeriodRequest;
import com.corevance.client.models.FloatingRateRequest;
...
import com.corevance.client.models.PostFloatingRatesResponse;
 ...
 * with Floating Rates.
 *
 * @see com.corevance.portfolio.loanaccount.loanschedule.domain.LoanApplicationTerms#updateAnnualNominalInterestRate
 */
public class FloatingRateInterestRecalculationTest extends FeignLoanTestBase {
    ...
    private Long createFloatingRate() {
        ...
        PostFloatingRatesResponse response = ok(() -> corevanceClient().floatingRates().createFloatingRate(floatingRateRequest));
