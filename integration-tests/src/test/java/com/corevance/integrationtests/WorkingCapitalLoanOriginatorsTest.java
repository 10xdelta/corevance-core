...
import com.corevance.client.models.LoanOriginatorData;
...
import com.corevance.integrationtests.client.feign.helpers.WorkingCapitalLoanOriginatorHelper;
...
public class WorkingCapitalLoanOriginatorsTest {
    ...
    public void testUserWithoutPermissionsCannotAttachOrDetachOriginator() {
        ...
        final CorevanceFeignClient userClient = CorevanceFeignClientHelper.createNewCorevanceFeignClient(username, password);
