...
import com.corevance.integrationtests.guarantor.GuarantorHelper;
import com.corevance.integrationtests.guarantor.GuarantorTestBuilder;
...
public class GroupSavingsIntegrationTest {
    ...
    public void testOnHoldTransactionsApiForGroupSavingsAccount() {
        ...
        // Note: Using 0,0,0 to bypass bug COREVANCE-2476 where group accounts can't be guarantors
        ...
        final String ON_HOLD_TRANSACTIONS_URL = "/corevance-provider/api/v1/savingsaccounts/" + savingsId + "/onholdtransactions?"
    ...
    public void testGroupAccountAvailableBalance() {
        ...
        final String GROUP_ACCOUNTS_URL = "/corevance-provider/api/v1/groups/" + groupID + "/accounts?" + Utils.TENANT_IDENTIFIER;
