...
import static com.corevance.infrastructure.core.domain.AuditableFieldsConstants.CREATED_BY;
import static com.corevance.infrastructure.core.domain.AuditableFieldsConstants.CREATED_DATE;
import static com.corevance.infrastructure.core.domain.AuditableFieldsConstants.LAST_MODIFIED_BY;
import static com.corevance.infrastructure.core.domain.AuditableFieldsConstants.LAST_MODIFIED_DATE;
...
import com.corevance.integrationtests.client.feign.helpers.FeignRawHttpHelper;
...
public class LoanTransactionAuditingIntegrationTest extends FeignLoanTestBase {
    ...
    public void checkAuditDates() throws InterruptedException {
        ...
        com.corevance.integrationtests.common.loans.LoanTransactionHelper restTxHelper = new com.corevance.integrationtests.common.loans.LoanTransactionHelper(
    ...
    private Long createLoanProduct(final String inMultiplesOf, final String digitsAfterDecimal, final String repaymentStrategy,
        ...
        final com.corevance.integrationtests.common.accounting.Account assetAccount = getAccounts().getLoansReceivableAccount();
        final com.corevance.integrationtests.common.accounting.Account incomeAccount = getAccounts().getInterestIncomeAccount();
        final com.corevance.integrationtests.common.accounting.Account expenseAccount = getAccounts().getChargeOffExpenseAccount();
        final com.corevance.integrationtests.common.accounting.Account overpaymentAccount = getAccounts().getOverpaymentAccount();
        ...
        final String loanProductJSON = new LoanProductTestBuilder() //
                ...
                .withAccounting(accountingRule, new com.corevance.integrationtests.common.accounting.Account[] { assetAccount,
