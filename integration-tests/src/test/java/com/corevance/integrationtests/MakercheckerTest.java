...
import com.corevance.client.models.PutPermissionsRequest;
import com.corevance.infrastructure.configuration.api.GlobalConfigurationConstants;
import com.corevance.integrationtests.common.AuditHelper;
...
import com.corevance.integrationtests.common.commands.MakercheckersHelper;
...
public class MakercheckerTest {
    ...
    public void testRejectDatatableCreationCleansUpOrphanedTable(String apptableName) {
        ...
        try {
            ...
            MakercheckersHelper.rejectMakerCheckerEntry(CorevanceClientHelper.createNewCorevanceClient(checker, "A1b2c3d4e5f$"), commandId);
