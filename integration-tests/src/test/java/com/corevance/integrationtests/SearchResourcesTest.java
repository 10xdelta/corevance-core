...
import com.corevance.client.models.GetSearchResponse;
import com.corevance.client.models.PostClientsResponse;
import com.corevance.integrationtests.client.feign.helpers.FeignSearchHelper;
...
public class SearchResourcesTest {
    ...
    public void setup() {
        ...
        this.searchHelper = new FeignSearchHelper(CorevanceFeignClientHelper.getCorevanceFeignClient());
    }
