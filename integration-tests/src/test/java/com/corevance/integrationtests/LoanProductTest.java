...
import com.corevance.client.models.GetChargeOffReasonToExpenseAccountMappings;
...
import com.corevance.client.models.GetLoanProductsWriteOffReasonOptions;
...
public class LoanProductTest extends BaseLoanIntegrationTest {
    ...
    private Long createTestWriteOffReason() {
        PostCodeValueDataResponse response = okR(CorevanceClientHelper.getCorevanceClient().codeValues.createCodeValue(26L,
