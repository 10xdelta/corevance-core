...
import com.corevance.integrationtests.client.feign.helpers.FeignGroupCenterHelper;
import com.corevance.integrationtests.client.feign.helpers.FeignOfficeHelper;
...
import com.corevance.integrationtests.common.CalendarHelper;
...
public class LoanReschedulingWithinCenterTest extends FeignLoanTestBase {
    ...
    public static void setupOfficeHelper() {
        officeHelper = new FeignOfficeHelper(CorevanceFeignClientHelper.getCorevanceFeignClient());
    }
