 ...
 * under the License.
 */
package com.corevance.integrationtests.useradministration.users;
...
public final class UserHelper {
    ...
    private static final String CREATE_USER_URL = "/corevance-provider/api/v1/users?" + Utils.TENANT_IDENTIFIER;
    private static final String USER_URL = "/corevance-provider/api/v1/users";
