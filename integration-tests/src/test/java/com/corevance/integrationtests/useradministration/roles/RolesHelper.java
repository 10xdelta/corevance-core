 ...
 * under the License.
 */
package com.corevance.integrationtests.useradministration.roles;
...
import com.corevance.useradministration.data.PermissionData;
...
public final class RolesHelper {
    ...
    private static final String CREATE_ROLE_URL = "/corevance-provider/api/v1/roles?" + Utils.TENANT_IDENTIFIER;
    private static final String ROLE_URL = "/corevance-provider/api/v1/roles";
    private static final String PERMISSIONS_URL = "/corevance-provider/api/v1/permissions";
    ...
    public static HashMap<String, Object> getRoleDetails(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String GET_ROLE_URL = "/corevance-provider/api/v1/roles/" + roleId + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public CommandProcessingResult updatePermissions(PutPermissionsRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().permissions.updatePermissions(request));
    }
