...
import com.corevance.integrationtests.common.workingcapitalloanbreach.WorkingCapitalLoanBreachActionHelper;
...
public class WorkingCapitalLoanBreachPastDueAmountTest {
    ...
    private List<WorkingCapitalLoanBreachScheduleData> getBreachSchedule(final Long loanId) {
        return FeignCalls.ok(
                () -> CorevanceFeignClientHelper.getCorevanceFeignClient().workingCapitalLoanBreachSchedule().retrieveBreachSchedule(loanId));
    }
