...
import com.corevance.integrationtests.support.instancemode.ConfigureInstanceMode;
import com.corevance.integrationtests.support.instancemode.InstanceModeSupportExtension;
...
public class InstanceModeIntegrationTest {
    ...
    public void setup() throws InterruptedException {
        ...
        jobId = Calls.ok(CorevanceClientHelper.getCorevanceClient().jobs.retrieveByShortName("SA_AANF")).getJobId();
    }
    ...
    public void testRunSchedulerJobDoesntWork_WhenReadOnly() {
        // when/then
        assertThrows(RuntimeException.class, () -> Calls.ok(CorevanceClientHelper.getCorevanceClient().jobs.executeJob(jobId, "executeJob")));
    }
    ...
    public void testRunSchedulerJobWorks_WhenBatchOnly() {
        // when
        Calls.ok(CorevanceClientHelper.getCorevanceClient().jobs.executeJob(jobId, "executeJob"));
