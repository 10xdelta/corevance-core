...
import com.corevance.client.models.AccountChargesRequest;
import com.corevance.client.models.AccountRequest;
import com.corevance.client.models.ChargeRequest;
import com.corevance.client.models.GetAccountsCharges;
import com.corevance.client.models.GetAccountsPurchasedShares;
import com.corevance.client.models.GetAccountsTypeAccountIdResponse;
...
import com.corevance.client.models.PostAccountsTypeAccountIdRequest;
...
import com.corevance.integrationtests.savings.base.BaseSavingsIntegrationTest;
import com.corevance.portfolio.shareaccounts.domain.ShareAccountStatusType;
...
public class ShareAccountChargeRoundingTest extends BaseSavingsIntegrationTest {
    ...
    void verifyActivationChargeRoundedCorrectlyWithAccountingEnabled() {
        runAt(DATE, () -> {
            ...
            GetAccountsTypeAccountIdResponse accountData = ok(
                    corevanceClient().shareAccounts.retrieveOneShareAccount(shareAccountId, "share"));
    ...
    private Long createShareProduct(int digitsAfterDecimal, int inMultiplesOf) {
        ...
        return ok(corevanceClient().shareProducts.createShareProduct("share", request)).getResourceId();
    }

    private Long createShareProductWithAccountingRule2(int digitsAfterDecimal, int inMultiplesOf) {
        String suffix = UUID.randomUUID().toString().replace("-", "").substring(0, 8);

        CorevanceFeignClient feignClient = CorevanceFeignClientHelper.getCorevanceFeignClient();
    ...
    private Long applyShareAccount(Long clientId, Long productId, Long savingsAccountId, Long chargeId, double chargeAmount, String date) {
        ...
        return ok(corevanceClient().shareAccounts.createShareAccount("share", request)).getResourceId();
    }

    private void approveShareAccount(Long shareAccountId) {
        ok(corevanceClient().shareAccounts.handleCommandsShareAccount("share", shareAccountId, new PostAccountsTypeAccountIdRequest(),
                "approve"));
    }
    ...
    private GetAccountsTypeAccountIdResponse getShareAccount(Long shareAccountId) {
        return ok(corevanceClient().shareAccounts.retrieveOneShareAccount(shareAccountId, "share"));
    }
