 ...
 * under the License.
 */
package com.corevance.integrationtests.bulkimport.importhandler.loan;
...
import com.corevance.integrationtests.bulkimport.importhandler.BulkImportOutputTemplateHelper;
import com.corevance.integrationtests.common.CollateralManagementHelper;
import com.corevance.integrationtests.common.GroupHelper;
...
import com.corevance.integrationtests.common.funds.FundsHelper;
...
public class LoanImportHandlerTest {
    ...
    private static final String CREATE_CLIENT_URL = "/corevance-provider/api/v1/clients?" + Utils.TENANT_IDENTIFIER;
