 ...
 * under the License.
 */
package com.corevance.integrationtests.savings;

import static io.restassured.RestAssured.given;

import java.math.BigDecimal;
import com.corevance.client.models.AccountTransferRequest;
...
public class AccountTransferWithdrawalFeeTest extends BaseSavingsIntegrationTest {
    ...
    public void testFromSavingsToSavingsAccountTransferWithWithdrawalFee() {
        ...
        final PostSavingsAccountsSavingsAccountIdChargesResponse chargeResponse = ok(corevanceClient().savingsAccountCharges
        ...
        ok(corevanceClient().accountTransfers.createAccountTransfer(new AccountTransferRequest().fromClientId(String.valueOf(fromClientId))
        ...
        SavingsAccountData fromSavingsAccount = ok(
                corevanceClient().savingsAccounts.retrieveSavingsAccount(fromSavingsId, false, null, "summary"));
        ...
        SavingsAccountData toSavingsAccount = ok(
                corevanceClient().savingsAccounts.retrieveSavingsAccount(toSavingsId, false, null, "summary"));
    ...
    private void enableWithdrawalFeeForTransfers(Long savingsId) {
        given().spec(requestSpec).body("{\"withdrawalFeeForTransfers\": true}").expect().spec(responseSpec).log().ifError().when()
                .put("/corevance-provider/api/v1/savingsaccounts/" + savingsId + "?" + Utils.TENANT_IDENTIFIER);
    }
