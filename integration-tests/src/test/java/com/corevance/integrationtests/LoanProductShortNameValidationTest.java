...
import static com.corevance.integrationtests.common.Utils.uniqueRandomStringGenerator;
...
public class LoanProductShortNameValidationTest {
    ...
    public void createLoanProductsWithSameShortName() {
        ...
        Calls.ok(CorevanceClientHelper.getCorevanceClient().loanProducts.createLoanProduct(request));
