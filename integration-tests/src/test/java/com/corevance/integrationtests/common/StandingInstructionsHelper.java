...
public class StandingInstructionsHelper {
    ...
    private static final String STANDING_INSTRUCTIONS_URL = "/corevance-provider/api/v1/standinginstructions";
    private static final String STANDING_INSTRUCTIONS_RUN_HISTORY_URL = "/corevance-provider/api/v1/standinginstructionrunhistory";
