 ...
 * under the License.
 */
package com.corevance.integrationtests.common.savings;

import static com.corevance.integrationtests.common.Utils.DEFAULT_TENANT;
import static com.corevance.integrationtests.common.Utils.TENANT_PARAM_NAME;
...
import com.corevance.client.models.SavingsAccountTransactionsSearchResponse;
...
public class SavingsAccountHelper {
    ...
    private static final String SAVINGS_ACCOUNT_URL = "/corevance-provider/api/v1/savingsaccounts";
    ...
    public static List<Long> getSavingsIdsByStatusId(int status) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().legacy.getSavingsAccountsByStatus(status));
    }
    ...
    public PostSavingsAccountsAccountIdResponse closeSavingsAccount(final Long savingsId, PostSavingsAccountsAccountIdRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().savingsAccounts.handleCommandsSavingsAccount(savingsId, request, "close"));
    }
    ...
    public Response<PostSavingsAccountTransactionsResponse> withdrawalFromSavingsAccount(final Long savingsId,
        ...
        return Calls.executeU(CorevanceClientHelper.getCorevanceClient().savingsTransactions.createSavingsAccountTransaction(savingsId,
                request, "withdrawal"));
    }
    ...
    public Map<String, Object> querySavingsTransactions(Integer savingsId, PagedLocalRequestAdvancedQueryRequest request) {
        String response = Calls.ok(CorevanceClientHelper.getCorevanceClient().savingsTransactions
    ...
    public HashMap updateGsimApplication(final Integer gsimID, final Integer clientID, final Integer groupID, final Integer productID) {
        ...
        final String GSIM_URL = "/corevance-provider/api/v1/savingsaccounts/gsim/" + gsimID + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public HashMap getTransactionDetails(Integer savingsId, Integer transactionId) {
        ...
        final String url = "/corevance-provider/api/v1/savingsaccounts/" + savingsId + "/transactions/" + transactionId + "?"
                + Utils.TENANT_IDENTIFIER;
        return Utils.performServerGet(requestSpec, responseSpec, url, "");
    }
