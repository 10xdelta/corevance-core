...
import com.corevance.client.models.PaymentTypeCreateRequest;
import com.corevance.client.models.PaymentTypeCreateResponse;
import com.corevance.client.models.PaymentTypeData;
import com.corevance.client.models.PaymentTypeDeleteResponse;
import com.corevance.client.models.PaymentTypeUpdateRequest;
import com.corevance.client.models.PaymentTypeUpdateResponse;
...
public final class PaymentTypeHelper {
    ...
    public static List<PaymentTypeData> getAllPaymentTypes(final Boolean onlyWithCode) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.getAllPaymentTypes(onlyWithCode));
    }
    ...
    public static PaymentTypeCreateResponse createPaymentType(final PaymentTypeCreateRequest request) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.createPaymentType(request));
    }
    ...
    public static void verifyPaymentTypeCreatedOnServer(final Long generatedPaymentTypeID) {
        ...
        PaymentTypeData response = Calls
                .ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.retrieveOnePaymentType(generatedPaymentTypeID));
    ...
    public static Object retrieveById(RequestSpecification requestSpec, ResponseSpecification responseSpec, final Long paymentTypeId) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.retrieveOnePaymentType(paymentTypeId));
    }
    ...
    public static PaymentTypeUpdateResponse updatePaymentType(final Long paymentTypeId, PaymentTypeUpdateRequest request) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.updatePaymentType(paymentTypeId, request));
    }

    public static PaymentTypeDeleteResponse deletePaymentType(final Long paymentTypeId) {
        log.info("-------------------------------DELETING PAYMENT TYPE-------------------------------------------");
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().paymentTypes.deleteCodePaymentType(paymentTypeId));
    }
