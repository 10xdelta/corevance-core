...
public final class NotesHelper {
    ...
    private static final String GROUP_URL = "/corevance-provider/api/v1/groups";
    ...
    private static final String LOAN_URL = "/corevance-provider/api/v1/loans";
    ...
    private static final String LOAN_TRANSACTION_URL = "/corevance-provider/api/v1/loanTransactions";
    ...
    private static final String SAVINGS_URL = "/corevance-provider/api/v1/savings";
