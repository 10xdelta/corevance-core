...
public final class CodeHelper {
    ...
    public static final String CODE_URL = "/corevance-provider/api/v1/codes";
    ...
    public static final String CODE_VALUE_URL = "/corevance-provider/api/v1/codes/[codeId]/codevalues";
    ...
    public PostCodeValueDataResponse createCodeValue(Long codeId, PostCodeValuesDataRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().codeValues.createCodeValue(codeId, request));
    }

    public List<GetCodesResponse> retrieveCodes() {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().codes.retrieveAllCodes());
    }

    public GetCodesResponse retrieveCodeByName(final String codeName) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().codes.retrieveOneCodeByName(codeName));
    }
}
