...
import com.corevance.client.models.PutGlobalConfigurationsResponse;
...
public class GlobalConfigurationHelper {
    ...
    public GetGlobalConfigurationsResponse getAllGlobalConfigurations() {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().globalConfigurations.retrieveConfiguration(false));
    }
    ...
    public GlobalConfigurationPropertyData getGlobalConfigurationByName(final String configName) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().globalConfigurations.retrieveOneByName(configName));
    }
    ...
    public GlobalConfigurationPropertyData getGlobalConfigurationById(final Long configId) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().globalConfigurations.retrieveOneGlobalConfiguration(configId));
    }
    ...
    public void resetAllDefaultGlobalConfigurations() {
        ...
        for (GlobalConfigurationPropertyData actualGlobalConfiguration : actualGlobalConfigurations.getGlobalConfiguration()) {
            ...
            if (!isMatching(defaultGlobalConfiguration, actualGlobalConfiguration)) {
                 ...
                 * {@link com.corevance.infrastructure.configuration.exception.GlobalConfigurationPropertyCannotBeModfied}
                 * will be thrown.
                 */
     ...
     *
     * @see <a href= "https://issues.apache.org/jira/browse/COREVANCE-722">COREVANCE-722</a> This is a quick, fail fast
    ...
    public PutGlobalConfigurationsResponse updateGlobalConfiguration(final String configName, PutGlobalConfigurationsRequest request) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().globalConfigurations.updateConfigurationByName(configName, request));
    }
    ...
    public void updateGlobalConfigurationInternal(final String configName, final Long value) {
        ...
        Calls.ok(CorevanceClientHelper.getCorevanceClient().legacy.updateInternalGlobalConfiguration(configName, value));
    }
