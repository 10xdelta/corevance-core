...
public final class CenterHelper {
    ...
    private static final String CENTERS_URL = "/corevance-provider/api/v1/centers";

    public static final String CREATED_DATE = "29 December 2014";
    private static final String CREATE_CENTER_URL = "/corevance-provider/api/v1/centers?" + Utils.TENANT_IDENTIFIER;
    ...
    public static void verifyCenterCreatedOnServer(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CENTER_URL = "/corevance-provider/api/v1/centers/" + generatedCenterID + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public static Integer activateCenter(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CENTER_ASSOCIATE_URL = "/corevance-provider/api/v1/centers/" + centerId + "?command=activate&"
