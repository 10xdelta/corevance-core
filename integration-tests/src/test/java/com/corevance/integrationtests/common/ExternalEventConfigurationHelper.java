...
public class ExternalEventConfigurationHelper {
    ...
    private static final String EXTERNAL_EVENT_CONFIGURATION_URL = "/corevance-provider/api/v1/externalevents/configuration?"
            + Utils.TENANT_IDENTIFIER;

    // TODO: Rewrite to use corevance-client instead!
    // Example:
    // com.corevance.integrationtests.common.loans.LoanTransactionHelper.disburseLoan(java.lang.Long,
