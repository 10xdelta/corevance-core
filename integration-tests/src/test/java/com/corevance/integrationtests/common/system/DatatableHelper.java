 ...
 * under the License.
 */
package com.corevance.integrationtests.common.system;

import static com.corevance.integrationtests.common.Utils.initializeDefaultRequestSpecification;
import static com.corevance.integrationtests.common.Utils.initializeDefaultResponseSpecification;
...
import com.corevance.client.models.PutDataTablesAppTableIdDatatableIdResponse;
import com.corevance.client.models.PutDataTablesRequest;
import com.corevance.client.models.PutDataTablesResponse;
...
public class DatatableHelper {
    ...
    private static final String DATATABLE_URL = "/corevance-provider/api/v1/datatables";
    ...
    public PostDataTablesResponse createDatatable(PostDataTablesRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().dataTables.createDatatable(request));
    }
    ...
    public GetDataTablesResponse getDataTableDetails(final String dataTableName) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().dataTables.getDatatable(dataTableName));
    }
    ...
    public Map<String, Object> queryDatatable(String dataTableName, PagedLocalRequestAdvancedQueryData request) {
        String response = Calls.ok(CorevanceClientHelper.getCorevanceClient().dataTables.advancedQuery(dataTableName, request));
    ...
    public PutDataTablesResponse updateDatatable(String dataTableName, PutDataTablesRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().dataTables.updateDatatable(dataTableName, request));
    }
