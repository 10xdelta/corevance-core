...
public class WorkingCapitalLoanHelper {
    ...
    private static WorkingCapitalLoansApi api() {
        return CorevanceFeignClientHelper.getCorevanceFeignClient().workingCapitalLoans();
    }

    private static WorkingCapitalLoanTransactionsApi transactionsApi() {
        return CorevanceFeignClientHelper.getCorevanceFeignClient().create(WorkingCapitalLoanTransactionsApi.class);
    }
