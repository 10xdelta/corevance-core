 ...
 * under the License.
 */
package com.corevance.integrationtests.common.recurringdeposit;
...
public class RecurringDepositProductHelper {
    ...
    private static final String RECURRING_DEPOSIT_PRODUCT_URL = "/corevance-provider/api/v1/recurringdepositproducts";
    private static final String INTEREST_CHART_URL = "/corevance-provider/api/v1/interestratecharts";
