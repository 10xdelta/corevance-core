...
public class DelinquencyBucketsHelper {
    ...
    public static List<DelinquencyBucketResponse> getBuckets() {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.getBuckets());
    }

    public static DelinquencyBucketResponse getBucket(Long id) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.getBucket(id));
    }

    public static Long createDefaultBucket() {
        Long range1Id = Calls
                .ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.createRange(new DelinquencyRangeRequest()
        ...
        Long range2Id = Calls
                ...
                .getResourceId();
        return Calls
                .ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.createBucket(
    ...
    public static PostDelinquencyBucketResponse createBucket(DelinquencyBucketRequest bucket) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.createBucket(bucket));
    }
    ...
    public static Long createBucket(List<Pair<Integer, Integer>> rangesDef) {
        ...
        rangesDef.forEach(range -> {
            rangeIds.add(Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement
    ...
    public static PutDelinquencyBucketResponse updateBucket(Long id, DelinquencyBucketRequest bucket) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.updateBucket(id, bucket));
    }

    public static DeleteDelinquencyBucketResponse deleteBucket(Long id) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().delinquencyRangeAndBucketsManagement.deleteBucket(id));
    }
