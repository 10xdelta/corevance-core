...
public class AccountTransferHelper {
    ...
    private static final String ACCOUNT_TRANSFER_URL = "/corevance-provider/api/v1/accounttransfers";
    private static final String LOAN_REFUND_BY_TRANSFER_URL = "/corevance-provider/api/v1/accounttransfers/refundByTransfer";
