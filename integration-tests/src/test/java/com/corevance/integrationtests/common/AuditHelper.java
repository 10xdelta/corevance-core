...
public class AuditHelper {
    ...
    private static final String AUDIT_BASE_URL = "/corevance-provider/api/v1/audits?" + Utils.TENANT_IDENTIFIER;
    private static final String AUDITSEARCH_BASE_URL = "/corevance-provider/api/v1/audits/searchtemplate?" + Utils.TENANT_IDENTIFIER;
