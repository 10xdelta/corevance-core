...
import com.corevance.client.models.AddressData;
...
import com.corevance.client.models.GetClientTransferProposalDateResponse;
...
import com.corevance.client.models.GetClientsClientIdTransactionsResponse;
import com.corevance.client.models.GetClientsClientIdTransactionsTransactionIdResponse;
...
import com.corevance.client.models.PostClientClientIdAddressesResponse;
import com.corevance.client.models.PostClientsClientIdIdentifiersRequest;
import com.corevance.client.models.PostClientsClientIdIdentifiersResponse;
...
import com.corevance.client.models.PostClientsClientIdTransactionsTransactionIdResponse;
...
import com.corevance.client.models.SortOrder;
...
public class ClientHelper {
    ...
    private static final String CLIENT_URL = "/corevance-provider/api/v1/clients";
    ...
    public static PostClientsResponse createClient(final PostClientsRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.createClient(request));
    }
    ...
    public static GetClientsClientIdResponse getClientByExternalId(final String externalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.retrieveOneClientByExternalId(externalId, null));
    }
    ...
    public static PutClientsClientIdResponse updateClientByExternalId(final String externalId, final PutClientsClientIdRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.updateClientByExternalId(externalId, request));
    }

    public static DeleteClientsClientIdResponse deleteClientByExternalId(final String externalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.deleteClientByExternalId(externalId));
    }

    public static GetClientsClientIdAccountsResponse getClientAccounts(final String externalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.retrieveAllClientAccountsByExternalId(externalId));
    }

    public static GetClientTransferProposalDateResponse getProposedTransferDate(final String externalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.retrieveClientTransferTemplateByExternalId(externalId));
    }
    ...
    public static PostClientsClientIdResponse closeClient(final String externalId, final Integer closureReasonId) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clients.handleCommandClientByExternalId(externalId, request,
    ...
    public PostClientsClientIdIdentifiersResponse createClientIdentifer(final Long clientId,
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientIdentifiers.createClientIdentifier(clientId, request));
    }
    ...
    public PageClientSearchData searchClients(PagedRequestClientTextSearch request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientSearchV2.searchClientsByText(request));
    }

    public static GetClientsClientIdAccountsResponse getClientAccounts(final long clientId) {
        return FeignCalls.ok(() -> CorevanceFeignClientHelper.getCorevanceFeignClient().clients().retrieveAllClientAccounts(clientId));
    }
    ...
    public static PostClientClientIdAddressesResponse createClientAddress(final RequestSpecification requestSpec,
        ...
        final String CREATE_CLIENT_ADDRESS_URL = "/corevance-provider/api/v1/client/" + clientId + "/addresses?type=" + addressTypeId + "&"
    ...
    public static Object assignStaffToClient(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CLIENT_ASSIGN_STAFF_URL = "/corevance-provider/api/v1/clients/" + clientId + "?" + Utils.TENANT_IDENTIFIER
                + "&command=assignStaff";
    ...
    public static void verifyClientCreatedOnServer(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CLIENT_URL = "/corevance-provider/api/v1/clients/" + clientId + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public static List<AddressData> getClientAddresses(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
            final int clientId) {
        final String GET_CLIENT_ADDRESSES_URL = "/corevance-provider/api/v1/client/" + clientId + "/addresses?" + Utils.TENANT_IDENTIFIER;
    ...
    public static Object getClient(final RequestSpecification requestSpec, final ResponseSpecification responseSpec, final String clientId,
        ...
        final String GET_CLIENT_URL = "/corevance-provider/api/v1/clients/" + clientId + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public static HashMap<String, Object> getClientAuditFields(final RequestSpecification requestSpec,
        ...
        final String GET_CLIENT_URL = "/corevance-provider/api/v1/internal/client/" + clientId + "/audit?" + Utils.TENANT_IDENTIFIER;
    ...
    public static Integer addChargesForClient(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String ADD_CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/charges?" + Utils.TENANT_IDENTIFIER;
    ...
    public static String payChargesForClients(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/charges/" + clientChargeId + "?command=paycharge&"
                + Utils.TENANT_IDENTIFIER;
    ...
    public static String waiveChargesForClients(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/charges/" + clientChargeId + "?command=waive&"
                + Utils.TENANT_IDENTIFIER;
    ...
    public static Integer revertClientChargeTransaction(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/transactions/" + clientChargeId + "?command=undo&"
                + Utils.TENANT_IDENTIFIER;
    ...
    public static Object getClientCharge(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/charges/" + clientChargeId + "?"
                + Utils.TENANT_IDENTIFIER;
    ...
    public static Boolean getClientTransactions(final RequestSpecification requestSpec, final ResponseSpecification responseSpec,
        ...
        final String CHARGES_URL = "/corevance-provider/api/v1/clients/" + clientId + "/transactions/" + transactionId + "?"
                + Utils.TENANT_IDENTIFIER;
    ...
    public GetClientsClientIdTransactionsResponse getAllClientTransactionsByExternalId(final String externalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientTransactions
    ...
    public GetClientsClientIdTransactionsTransactionIdResponse getClientTransactionByExternalId(final String externalId,
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientTransactions.retrieveClientTransactionByClientExternalId(externalId,
    ...
    public PostClientsClientIdTransactionsTransactionIdResponse undoClientTransactionByExternalId(final String externalId,
            final String transactionId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientTransactions.undoClientTransactionByClientExternalId(externalId,
    ...
    public PostClientsClientIdTransactionsTransactionIdResponse undoClientTransactionByTransactionExternalId(final Long clientId,
            final String transactionExternalId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().clientTransactions.undoClientTransactionByTransactionExternalId(clientId,
    ...
    public List getClientWithStatus(final int limit, final String status) {
        final String URL = "/corevance-provider/api/v1/clients?paged=true&status=" + status + "&limit=" + Integer.toString(limit) + "&"
                + Utils.TENANT_IDENTIFIER;
    ...
    public LoanAccountLockResponseDTO retrieveLockedAccounts(int page, int limit) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().loanAccountLockApi.retrieveLockedAccounts(page, limit));
    }
