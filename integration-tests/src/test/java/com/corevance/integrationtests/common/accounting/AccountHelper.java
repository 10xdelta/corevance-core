...
import com.corevance.client.models.DeleteGLAccountsResponse;
...
import com.corevance.client.models.PutGLAccountsRequest;
import com.corevance.client.models.PutGLAccountsResponse;
...
public class AccountHelper {
    ...
    private static final String CREATE_GL_ACCOUNT_URL = "/corevance-provider/api/v1/glaccounts?" + Utils.TENANT_IDENTIFIER;
    ...
    public ArrayList getAccountingWithRunningBalances() {
        final String GET_RUNNING_BALANCE_URL = "/corevance-provider/api/v1/glaccounts?fetchRunningBalance=true";
    ...
    public HashMap getAccountingWithRunningBalanceById(final String accountId) {
        final String GET_RUNNING_BALANCE_URL = "/corevance-provider/api/v1/glaccounts/" + accountId + "?fetchRunningBalance=true";
    ...
    public static PostGLAccountsResponse createGLAccount(final PostGLAccountsRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().glAccounts.createGLAccount(request));
    }

    public static DeleteGLAccountsResponse deleteGLAccount(final Long requestId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().glAccounts.deleteGLAccount(requestId));
    }

    public static PutGLAccountsResponse updateGLAccount(final Long requestId, final PutGLAccountsRequest request) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().glAccounts.updateGLAccount(requestId, request));
    }

    public static GetGLAccountsResponse getGLAccount(final Long glAccountId) {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().glAccounts.retreiveAccount(glAccountId, false));
    }
