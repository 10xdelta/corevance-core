 ...
 * under the License.
 */
package com.corevance.integrationtests.common.funds;
...
import com.corevance.client.models.FundRequest;
import com.corevance.client.models.PostFundsResponse;
...
public final class FundsResourceHandler {
    ...
    private static final String FUNDS_URL = "/corevance-provider/api/v1/funds";
    ...
    public static PostFundsResponse createFund() {
        ...
        return FeignCalls.ok(() -> CorevanceFeignClientHelper.getCorevanceFeignClient().funds().createFund(request));
    }
