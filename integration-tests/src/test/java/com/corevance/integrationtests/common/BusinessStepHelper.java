...
public class BusinessStepHelper {
    ...
    public BusinessStepsSnapshot getConfigurationSnapshot(String jobName) {
        JobBusinessStepConfigData businessConfig = Calls
                .ok(CorevanceClientHelper.getCorevanceClient().businessStepConfiguration.retrieveAllConfiguredBusinessStep(jobName));
    ...
    public void updateSteps(String jobName, String... steps) {
        ...
        Calls.ok(CorevanceClientHelper.getCorevanceClient().businessStepConfiguration.updateJobBusinessStepConfig(jobName,
