...
public class LoanCOBCatchUpHelper {
    ...
    public Response<Void> executeLoanCOBCatchUp() {
        return Calls.okR(CorevanceClientHelper.getCorevanceClient().loanCobCatchUpApi.executeLoanCOBCatchUp());
    }

    public OldestCOBProcessedLoanDTO executeRetrieveOldestCOBProcessedLoan() {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().loanCobCatchUpApi.getOldestCOBProcessedLoan());
    }

    public Response<IsCatchUpRunningDTO> executeGetLoanCatchUpStatus() {
        return Calls.okR(CorevanceClientHelper.getCorevanceClient().loanCobCatchUpApi.isCatchUpRunning());
    }
