 ...
 * under the License.
 */
package com.corevance.integrationtests.common.report;
...
public class ReportHelper {
    ...
    public Response<ResponseBody> runReport(String reportName, Map<String, String> reportParameters) throws IOException {
        return CorevanceClientHelper.getCorevanceClient().reportsRun.runReportGetFile(reportName, reportParameters).execute();
    }
}
