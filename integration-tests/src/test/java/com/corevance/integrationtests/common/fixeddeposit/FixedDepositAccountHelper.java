 ...
 * under the License.
 */
package com.corevance.integrationtests.common.fixeddeposit;
...
import com.corevance.client.models.PostFixedDepositAccountsFixedDepositAccountIdTransactionsRequest;
...
public class FixedDepositAccountHelper {
    ...
    private static final String FIXED_DEPOSIT_ACCOUNT_URL = "/corevance-provider/api/v1/fixeddepositaccounts";
    ...
    public List<GetFixedDepositAccountsAccountIdTransactionsResponse> getFixedDepositTransactions(final Integer fixedDepositAccountId) {
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().fixedDepositAccountTransactions
    ...
    public Long adjustFixedDepositTransaction(final Integer fixedDepositAccountId, final Integer transactionId,
        ...
        return Calls
                .ok(CorevanceClientHelper.getCorevanceClient().fixedDepositAccountTransactions.handleCommandsFixedDepositAccountTransaction(
