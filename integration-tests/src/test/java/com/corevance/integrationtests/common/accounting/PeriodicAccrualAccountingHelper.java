...
import com.corevance.client.models.PostRunaccrualsRequest;
...
public final class PeriodicAccrualAccountingHelper {
    ...
    public static void runPeriodicAccrualAccounting(final String date) {
        ...
        ok(() -> {
            CorevanceFeignClientHelper.getCorevanceFeignClient().periodicAccrualAccounting().executePeriodicAccrualAccounting(request);
            return null;
        });
    }
}
