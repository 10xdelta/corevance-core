...
public final class StaffHelper {
    ...
    private static final String TRANSFER_STAFF_URL = "/corevance-provider/api/v1/groups";

    private static final String CREATE_STAFF_URL = "/corevance-provider/api/v1/staff";
