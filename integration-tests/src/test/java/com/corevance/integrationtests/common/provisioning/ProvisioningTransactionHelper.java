 ...
 * under the License.
 */
package com.corevance.integrationtests.common.provisioning;

import io.restassured.specification.RequestSpecification;
import io.restassured.specification.ResponseSpecification;
import java.util.ArrayList;
import java.util.Map;
import com.corevance.client.models.PageProvisioningEntryData;
...
public class ProvisioningTransactionHelper {
    ...
    private static final String PROVISIONING_CATEGORY_URL = "/corevance-provider/api/v1/provisioningcategory?" + Utils.TENANT_IDENTIFIER;

    private static final String CREATE_PROVISIONING_CRITERIA_URL = "/corevance-provider/api/v1/provisioningcriteria?"
            + Utils.TENANT_IDENTIFIER;
    private static final String CREATE_PROVISIONING_ENTRY_URL = "/corevance-provider/api/v1/provisioningentries?" + Utils.TENANT_IDENTIFIER;
    ...
    public Integer deleteProvisioningCategory(final Integer categoryId) {
        final String url = "/corevance-provider/api/v1/provisioningcategory/" + categoryId + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public Map retrieveProvisioningCriteria(final Integer criteriaId) {
        String url = "/corevance-provider/api/v1/provisioningcriteria/" + criteriaId + "?" + Utils.TENANT_IDENTIFIER;
    ...
    public Integer updateProvisioningEntry(final String command, final Integer entryId, String jsonBody) {
        String url = "/corevance-provider/api/v1/provisioningentries/" + entryId + "?command=" + command + "&" + Utils.TENANT_IDENTIFIER;
    ...
    public Map retrieveProvisioningEntry(final Integer provisioningEntry) {
        String url = "/corevance-provider/api/v1/provisioningentries/" + provisioningEntry + "?" + Utils.TENANT_IDENTIFIER;
        return Utils.performServerGet(requestSpec, responseSpec, url, "");
    }
    ...
    public Map retrieveProvisioningEntries(final Integer provisioningEntry) {
        String url = "/corevance-provider/api/v1/provisioningentries/entries?entryId=" + provisioningEntry + "&" + Utils.TENANT_IDENTIFIER;
        return Utils.performServerGet(requestSpec, responseSpec, url, "");
    }

    public PageProvisioningEntryData retrieveAllProvisioningEntries() {
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().provisioningEntries.retrieveAllProvisioningEntries(null, null));
    }
