 ...
 * under the License.
 */
package com.corevance.integrationtests.common.xbrl;
...
public class XBRLIntegrationTestHelper {
    ...
    private static final String GET_TAXONOMY_LIST_URL = "/corevance-provider/api/v1/mixtaxonomy?" + Utils.TENANT_IDENTIFIER;
    private static final String TAXONOMY_MAPPING_URL = "/corevance-provider/api/v1/mixmapping?" + Utils.TENANT_IDENTIFIER;
