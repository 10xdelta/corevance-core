 ...
 * under the License.
 */
package com.corevance.integrationtests.common.commands;
...
import com.corevance.client.models.PostMakerCheckersResponse;
...
public class MakercheckersHelper {
    ...
    private static final String MAKERCHECKER_URL = "/corevance-provider/api/v1/makercheckers";
    ...
    public static PostMakerCheckersResponse rejectMakerCheckerEntry(CorevanceClient client, Long auditId) {
