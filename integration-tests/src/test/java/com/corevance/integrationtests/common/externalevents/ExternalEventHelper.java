 ...
 * under the License.
 */
package com.corevance.integrationtests.common.externalevents;
...
import com.corevance.client.models.ExternalEventConfigurationUpdateResponse;
...
import com.corevance.integrationtests.common.ExternalEventConfigurationHelper;
...
public final class ExternalEventHelper {
    ...
    public static List<ExternalEventResponse> getAllExternalEvents(final RequestSpecification requestSpec,
        ...
        final String url = "/corevance-provider/api/v1/internal/externalevents?" + Utils.TENANT_IDENTIFIER;
    ...
    public static List<ExternalEventResponse> getAllExternalEvents(final RequestSpecification requestSpec,
        ...
        final String url = "/corevance-provider/api/v1/internal/externalevents?" + filter.toQueryParams() + Utils.TENANT_IDENTIFIER;
        log.info("---------------------------------GETTING ALL EXTERNAL EVENTS---------------------------------------------");
        String response = Utils.performServerGet(requestSpec, responseSpec, url);
        return GSON.fromJson(response, new TypeToken<List<ExternalEventResponse>>() {}.getType());
    }
    ...
    public void configureBusinessEvent(String eventName, boolean enabled) {
        ExternalEventConfigurationUpdateResponse result = Calls
                .ok(CorevanceClientHelper.getCorevanceClient().externalEventConfigurationApi.updateExternalEventConfigurations(
