 ...
 * under the License.
 */
package com.corevance.integrationtests.support.instancemode;

import com.google.gson.Gson;
import io.restassured.specification.RequestSpecification;
import io.restassured.specification.ResponseSpecification;
import com.corevance.client.models.ChangeInstanceModeRequest;
...
public class InstanceModeHelper {
    ...
    public static void changeMode(RequestSpecification requestSpec, ResponseSpecification responseSpec, boolean readEnabled,
        ...
        Utils.performServerPut(requestSpec, responseSpec, "/corevance-provider/api/v1/instance-mode?" + Utils.TENANT_IDENTIFIER, requestStr);
    }
}
