...
public class LoanTransactionReverseReplayRelationTest extends FeignLoanTestBase {
    ...
    public void loanTransactionReverseReplayRelationTest() {
        ...
        final Long productId = createLoanProductFromJson(new com.google.gson.Gson()
                .toJson(new com.corevance.integrationtests.common.loans.LoanProductTestBuilder().build(null, delinquencyBucketId)));
        assertNotNull(productId);

        String loanApplicationJSON = new com.corevance.integrationtests.common.loans.LoanApplicationTestBuilder()
