...
import com.corevance.integrationtests.client.feign.modules.ExternalEventTestValidators;
...
public class FeignLoanAdjustmentOriginatorEnricherTest extends FeignLoanTestBase {
    ...
    public static void setupOriginatorHelpers() {
        ...
        externalEventHelper = new FeignExternalEventHelper(corevanceClient);
    ...
    public void testAdjustEventContainsOriginatorsAfterChargeWaiverReversal() {
        ...
        try {
            ...
            final Long loanChargeId = ok(
                    () -> corevanceClient.loanCharges().createOrPayLoanCharge(loanId, new PostLoansLoanIdChargesRequest().chargeId(chargeId)
                            .amount(100.0).locale("en").dateFormat("dd MMMM yyyy").dueDate(today), (String) null))
                    .getResourceId();

            ok(() -> corevanceClient.loanCharges().executeLoanChargeOnExistingCharge(loanId, loanChargeId,
