...
public class FeignLoanOriginatorApiTest extends FeignIntegrationTest {
    ...
    public static void setup() {
        CorevanceFeignClient corevanceClient = CorevanceFeignClientHelper.getCorevanceFeignClient();
    ...
    public void testAttachOriginatorToApprovedLoanReturns403() {
        ...
        final String todayDate = com.corevance.integrationtests.common.Utils.dateFormatter
                .format(com.corevance.integrationtests.common.Utils.getLocalDateOfTenant());
