...
public class FeignSearchHelper {
    ...
    public FeignSearchHelper(CorevanceFeignClient corevanceClient) {
        this.corevanceClient = corevanceClient;
    }

    public List<GetSearchResponse> search(String query, String resource, Boolean exactMatch) {
        return ok(() -> corevanceClient.search().searchData(query, resource, exactMatch));
    }
}
