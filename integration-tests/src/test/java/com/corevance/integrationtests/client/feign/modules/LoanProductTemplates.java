...
import com.corevance.integrationtests.client.feign.modules.LoanTestData.AmortizationType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.DaysInMonthType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.DaysInYearType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.InterestCalculationPeriodType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.InterestRateFrequencyType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.InterestType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.RepaymentFrequencyType;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.RescheduleStrategyMethod;
import com.corevance.integrationtests.client.feign.modules.LoanTestData.TransactionProcessingStrategyCode;
...
public interface LoanProductTemplates {
    ...
    default PostLoanProductsRequest create4IProgressive() {
        final Long delinquencyBucketId = com.corevance.integrationtests.common.products.DelinquencyBucketsHelper
                .createDefaultBucket();
    ...
    default PostLoanProductsRequest dueDateRespectiveNoAccountingNoInterestProduct(double principal, int repaymentEveryDays,
        ...
        return new PostLoanProductsRequest().name(Utils.uniqueRandomStringGenerator("LOAN_PRODUCT_", 6))//
                ...
                .accountingRule(1)//
                .multiDisburseLoan(false)//
                .dateFormat(com.corevance.integrationtests.client.feign.modules.LoanTestData.DATETIME_PATTERN)//
                .locale(com.corevance.integrationtests.client.feign.modules.LoanTestData.LOCALE);
    }
}
