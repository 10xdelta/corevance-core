...
public class FeignAccountHelper {
    ...
    public FeignAccountHelper(CorevanceFeignClient corevanceClient) {
    ...
    private Account createAccount(String name, String glCode, String type) {
        ...
        PostGLAccountsResponse response = ok(() -> corevanceClient.generalLedgerAccount().createGLAccount(request));

        GetGLAccountsResponse account = ok(
                () -> corevanceClient.generalLedgerAccount().retreiveAccount(response.getResourceId(), Collections.emptyMap()));
    ...
    public String getGlCode(Account account) {
        GetGLAccountsResponse response = ok(
                () -> corevanceClient.generalLedgerAccount().retreiveAccount(account.getAccountID().longValue(), Collections.emptyMap()));
