...
import com.corevance.client.models.GetClientsResponse;
...
public class ClientSearchTest extends IntegrationTest {
    ...
    public void testClientSearchByLegalForm() {
        ...
        PostOfficesResponse newOffice = ok(
                corevanceClient().offices.createOffice(new PostOfficesRequest().name(Utils.randomStringGenerator("TestOffice_", 6))
        ...
        // when
        GetClientsResponse individualClients = ok(corevanceClient().clients.retrieveAllClients(newOffice.getOfficeId(), null, null, null,
                null, null, null, null, null, null, null, null, 1, null));
        GetClientsResponse entityClients = ok(corevanceClient().clients.retrieveAllClients(newOffice.getOfficeId(), null, null, null, null,
    ...
    private Response<GetClientsResponse> callRetrieveAllClients(String orderBy, String sortOrder) {
        return Calls.executeU(corevanceClient().clients.retrieveAllClients(null, null, null, null, null, null, null, null, null, orderBy,
