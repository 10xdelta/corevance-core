...
import com.corevance.integrationtests.client.feign.modules.SavingsTestData;
...
public class FeignSavingsLifecycleExtension implements AfterEachCallback, BeforeEachCallback {
    ...
    private void closeActiveAccounts(CorevanceFeignClient client, FeignSavingsHelper savingsHelper, String todayDate) {
        try {
    ...
    private void undoApprovedAccounts(CorevanceFeignClient client, FeignSavingsHelper savingsHelper) {
        try {
    ...
    private void rejectSubmittedAccounts(CorevanceFeignClient client, FeignSavingsHelper savingsHelper, String todayDate) {
        try {
