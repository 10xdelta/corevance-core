...
public class ClientAndLoanTrendsPostgresTest extends IntegrationTest {
    ...
    void testClientTrendsByWeekReportRunsSuccessfully() {
        Response<RunReportsResponse> response = okR(
                corevanceClient().reportsRun.runReportGetData("ClientTrendsByWeek", Map.of("R_officeId", "1")));
    ...
    void testClientTrendsByMonthReportRunsSuccessfully() {
        Response<RunReportsResponse> response = okR(
                corevanceClient().reportsRun.runReportGetData("ClientTrendsByMonth", Map.of("R_officeId", "1")));
        assertEquals(200, response.code());
    }
    ...
    void testLoanTrendsByWeekReportRunsSuccessfully() {
        Response<RunReportsResponse> response = okR(
                corevanceClient().reportsRun.runReportGetData("LoanTrendsByWeek", Map.of("R_officeId", "1")));
        assertEquals(200, response.code());
    }
    ...
    void testLoanTrendsByMonthReportRunsSuccessfully() {
        Response<RunReportsResponse> response = okR(
                corevanceClient().reportsRun.runReportGetData("LoanTrendsByMonth", Map.of("R_officeId", "1")));
        assertEquals(200, response.code());
    }
