...
import com.corevance.client.models.PostProvisioningEntriesResponse;
import com.corevance.client.models.ProvisionEntryRequest;
import com.corevance.client.models.ProvisioningEntryData;
...
import com.corevance.integrationtests.common.provisioning.ProvisioningHelper;
import com.corevance.integrationtests.common.provisioning.ProvisioningTransactionHelper;
...
public class FeignProvisioningEntryTest extends FeignLoanTestBase {
    ...
    public void testRetrieveProvisioningEntryWithNoActiveLoansDoesNotReturn500() {
        ...
        PostProvisioningEntriesResponse created = ok(() -> corevanceClient().provisioningEntries().createProvisioningEntries(request));
        ...
        ProvisioningEntryData entry = ok(
                () -> corevanceClient().provisioningEntries().retrieveOneProvisioningEntry(created.getResourceId()));
        assertNotNull(entry);
