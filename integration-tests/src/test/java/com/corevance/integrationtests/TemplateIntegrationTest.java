...
public class TemplateIntegrationTest {
    ...
    private static final String GET_TEMPLATES_URL = "/corevance-provider/api/v1/templates?tenantIdentifier=default";
    ...
    public void test() {
        ...
        final String templateUrlForId = String.format("/corevance-provider/api/v1/templates/%s?tenantIdentifier=default", id);
