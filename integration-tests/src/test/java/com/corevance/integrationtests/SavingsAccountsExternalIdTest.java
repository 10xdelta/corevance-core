...
import com.corevance.client.models.PutSavingsAccountsAccountIdRequest;
import com.corevance.client.models.PutSavingsAccountsAccountIdResponse;
...
public class SavingsAccountsExternalIdTest extends IntegrationTest {
    ...
    void updateSavingsAccountWithExternalId() {
        ...
        Response<PutSavingsAccountsAccountIdResponse> response = okR(
                corevanceClient().savingsAccounts.updateSavingsAccountByExternalId(EXTERNAL_ID, request, ""));
    ...
    void approveSavingsAccount() {
        ...
        Response<PostSavingsAccountsAccountIdResponse> response = okR(
                corevanceClient().savingsAccounts.handleCommandsSavingsAccountByExternalId(EXTERNAL_ID, request, "approve"));
    ...
    void retrieveSavingsAccountWithExternalId() {
        ...
        Response<SavingsAccountData> response = okR(
                corevanceClient().savingsAccounts.retrieveSavingsAccountByExternalId(EXTERNAL_ID, false, null, "all"));
    ...
    void undoApprovalSavingsAccountWithExternalId() {
        ...
        PostSavingsAccountsAccountIdRequest request = new PostSavingsAccountsAccountIdRequest();
        Response<PostSavingsAccountsAccountIdResponse> response = okR(
                corevanceClient().savingsAccounts.handleCommandsSavingsAccountByExternalId(EXTERNAL_ID, request, "undoapproval"));
    ...
    void deleteSavingsAccountWithExternalId() {
        ...
        Response<DeleteSavingsAccountsAccountIdResponse> response = okR(
                corevanceClient().savingsAccounts.deleteSavingsAccountByExternalId(EXTERNAL_ID));
    ...
    void retrieveSavingsAccountWithExternalIdThirdTime() {
        ...
        Response<SavingsAccountData> response = Calls
                .executeU(corevanceClient().savingsAccounts.retrieveSavingsAccountByExternalId(EXTERNAL_ID, false, null, "all"));
