...
import com.corevance.integrationtests.common.batch.BatchServiceHelper;
...
public class BatchWorkingCapitalLoanIntegrationTest {
    ...
    private Long submitAndTrack(final com.corevance.client.models.PostWorkingCapitalLoansRequest request) {
