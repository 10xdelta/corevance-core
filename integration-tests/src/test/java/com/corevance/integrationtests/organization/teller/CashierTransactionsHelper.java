 ...
 * under the License.
 */
package com.corevance.integrationtests.organization.teller;
...
import com.corevance.client.models.GetTellersTellerIdCashiersCashiersIdSummaryAndTransactionsResponse;
import com.corevance.client.models.GetTellersTellerIdCashiersCashiersIdTransactionsResponse;
...
public class CashierTransactionsHelper {
    ...
    private static final String CREATE_CASHIER_URL = "/corevance-provider/api/v1/tellers/1/cashiers";
    private static final String CREATE_TELLER_URL = "/corevance-provider/api/v1/tellers";
    ...
    public GetTellersTellerIdCashiersCashiersIdTransactionsResponse getTellersTellerIdCashiersCashiersIdTransactionsResponse(Long tellerId,
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().tellers.retrieveCashierTransactions(tellerId, cashierId, currencyCode,
    ...
    public GetTellersTellerIdCashiersCashiersIdSummaryAndTransactionsResponse getTellersTellerIdCashiersCashiersIdSummaryAndTransactionsResponse(
        ...
        return Calls.ok(CorevanceClientHelper.getCorevanceClient().tellers.retrieveCashierTransactionsWithSummary(tellerId, cashierId,
