...
public class WorkingCapitalLoanRepaymentAccountingTest {
    ...
    public static void setupAccounts() {
        ...
        final FeignAccountHelper accountHelper = new FeignAccountHelper(CorevanceFeignClientHelper.getCorevanceFeignClient());
    ...
    private List<JournalEntryTransactionItem> getJournalEntriesForWCTransaction(final Long wcTransactionId) {
        ...
        final FeignJournalEntryHelper journalHelper = new FeignJournalEntryHelper(CorevanceFeignClientHelper.getCorevanceFeignClient());
