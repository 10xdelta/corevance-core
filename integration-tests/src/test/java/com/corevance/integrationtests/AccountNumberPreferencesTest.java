...
import com.corevance.integrationtests.common.CenterDomain;
import com.corevance.integrationtests.common.CenterHelper;
...
import com.corevance.integrationtests.common.system.AccountNumberPreferencesHelper;
...
public class AccountNumberPreferencesTest {
    ...
    private void createAndValidateGroup(Boolean isAccountPreferenceSetUp) {
        ...
        final String GROUP_URL = "/corevance-provider/api/v1/groups/" + this.groupID + "?" + Utils.TENANT_IDENTIFIER;
    ...
    private void createAndValidateCenter(Boolean isAccountPreferenceSetUp) {
        ...
        if (isAccountPreferenceSetUp) {
            ...
            final String CENTER_URL = "/corevance-provider/api/v1/centers/" + this.centerId + "?" + Utils.TENANT_IDENTIFIER;
