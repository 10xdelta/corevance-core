 ...
 * under the License.
 */
package com.corevance.portfolio.loanorigination.data;
...
public class LoanOriginatorMappingResponse implements Serializable {
    ...
    public static LoanOriginatorMappingResponse of(Long loanId, String loanExternalId, Long originatorId, String originatorExternalId) {
        return LoanOriginatorMappingResponse.builder().loanId(loanId).loanExternalId(loanExternalId).originatorId(originatorId)
                .originatorExternalId(originatorExternalId).build();
    }
}
