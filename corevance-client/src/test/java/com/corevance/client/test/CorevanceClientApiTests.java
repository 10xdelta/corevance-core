...
public class CorevanceClientApiTests {

    private CorevanceClient client;

    @BeforeEach
    void setUp() {
        client = CorevanceClient.builder().baseURL("http://test/").tenant("default").basicAuth("mifos", "password").build();
    }
