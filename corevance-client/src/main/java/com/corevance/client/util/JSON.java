...
import com.corevance.client.util.adapter.ExternalIdAdapter;
import retrofit2.Converter;
import retrofit2.Retrofit;
import retrofit2.converter.gson.GsonConverterFactory;

// This class was originally generated by OpenAPI Generator (https://openapi-generator.tech),
// but then had to be manually edited by Michael Vorburger.ch to fix https://issues.apache.org/jira/browse/COREVANCE-1220.
// The original JSON class is deleted during the build (see COREVANCE-1231).
public class JSON {
    ...
    /**
     * GSON TypeAdapter for JSR-310 LocalDate type, which Corevance API's RETURNS as JSON array in the
     * <tt>[2009,1,1]</tt> format, but EXPECTS as String not Array and with a locale and dateFormat. Weird, but so it is
     * (see COREVANCE-1220 & COREVANCE-1233).
     */
    public static class LocalDateTypeAdapter extends TypeAdapter<LocalDate> {

        // NB this format is referenced from com.corevance.client.util.CorevanceClient.DATE_FORMAT
        ...
        public LocalDate read(JsonReader in) throws IOException {
            ...
            throw new JsonParseException(
                    "Corevance's API normally always sends LocalDate as e.g. [2009,1,1].. or does it not?! (COREVANCE-1220)");
        }
    }
    ...
    public static class SqlDateTypeAdapter extends TypeAdapter<java.sql.Date> {
        ...
        private final DateFormat dateFormat = null; // TODO COREVANCE-1220
    ...
    // The original class ApiClass, just like the JSON class, is deleted during the build (see COREVANCE-1231).
