 ...
 * under the License.
 */
package com.corevance.client.services;
...
// https://issues.apache.org/jira/browse/COREVANCE-1263
public interface RunReportsApi {

    /**
     * Running a Report This resource allows you to run and receive output from pre-defined Apache Corevance reports.
     ...
     * reports can return HTML, PDF or CSV formats. The Apache Corevance reference application uses a JQuery plugin
