...
import com.corevance.test.data.CurrencyOptions;
...
@Component
public class ChargeGlobalInitializerStep implements CorevanceGlobalInitializerStep {
    ...
    public void initialize() {
        ...
        try {
            existingCharges = corevanceClient.charges().retrieveAllCharges(Map.of());
        } catch (Exception e) {
    ...
    private PostChargesResponse createChargeIfNotExists(List<ChargeData> existingCharges, Enum<ChargeProductAppliesTo> appliesTo,
        ...
        try {
            return ok(() -> corevanceClient.charges().createCharge(request, Map.of()));
