...
import com.corevance.client.models.FundData;
...
public class FundGlobalInitializerStep implements CorevanceGlobalInitializerStep {
    ...
    public void initialize() {
        ...
        try {
            existingFunds = corevanceClient.funds().retrieveFunds(Map.of());
        } catch (Exception e) {
        ...
        fundNames.forEach(name -> {
            ...
            executeVoid(() -> corevanceClient.funds().createFund(postFundsRequest, Map.of()));
        });
