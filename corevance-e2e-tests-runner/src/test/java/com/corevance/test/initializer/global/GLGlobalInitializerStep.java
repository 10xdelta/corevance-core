...
public class GLGlobalInitializerStep implements CorevanceGlobalInitializerStep {
    ...
    public void initialize() {
        ...
        try {
            existingAccounts = corevanceClient.generalLedgerAccount().retrieveAllAccountsUniversal(Map.of());
        } catch (Exception e) {
    ...
    private void createGLAccountIfNotExists(List<GetGLAccountsResponse> existingAccounts, String name, String glCode, Integer type) {
        ...
        executeVoid(() -> corevanceClient.generalLedgerAccount().createGLAccount(request, Map.of()));
    }
}
