...
public class PaymentTypeGlobalInitializerStep implements CorevanceGlobalInitializerStep {
    ...
    public void initialize() {
        ...
        try {
            existingPaymentTypes = corevanceClient.paymentType().getAllPaymentTypesUniversal(Map.of());
        } catch (Exception e) {
        ...
        ParallelExecutionHelper.runInParallel(paymentTypeNames, paymentTypeName -> {
            ...
            executeVoid(() -> corevanceClient.paymentType().createPaymentType(postPaymentTypesRequest, Map.of()));
        });
    }
}
