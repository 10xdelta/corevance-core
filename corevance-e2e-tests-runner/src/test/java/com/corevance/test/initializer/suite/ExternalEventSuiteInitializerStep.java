...
import com.corevance.client.models.ExternalEventConfigurationItemResponse;
import com.corevance.client.models.ExternalEventConfigurationResponse;
...
@Component
public class ExternalEventSuiteInitializerStep implements CorevanceSuiteInitializerStep {
    ...
    public void initializeForSuite() throws InterruptedException {
        ...
        ExternalEventConfigurationResponse response = ok(
                () -> corevanceClient.externalEventConfiguration().getExternalEventConfigurations(Map.of()));
        ...
        executeVoid(() -> corevanceClient.externalEventConfiguration().updateExternalEventConfigurations(request, Map.of()));
