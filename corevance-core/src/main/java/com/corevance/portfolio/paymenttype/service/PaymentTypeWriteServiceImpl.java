 ...
 * under the License.
 */
package com.corevance.portfolio.paymenttype.service;
...
import com.corevance.portfolio.paymenttype.data.PaymentTypeDeleteRequest;
import com.corevance.portfolio.paymenttype.data.PaymentTypeDeleteResponse;
import com.corevance.portfolio.paymenttype.data.PaymentTypeUpdateRequest;
import com.corevance.portfolio.paymenttype.data.PaymentTypeUpdateResponse;
...
import com.corevance.portfolio.paymenttype.mapper.PaymentTypeCreateRequestMapper;
...
public class PaymentTypeWriteServiceImpl implements PaymentTypeWriteService {
    ...
    @Override
    @CacheEvict(value = "payment_types", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('payment_types')")
