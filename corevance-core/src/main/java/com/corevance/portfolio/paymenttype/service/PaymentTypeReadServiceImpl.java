...
import com.corevance.portfolio.paymenttype.mapper.PaymentTypeMapper;
...
public class PaymentTypeReadServiceImpl implements PaymentTypeReadService {
    ...
    @Override
    @Cacheable(value = "payment_types", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('payment_types')")
    ...
    @Override
    @Cacheable(value = "paymentTypesWithCode", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('payment_types')")
    ...
    /*
     * // TODO: do proper jakarta validation to corevance api error mapping private void
