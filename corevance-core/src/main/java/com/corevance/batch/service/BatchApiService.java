...
public interface BatchApiService {
    ...
    /**
     * Returns a list of {@link com.corevance.batch.domain.BatchResponse}s by getting the appropriate
     * CommandStrategy for every {@link com.corevance.batch.domain.BatchRequest}. It will be used when the Query
