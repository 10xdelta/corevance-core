...
public interface CommandStrategy {
    ...
    /**
     * Returns an object of type {@link com.corevance.batch.domain.BatchResponse}. This takes
     * {@link com.corevance.batch.domain.BatchRequest} as it's single argument and provides appropriate response.
     *
     * @param batchRequest
     * @param uriInfo
