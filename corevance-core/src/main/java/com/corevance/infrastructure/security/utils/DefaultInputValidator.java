 ...
 * under the License.
 */
package com.corevance.infrastructure.security.utils;
...
public class DefaultInputValidator implements InputValidator {
    ...
    private Map<String, CorevanceProperties.CorevanceInputValidationProfileProperties> profiles = new LinkedHashMap<>();
    ...
    public void init() {
        ...
        properties.getInputValidation().getProfiles().forEach(profile -> {
            ...
            profile.getPatternRefs()
                    .sort(Comparator.comparing(CorevanceProperties.CorevanceInputValidationPatternReferenceProperties::getOrder));
