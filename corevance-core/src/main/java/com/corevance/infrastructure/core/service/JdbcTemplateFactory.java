...
public class JdbcTemplateFactory {
    ...
    public JdbcTemplate create(CorevancePlatformTenant tenant) {
        return new JdbcTemplate(routingDataSource);
    }

    public NamedParameterJdbcTemplate createNamedParameterJdbcTemplate(CorevancePlatformTenant tenant) {
