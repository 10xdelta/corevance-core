 ...
 * under the License.
 */
package com.corevance.infrastructure.core.service.database;

import static com.corevance.infrastructure.core.domain.CorevancePlatformTenantConnection.resolveProtocol;
import static com.corevance.infrastructure.core.domain.CorevancePlatformTenantConnection.toJdbcUrl;
...
import com.corevance.infrastructure.core.service.database.metrics.TenantConnectionPoolMetricsTrackerFactory;
import org.springframework.beans.factory.annotation.Qualifier;
import org.springframework.stereotype.Component;

/**
 * Factory class to get data source service based on the details stored in {@link CorevancePlatformTenantConnection}
 * variable
 */
@Component
@Slf4j
...
public class DataSourcePerTenantServiceFactory {
    ...
    public DataSource createNewDataSourceFor(CorevancePlatformTenant tenant, CorevancePlatformTenantConnection tenantConnection) {
        ...
        config.setReadOnly(corevanceProperties.getMode().isReadOnlyMode());
    ...
    private int getMaxPoolSize(CorevancePlatformTenantConnection tenantConnection) {
        CorevanceProperties.CorevanceConfigProperties configOverride = corevanceProperties.getTenant().getConfig();
    ...
    private int getMinPoolSize(CorevancePlatformTenantConnection tenantConnection) {
        CorevanceProperties.CorevanceConfigProperties configOverride = corevanceProperties.getTenant().getConfig();
