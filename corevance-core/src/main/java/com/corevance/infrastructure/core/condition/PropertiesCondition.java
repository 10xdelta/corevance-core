...
public abstract class PropertiesCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        CorevanceProperties properties = SpringPropertiesFactory.get(context.getEnvironment(), CorevanceProperties.class);
        return matches(properties);
    }

    protected abstract boolean matches(CorevanceProperties properties);
}
