 ...
 * under the License.
 */
package com.corevance.infrastructure.core.exceptionmapper;
...
import com.corevance.infrastructure.core.exception.AbstractIdempotentCommandException;
...
@Scope("singleton")
@Slf4j
public class IdempotentCommandExceptionMapper implements CorevanceExceptionMapper, ExceptionMapper<AbstractIdempotentCommandException> {
