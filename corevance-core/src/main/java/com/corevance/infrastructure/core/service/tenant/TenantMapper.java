...
package com.corevance.infrastructure.core.service.tenant;
...
public final class TenantMapper implements RowMapper<CorevancePlatformTenant> {
    ...
    @Override
    public CorevancePlatformTenant mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
        final Long id = rs.getLong("id");
        final String tenantIdentifier = rs.getString("identifier");
        final String name = rs.getString("name");
        final String timezoneId = rs.getString("timezoneId");
        final CorevancePlatformTenantConnection connection = getDBConnection(rs);
        return new CorevancePlatformTenant(id, tenantIdentifier, name, timezoneId, connection);
    }

    // gets the DB connection
    private CorevancePlatformTenantConnection getDBConnection(ResultSet rs) throws SQLException {
        ...
        return new CorevancePlatformTenantConnection(connectionId, schemaName, schemaServer, schemaServerPort, schemaConnectionParameters,
