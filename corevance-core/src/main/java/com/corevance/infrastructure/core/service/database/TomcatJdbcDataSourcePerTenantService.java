...
import com.corevance.infrastructure.configuration.service.MoneyHelperInitializationService;
 ...
 *
 * {@link ThreadLocalContextUtil} is used to retrieve the {@link CorevancePlatformTenant} for the request.
 */
@Slf4j
@Service
...
public class TomcatJdbcDataSourcePerTenantService implements RoutingDataSourceService, ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataSource retrieveDataSource() {
        ...
        if (tenant != null) {
            final CorevancePlatformTenantConnection tenantConnection = tenant.getConnection();
    ...
    private void initializeDataSourceConnection(CorevancePlatformTenant tenant) {
