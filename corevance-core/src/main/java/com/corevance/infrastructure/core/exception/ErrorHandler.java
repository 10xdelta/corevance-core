...
public final class ErrorHandler {
    ...
    public <T extends RuntimeException> ExceptionMapper<T> findMostSpecificExceptionHandler(T exception) {
        ...
        do {
            ...
            Set<String> corevanceErrorMappers = createSet(ctx.getBeanNamesForType(CorevanceExceptionMapper.class));
            SetUtils.SetView<String> intersection = SetUtils.intersection(exceptionMappers, corevanceErrorMappers);
    ...
    public ErrorInfo handle(@NotNull RuntimeException exception) {
        ...
        Integer errorCode = exceptionMapper instanceof CorevanceExceptionMapper ? ((CorevanceExceptionMapper) exceptionMapper).errorCode()
                : null;
