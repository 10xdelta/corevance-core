...
@AllArgsConstructor
@Jacksonized
public class CorevancePlatformTenantConnection implements Serializable {
    ...
    public CorevancePlatformTenantConnection(final Long connectionId, final String schemaName, String schemaServer,
