...
import static com.corevance.infrastructure.core.service.database.DatabasePasswordEncryptor.DEFAULT_ENCRYPTION;
...
public final class DatabasePasswordDecryptor {
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out.println(
                    "Usage: java -cp corevance-provider.jar -Dloader.main=com.corevance.infrastructure.core.service.database.DatabasePasswordDecryptor org.springframework.boot.loader.launch.PropertiesLauncher <masterPassword> <base64Password>");
            System.exit(1);
        }
