 ...
 * under the License.
 */
package com.corevance.infrastructure.event.external.service.message;
...
import com.corevance.infrastructure.event.external.service.message.domain.MessageBusinessDate;
import com.corevance.infrastructure.event.external.service.message.domain.MessageCategory;
import com.corevance.infrastructure.event.external.service.message.domain.MessageCreatedAt;
import com.corevance.infrastructure.event.external.service.message.domain.MessageData;
import com.corevance.infrastructure.event.external.service.message.domain.MessageDataSchema;
import com.corevance.infrastructure.event.external.service.message.domain.MessageId;
import com.corevance.infrastructure.event.external.service.message.domain.MessageIdempotencyKey;
import com.corevance.infrastructure.event.external.service.message.domain.MessageSource;
import com.corevance.infrastructure.event.external.service.message.domain.MessageType;
