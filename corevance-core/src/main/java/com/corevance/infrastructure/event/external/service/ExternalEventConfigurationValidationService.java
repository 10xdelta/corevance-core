...
import com.corevance.infrastructure.event.external.exception.ExternalEventConfigurationNotFoundException;
import com.corevance.infrastructure.event.external.service.validation.ExternalEventSourceService;
...
public class ExternalEventConfigurationValidationService implements InitializingBean {
    ...
    private void validateEventConfigurationForIndividualTenant(CorevancePlatformTenant tenant, List<String> eventClasses)
    ...
    private List<String> getExternalEventConfigurationsForTenant(CorevancePlatformTenant tenant) {
