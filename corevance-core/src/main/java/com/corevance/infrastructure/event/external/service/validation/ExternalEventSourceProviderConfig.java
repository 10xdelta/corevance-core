 ...
 * under the License.
 */
package com.corevance.infrastructure.event.external.service.validation;
...
public class ExternalEventSourceProviderConfig {
    ...
    private static final String EXTERNAL_EVENT_CLASSES_BASE_PACKAGE = "com.corevance";

    @Bean
    public ExternalEventSourceProvider corevanceExternalEventSourceProvider() {
