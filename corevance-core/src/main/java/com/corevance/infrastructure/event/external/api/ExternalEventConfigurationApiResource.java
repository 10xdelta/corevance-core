 ...
 * under the License.
 */
package com.corevance.infrastructure.event.external.api;
...
import com.corevance.infrastructure.event.external.command.ExternalConfigurationsUpdateCommand;
import com.corevance.infrastructure.event.external.data.ExternalEventConfigurationResponse;
import com.corevance.infrastructure.event.external.data.ExternalEventConfigurationUpdateRequest;
import com.corevance.infrastructure.event.external.data.ExternalEventConfigurationUpdateResponse;
import com.corevance.infrastructure.event.external.service.ExternalEventConfigurationReadPlatformService;
