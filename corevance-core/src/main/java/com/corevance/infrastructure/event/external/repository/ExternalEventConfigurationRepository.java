 ...
 * under the License.
 */
package com.corevance.infrastructure.event.external.repository;
...
public interface ExternalEventConfigurationRepository
    ...
    @Override
    @Cacheable(key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#externalEventType)")
