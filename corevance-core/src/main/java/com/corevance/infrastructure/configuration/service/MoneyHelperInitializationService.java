...
public class MoneyHelperInitializationService {
     ...
     */
    public void initializeTenantRoundingMode(CorevancePlatformTenant tenant) {
        if (tenant == null) {
        ...
        CorevancePlatformTenant originalTenant = ThreadLocalContextUtil.getTenant();
        try {
    ...
    public boolean isTenantInitialized(CorevancePlatformTenant tenant) {
