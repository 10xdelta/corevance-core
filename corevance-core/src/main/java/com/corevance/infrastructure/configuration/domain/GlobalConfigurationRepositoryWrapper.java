...
public class GlobalConfigurationRepositoryWrapper {
    ...
    @Cacheable(value = "configByName", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#propertyName)")
    ...
    @CacheEvict(value = "configByName", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#propertyName)")
