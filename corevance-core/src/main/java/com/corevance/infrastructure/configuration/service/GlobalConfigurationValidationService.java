...
import com.corevance.infrastructure.configuration.exception.GlobalConfigurationException;
...
public class GlobalConfigurationValidationService implements InitializingBean {
    ...
    private void validateGlobalConfigurationForIndividualTenant(CorevancePlatformTenant tenant) {
    ...
    private List<String> getGlobalConfigurationNames(CorevancePlatformTenant tenant) {
