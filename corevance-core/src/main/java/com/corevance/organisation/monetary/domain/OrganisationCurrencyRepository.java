...
public interface OrganisationCurrencyRepository
    ...
    String FIND_CURRENCY_DETAILS = "SELECT new com.corevance.organisation.monetary.data.CurrencyData(oc.code, oc.name, oc.decimalPlaces, oc.inMultiplesOf, oc.displaySymbol, oc.nameCode) FROM OrganisationCurrency oc ";
