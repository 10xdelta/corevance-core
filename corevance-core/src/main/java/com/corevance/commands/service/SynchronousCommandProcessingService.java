...
import static com.corevance.commands.domain.CommandProcessingResultType.ERROR;
import static com.corevance.commands.domain.CommandProcessingResultType.PROCESSED;
...
import com.corevance.commands.configuration.RetryConfigurationAssembler;
import com.corevance.commands.domain.CommandProcessingResultType;
import com.corevance.commands.domain.CommandSource;
import com.corevance.commands.domain.CommandWrapper;
import com.corevance.commands.exception.RollbackTransactionNotApprovedException;
...
import com.corevance.commands.provider.CommandHandlerProvider;
...
import com.corevance.infrastructure.core.domain.BatchRequestContextHolder;
...
import com.corevance.infrastructure.core.exception.IdempotentCommandProcessFailedException;
import com.corevance.infrastructure.core.exception.IdempotentCommandProcessSucceedException;
import com.corevance.infrastructure.core.exception.IdempotentCommandProcessUnderProcessingException;
...
public class SynchronousCommandProcessingService implements CommandProcessingService {
    ...
    private CommandProcessingResult executeCommandAttempt(CommandExecutionContext executionContext) {
        ...
        Long commandId = (Long) corevanceRequestContextHolder.getAttribute(COMMAND_SOURCE_ID, null);
    ...
    private void storeCommandIdInContext(CommandSource savedCommandSource) {
        ...
        corevanceRequestContextHolder.setAttribute(COMMAND_SOURCE_ID, savedCommandSource.getId());
    }
    ...
    private void setIdempotencyKeyStoreFlag(boolean flag) {
        corevanceRequestContextHolder.setAttribute(IDEMPOTENCY_KEY_STORE_FLAG, flag);
    }
