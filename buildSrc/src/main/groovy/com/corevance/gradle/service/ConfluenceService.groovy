 ...
 * under the License.
 */
package com.corevance.gradle.service
...
import com.corevance.gradle.CorevancePluginExtension.CorevancePluginConfigConfluence
...
class ConfluenceService {
    ...
    ConfluenceService(CorevancePluginConfigConfluence config) {
...
// curl -u aleks:xxx -X POST -H 'Content-Type: application/json' -d '{"type":"page","title":"1.7.0 - Apache Corevance","space":{"key":"COREVANCE"},"ancestors":[{"id":75974324}],"body":{"storage":{"value":"<p>This is <br/> a new page</p>","representation": "storage"}}}' https://cwiki.apache.org/confluence/content/ | python -mjson.tool