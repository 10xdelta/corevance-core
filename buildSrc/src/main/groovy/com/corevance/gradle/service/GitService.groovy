...
class GitService {
    ...
    GitService(CorevancePluginExtension.CorevancePluginConfigGit config, CorevancePluginExtension.CorevancePluginConfigGpg gpgConfig) {
    ...
    void config(String directory, List<CorevancePluginExtension.CorevancePluginConfigGitSection> sections) {
        Git git = Git.open(new File(directory));
