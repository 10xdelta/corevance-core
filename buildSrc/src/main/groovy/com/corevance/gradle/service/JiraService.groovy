...
class JiraService {
    ...
    JiraService(CorevancePluginExtension.CorevancePluginConfigJira config) {
    ...
    CorevancePluginExtension.CorevancePluginJiraParams search(CorevancePluginExtension.CorevancePluginJiraParams params) {
        def query = [:]
