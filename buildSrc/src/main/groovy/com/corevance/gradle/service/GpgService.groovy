...
import com.corevance.gradle.CorevancePluginExtension
import com.corevance.gradle.CorevancePluginExtension.CorevancePluginConfigGpg
...
class GpgService {
    ...
    GpgService(CorevancePluginConfigGpg config) {
    ...
    void sign(CorevancePluginExtension.CorevancePluginGpgParams params) {
    ...
    void sha512(CorevancePluginExtension.CorevancePluginGpgParams params) {
        params.files.findAll {
