...
import com.corevance.gradle.CorevancePluginExtension.CorevancePluginEmailParams
...
class EmailService {
    ...
    EmailService(CorevancePluginExtension.CorevancePluginConfigSmtp config) {
    ...
    void send(CorevancePluginEmailParams params) {
