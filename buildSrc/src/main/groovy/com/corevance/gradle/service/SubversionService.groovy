...
class SubversionService {
    ...
    SubversionService(CorevancePluginExtension.CorevancePluginConfigSubversion config) {
    ...
    void checkout(CorevancePluginExtension.CorevancePluginSubversionParams params) {
    ...
    void commit(CorevancePluginExtension.CorevancePluginSubversionParams params) {
        // TODO: implement this
        SVNURL svnUrl = SVNURL.parseURIEncoded(params.url)
    }
}
