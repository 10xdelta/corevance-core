...
class TemplateService {
    ...
    TemplateService(CorevancePluginExtension.CorevancePluginConfigTemplate config) {
    ...
    CorevancePluginExtension.CorevancePluginTemplateParams render(CorevancePluginExtension.CorevancePluginTemplateParams params, Object data) {
