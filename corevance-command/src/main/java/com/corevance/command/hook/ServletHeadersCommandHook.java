 ...
 * under the License.
 */
package com.corevance.command.hook;

import static com.corevance.command.core.CommandConstants.COMMAND_HOOK_ORDER_HEADERS;
import static com.corevance.command.core.CommandConstants.COMMAND_HTTP_HEADER_IP;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang3.StringUtils;
import com.corevance.command.core.Command;
import com.corevance.command.core.CommandHookBefore;
import com.corevance.command.core.CommandProperties;
...
@ConditionalOnProperty(value = "corevance.command.hooks.servlet-header-pre", havingValue = "true")
