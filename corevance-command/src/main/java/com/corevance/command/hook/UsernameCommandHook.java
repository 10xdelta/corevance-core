...
import static com.corevance.command.core.CommandConstants.COMMAND_HOOK_ORDER_USERNAME;
...
@ConditionalOnProperty(value = "corevance.command.hooks.username-pre", havingValue = "true")
