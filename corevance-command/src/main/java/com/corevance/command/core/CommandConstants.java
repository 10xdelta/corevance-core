 ...
 * under the License.
 */
package com.corevance.command.core;
...
public final class CommandConstants {
    ...
    public static final String COMMAND_HTTP_HEADER_REQUEST_ID = "x-corevance-request-id";
    public static final String COMMAND_HTTP_HEADER_TENANT_ID = "Corevance-Platform-TenantId";
