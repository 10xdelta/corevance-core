 ...
 * under the License.
 */
package com.corevance.portfolio.loanaccount.domain;
...
import com.corevance.portfolio.loanaccount.data.CumulativeIncomeFromIncomePosting;
import com.corevance.portfolio.loanaccount.data.LoanScheduleDelinquencyData;
import com.corevance.portfolio.loanaccount.data.TransactionPortionsForForeclosure;
import com.corevance.portfolio.loanaccount.data.UnpaidChargeData;
...
public interface LoanTransactionRepository extends JpaRepository<LoanTransaction, Long>, JpaSpecificationExecutor<LoanTransaction> {
    ...
    @Query("""
            SELECT new com.corevance.portfolio.loanaccount.data.LoanScheduleDelinquencyData(
                lt.loan.id,
                min(lt.dateOf),
                0L,
                lt.loan
    ...
    @Query("""
                    SELECT new com.corevance.portfolio.loanaccount.data.UnpaidChargeData(
                        lc.charge.id,
                        lc.charge.name,
    ...
    @Query("""
                ...
                FROM LoanTransaction lt
                WHERE lt.loan = :loan
                AND lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.WAIVE_INTEREST
    ...
    @Query("""
            SELECT COALESCE(SUM(CASE WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL THEN lt.interestPortion
                 WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL_ADJUSTMENT THEN (0 - lt.interestPortion)
                 ELSE 0 END), 0)
            FROM LoanTransaction lt
            WHERE lt.loan = :loan
            AND lt.reversed = false
    ...
    @Query("""
            ...
            WHERE lt.loan = :loan
                AND lt.reversed = false
                AND lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL
    ...
    @Query("""
            ...
            AND lt.typeOf NOT IN (
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CONTRA,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.MARKED_FOR_RESCHEDULING,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL_ADJUSTMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.APPROVE_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.INITIATE_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REJECT_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.WITHDRAW_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION_ADJUSTMENT
            )
            """)
    ...
    @Query("""
            ...
            WHERE lt.loan = :loan
                ...
                AND lt.typeOf NOT IN (
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.DISBURSEMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REPAYMENT_AT_DISBURSEMENT
            )
            ORDER BY lt.dateOf
            """)
    ...
    @Query("""
            SELECT new com.corevance.portfolio.loanaccount.data.CumulativeIncomeFromIncomePosting(
            ...
            WHERE lt.loan = :loan
                AND lt.reversed = false
                AND lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.INCOME_POSTING
            """)
    CumulativeIncomeFromIncomePosting findCumulativeIncomeByLoanAndType(@Param("loan") Loan loan);

    // (0 - x) instead of -x: avoids EclipseLink concurrent unary-negation race in ArgumentListFunctionExpression
    @Query("""
            SELECT COALESCE(SUM(CASE WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL THEN lcpb.amount
                 WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL_ADJUSTMENT THEN (0 - lcpb.amount)
                 ELSE 0 END), 0)
    ...
    @Query("""
            ...
            WHERE lcpb.loanCharge = :loanCharge
                AND lt.reversed = false
                AND lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.WAIVE_CHARGES
                AND lt.dateOf <= :tillDate
            """)
    ...
    // (0 - x) instead of -x: avoids EclipseLink concurrent unary-negation race in ArgumentListFunctionExpression
    @Query("""
            SELECT COALESCE(SUM(CASE WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION THEN lt.amount
              WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION_ADJUSTMENT THEN (0 - lt.amount)
              ELSE 0 END), 0) FROM LoanTransaction lt
            WHERE lt.loan = :loan
            AND lt.reversed = false
            AND (lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION
              OR lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION_ADJUSTMENT)
            """)
    BigDecimal getAmortizedAmountCapitalizedIncome(@Param("loan") Loan loan);

    // (0 - x) instead of -x: avoids EclipseLink concurrent unary-negation race in ArgumentListFunctionExpression
    @Query("""
            SELECT COALESCE(SUM(CASE WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.BUY_DOWN_FEE_AMORTIZATION THEN lt.amount
              WHEN lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.BUY_DOWN_FEE_AMORTIZATION_ADJUSTMENT THEN (0 - lt.amount)
              ELSE 0 END), 0) FROM LoanTransaction lt
            WHERE lt.loan = :loan
            AND lt.reversed = false
            AND (lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.BUY_DOWN_FEE_AMORTIZATION
              OR lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.BUY_DOWN_FEE_AMORTIZATION_ADJUSTMENT)
            """)
    ...
    @Query("""
            ...
            AND ltr.relationType = com.corevance.portfolio.loanaccount.domain.LoanTransactionRelationTypeEnum.ADJUSTMENT
            """)
    ...
    @Query("""
            ...
            WHERE lt.loan = :loan
                ...
                AND lt.amount > 0
                AND lt.typeOf IN (
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REPAYMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.MERCHANT_ISSUED_REFUND,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.PAYOUT_REFUND,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.GOODWILL_CREDIT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CHARGE_REFUND,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CHARGE_ADJUSTMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.DOWN_PAYMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.INTEREST_PAYMENT_WAIVER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.INTEREST_REFUND,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_ADJUSTMENT
                )
            """)
    ...
    @Query("""
            ...
            WHERE lt.loan = :loan
                ...
                AND lt.typeOf NOT IN (
                    ...
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL_ADJUSTMENT,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.ACCRUAL_ACTIVITY,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.APPROVE_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.INITIATE_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REJECT_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.WITHDRAW_TRANSFER,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CHARGE_OFF,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REAMORTIZE,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.REAGE,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CONTRACT_TERMINATION,
                    com.corevance.portfolio.loanaccount.domain.LoanTransactionType.CAPITALIZED_INCOME_AMORTIZATION_ADJUSTMENT
                )
            ORDER BY lt.dateOf, lt.createdDate, lt.id
            """)
    ...
    @Query("""
            ...
            WHERE lt.loan = :loan
                AND lt.reversed = false
                AND lt.typeOf = com.corevance.portfolio.loanaccount.domain.LoanTransactionType.RECOVERY_REPAYMENT
            """)
