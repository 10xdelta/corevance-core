...
import com.corevance.portfolio.loanaccount.exception.LoanTransactionProcessingStrategyNotFoundException;
...
public class LoanRepaymentScheduleTransactionProcessorFactory {
    ...
    @Value("${corevance.loan.transactionprocessor.error-not-found-fail}")
