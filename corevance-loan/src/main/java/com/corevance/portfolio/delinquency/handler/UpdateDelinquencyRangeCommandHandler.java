 ...
 * under the License.
 */
package com.corevance.portfolio.delinquency.handler;
...
@CommandType(entity = "DELINQUENCY_RANGE", action = "UPDATE")
public class UpdateDelinquencyRangeCommandHandler implements NewCommandSourceHandler {
