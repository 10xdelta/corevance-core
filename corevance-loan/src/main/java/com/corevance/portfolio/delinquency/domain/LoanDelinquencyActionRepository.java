 ...
 * under the License.
 */
package com.corevance.portfolio.delinquency.domain;
...
public interface LoanDelinquencyActionRepository
    ...
    @Query(value = "select da from LoanDelinquencyAction da where "
            + "    ((da.action = com.corevance.portfolio.delinquency.domain.DelinquencyAction.PAUSE and da.endDate is not null and :business_date >= da.startDate and :business_date <= da.endDate) or"
            + "    (da.action = com.corevance.portfolio.delinquency.domain.DelinquencyAction.RESUME and da.endDate is null and :business_date >= da.startDate)) and"
