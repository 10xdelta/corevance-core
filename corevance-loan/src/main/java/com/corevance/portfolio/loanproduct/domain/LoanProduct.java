 ...
 * under the License.
 */
package com.corevance.portfolio.loanproduct.domain;
...
public class LoanProduct extends AbstractPersistableCustom<Long> {
    ...
    // TODO COREVANCE-1932-Corevance modularization: Move to corevance-progressive-loan module after removing association
