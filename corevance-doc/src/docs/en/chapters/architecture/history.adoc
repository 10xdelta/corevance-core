...
Corevance was an idea born out of a wish to create and deploy technology that allows the microfinance industry to scale. The goal is to:
...
* 2016: Corevance 1.x began incubation at Apache
