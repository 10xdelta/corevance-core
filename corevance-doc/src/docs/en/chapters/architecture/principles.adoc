...
The Corevance platform has been developed with support for multi-tenancy at the core of its design. This means that it is just as easy to use the platform for Software-as-a-Service (SaaS) type offerings as it is for local installations.
...
Source code starts from https://github.com/apache/corevance/tree/develop/corevance-provider/src/main/java/com/corevance
