...
* Query: GET /users
* HTTPS API: retrieveAll method on *com.corevance.useradministration.api.UsersApiResource* invoked
...
* HTTPS API: create method on com.corevance.useradministration.api.UsersApiResource invoked

.UsersApiResource.create
[source,java]
----
include::{rootdir}/corevance-provider/src/main/java/com/corevance/useradministration/api/UsersApiResource.java[lines=168..188]
----
...
[source,java]
----
include::{rootdir}/corevance-core/src/main/java/com/corevance/commands/service/PortfolioCommandSourceWritePlatformServiceImpl.java[lines=69..129]
----
...
[source,java]
----
include::{rootdir}/corevance-core/src/main/java/com/corevance/commands/service/SynchronousCommandProcessingService.java[lines=84..150]
----
