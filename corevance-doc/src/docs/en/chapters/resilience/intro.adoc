...
Corevance had handcrafted retry loops in place for the longest time. A typical retry code would have looked like this:
...
[source,java]
----
include::{rootdir}/corevance-core/src/main/java/com/corevance/commands/service/PortfolioCommandSourceWritePlatformServiceImpl.java[lines=49..76]
----
