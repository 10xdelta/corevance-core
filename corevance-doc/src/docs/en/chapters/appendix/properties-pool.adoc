...
|COREVANCE_HIKARI_DRIVER_SOURCE_CLASS_NAME
|org.mariadb.jdbc.Driver
|The correct driver name for the database that will be used with corevance.

|spring.datasource.hikari.jdbcUrl
|COREVANCE_HIKARI_JDBC_URL
|jdbc:mariadb://localhost:3306/corevance_tenants
|The database connection string for the database with tenant information that will be used with corevance.

|spring.datasource.hikari.username
|COREVANCE_HIKARI_USERNAME
|root
|The username for the database with tenant information that will be used with corevance

|spring.datasource.hikari.password
|COREVANCE_HIKARI_PASSWORD
|mysql
|The password for the database with tenant information that will be used with corevance

|spring.datasource.hikari.minimumIdle
|COREVANCE_HIKARI_MINIMUM_IDLE
|3
|The minimum number of connections in hakari pool that will be maintained when the system is idle

|spring.datasource.hikari.maximumPoolSize
|COREVANCE_HIKARI_MAXIMUM_POOL_SIZE
|10
|The maximum number of connections that hikari can create in the pool.

|spring.datasource.hikari.idleTimeout
|COREVANCE_HIKARI_IDLE_TIMEOUT
|60000
...
|COREVANCE_HIKARI_CONNECTION_TIMEOUT
|20000
...
|COREVANCE_HIKARI_DS_PROPERTIES_CACHE_PREP_STMTS
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_PREP_STMT_CACHE_SIZE
|250
...
|COREVANCE_HIKARI_DS_PROPERTIES_PREP_STMT_CACHE_SQL_LIMIT
|2048
...
|COREVANCE_HIKARI_DS_PROPERTIES_USE_SERVER_PREP_STMTS
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_USE_LOCAL_SESSION_STATE
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_REWRITE_BATCHED_STATEMENTS
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_CACHE_RESULT_SET_METADATA
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_CACHE_SERVER_CONFIGURATION
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_ELIDE_SET_AUTO_COMMITS
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_MAINTAIN_TIME_STATS
|false
...
|COREVANCE_HIKARI_DS_PROPERTIES_LOG_SLOW_QUERIES
|true
...
|COREVANCE_HIKARI_DS_PROPERTIES_DUMP_QUERIES_IN_EXCEPTION
|true
