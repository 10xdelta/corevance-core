...
|server.ssl.ciphers
|COREVANCE_SERVER_SSL_CIPHERS
|TLS_RSA_WITH_AES_128_CBC_SHA256
|This property allows you to control the cipher suites that corevance will accept for secure connections

|server.ssl.enabled-protocols
|COREVANCE_SERVER_SSL_PROTOCOLS
|TLSv1.2
...
|COREVANCE_SERVER_SSL_KEY_STORE
...
|COREVANCE_SERVER_SSL_KEY_STORE_PASSWORD
|openmf
