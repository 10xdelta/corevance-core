...
It is very easy to add your own business steps to Corevance's default steps:

1. Create a custom module (e. g. `custom/acme/steps`, follow the instructions on how to create a custom module)
2. Create a class that implements interface `com.corevance.cob.COBBusinessStep`
...
[source,java]
----
include::{rootdir}/corevance-cob/src/main/java/com/corevance/cob/COBBusinessStep.java[lines=19..]
----
...
[source,java]
----
include::{rootdir}/custom/acme/loan/cob/src/main/java/com/acme/corevance/loan/cob/AcmeNoopBusinessStep.java[lines=19..]
----
