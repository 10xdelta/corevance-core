...
Corevance has 7 built-in loan transaction processors:

1. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.CreocoreLoanRepaymentScheduleTransactionProcessor`
2. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.EarlyPaymentLoanRepaymentScheduleTransactionProcessor`
3. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.CorevanceStyleLoanRepaymentScheduleTransactionProcessor`
4. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.HeavensFamilyLoanRepaymentScheduleTransactionProcessor`
5. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.InterestPrincipalPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor`
6. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.PrincipalInterestPenaltyFeesOrderLoanRepaymentScheduleTransactionProcessor`
7. `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.RBILoanRepaymentScheduleTransactionProcessor`

.Default Loan Transaction Processor configuration
[source,java]
----
include::{rootdir}/corevance-provider/src/main/java/com/corevance/portfolio/loanaccount/starter/LoanAccountAutoStarter.java[lines=38..80]
----
...
[source,properties]
----
include::{rootdir}/corevance-provider/src/main/resources/application.properties[lines=64..70]
----
...
[source,java]
----
include::{rootdir}/corevance-loan/src/main/java/com/corevance/portfolio/loanaccount/domain/transactionprocessor/LoanRepaymentScheduleTransactionProcessor.java[lines=19..]
----

.Custom Loan Transaction Processor Example
[source,java]
----
include::{rootdir}/custom/acme/loan/processor/src/main/java/com/acme/corevance/loan/processor/AcmeLoanRepaymentScheduleTransactionProcessor.java[lines=19..]
----

The example implementation doesn't do much. We are just overriding one of the default processor implementations `com.corevance.portfolio.loanaccount.domain.transactionprocessor.impl.CorevanceStyleLoanRepaymentScheduleTransactionProcessor` and give the custom processor it's own lookup code and name (descriptive text for display in UIs, e. g. when configuring a loan product). As usual it is a good idea to follow some simple conventions:
...
[source,java]
----
include::{rootdir}/corevance-loan/src/main/java/com/corevance/portfolio/loanaccount/domain/LoanRepaymentScheduleTransactionProcessorFactory.java[lines=19..]
----
...
[source,java]
----
include::{rootdir}/corevance-provider/src/main/java/com/corevance/portfolio/loanaccount/starter/LoanAccountAutoStarter.java[lines=81..87]
----
...
[source,java]
----
include::{rootdir}/custom/acme/loan/starter/src/main/java/com/acme/corevance/loan/starter/AcmeLoanAutoConfiguration.java[lines=36..41]
----

.Processor Lookup Failure Configuration Property
[source,properties]
----
include::{rootdir}/corevance-provider/src/main/resources/application.properties[lines=71..71]
----
