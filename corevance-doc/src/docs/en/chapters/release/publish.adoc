...
This is quite similiar to the Corevance release plugin properties for GPG. In one of the next release we'll merge these two setups to avoid this duplicated configuration.
...
For convenience we will be using Github Packages to publish Corevance's Typescript API client.
