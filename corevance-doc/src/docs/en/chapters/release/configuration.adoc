...
Before you can start using the Corevance release plugin to create releases you have to configure and setup a couple of things first.

* All official communication concerning releases happens on the mailto:dev@corevance.apache.org[mailing list]. Every release manager needs to be a member of and engaging on the mailing list for credibility.
* Make sure you have edit permissions on the https://cwiki.apache.org/confluence/display/COREVANCE[Apache Confluence Wiki]
...
* Familiarity with building Corevance locally and creating release distributions is required
