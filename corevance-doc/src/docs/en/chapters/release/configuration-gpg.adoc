...
+
IMPORTANT: Please contact a PMC member to add your GPG public key in Corevance's Subversion repository. This is necessary to be able to validate published releases.
