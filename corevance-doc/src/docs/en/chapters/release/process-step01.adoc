...
The RM should, if one doesn't already exist, first create a new release umbrella issue in JIRA. This issue is dedicated to tracking (a summary of) any discussion related to the planned new release. An example of such an issue is https://issues.apache.org/jira/browse/COREVANCE-873[COREVANCE-873].
...
----
./gradlew corevanceReleaseStep1 -Pcorevance.release.issue=1234 -Pcorevance.releaseBranch.date="Monday, April 25, 2022" -Pcorevance.release.version={revnumber}
----
