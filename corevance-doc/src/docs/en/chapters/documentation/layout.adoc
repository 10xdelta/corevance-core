...
* images are located in `corevance-doc/src/docs/en/images` (or sub-folders)
* diagrams are located in `corevance-doc/src/docs/en/diagrams` (or sub-folders)
* specific chapters are located in `corevance-doc/src/docs/en/chapters`
...
NOTE: These rules are not entirely set in stone and could be modified if necessary. If you see any issues then please report them on the mailto:dev@corevance.apache.org[mailing list] or https://issues.apache.org[open a Jira ticket].
