...
Both mechanisms operate on the same underlying *breach schedule* — a series of contiguous time periods generated per-loan by the Close of Business (COB) pipeline. The feature is implemented in the `corevance-working-capital-loan` module.
