...
Corevance supports the direct modification of the approved amount on loans
...
Corevance supports the indirect modification of the approved amount on loans. This is called modifying the available disbursement amount.
