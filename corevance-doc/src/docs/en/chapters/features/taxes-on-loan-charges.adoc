...
[NOTE]
====
Introduced in link:https://issues.apache.org/jira/browse/COREVANCE-1289[COREVANCE-1289] — Tax component not working as expected: tax bifurcation in journal entries was not applied when a tax group was mapped to a loan charge.
====
