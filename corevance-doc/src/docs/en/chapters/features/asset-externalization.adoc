...
The Asset Externalization capability enables **loan ownership transfer** between a **Platform Owner** and external investors within **Corevance**, supporting:
...
### In Scope (Corevance Responsibilities)
...
* Credit ETL (Extract, Transform, Load) schema decisions outside Corevance
...
* Corevance SOR → Adaptor → Credit ETL
