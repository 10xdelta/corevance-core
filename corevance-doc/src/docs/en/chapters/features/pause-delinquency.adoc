...
This document specifies the functional and business requirements for the Pause Delinquency feature in Corevance. It defines the rules for pausing and resuming delinquency calculations, database design, API endpoints, event handling, and validation rules.
