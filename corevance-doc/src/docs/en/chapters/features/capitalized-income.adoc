...
[NOTE]
====
In Corevance, balance of a transaction is either: Principal, Fee, Penalty, Interest or overpayment
====
...
The Capitalized Income transaction in Apache Corevance performs the following actions:
...
A Capitalized Income Amortization transaction in Apache Corevance does the following:
...
A Capitalized Income Adjustment transaction in Apache Corevance serves to reduce the balance of an existing capitalized income transaction.
...
A Capitalized Income Amortization Adjustment in Apache Corevance is a special transaction type used to reverse previously recognized income from capitalized income amortization.
