 ...
 * under the License.
 */
package com.corevance.portfolio.charge.api;
...
import com.corevance.portfolio.charge.request.ChargeRequest;
...
@Tag(name = "Charges", description = """
        ...
        A Charge on corevance platform is what we use to model both Fees and Penalties.
