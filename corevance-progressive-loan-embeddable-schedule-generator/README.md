# Corevance Progressive Loan Embeddable Schedule Generator
...
- Generate Embeddable Progressive Schedule Generator Jar
    ...
    ```shell
        ./gradlew :corevance-progressive-loan-embeddable-schedule-generator:shadowJar
    ```

- Copy Jar from `corevance-progressive-loan-embeddable-schedule-generator/build/libs/corevance-progressive-loan-embeddable-schedule-generator-*-SNAPSHOT-all.jar` to Your class path.
...
The project directory structure:
  ...
  - `Main.java`
  - `corevance-embeddable-calculator-1.11.0-SNAPSHOT-all.jar`
...
- Compile the source
  ...
  ```shell
  javac -cp corevance-progressive-loan-embeddable-schedule-generator-1.11.0-SNAPSHOT-all.jar Main.java
  ```

- Run with dependencies:

  ```shell
  java -cp corevance-progressive-loan-embeddable-schedule-generator-1.11.0-SNAPSHOT-all.jar:. Main
  ```
