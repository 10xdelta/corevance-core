 ...
 *
 * @author Markus Geiss
 * @see com.corevance.organisation.teller.domain.TellerRepository
 * @since 2.0.0
 */
public interface TellerWritePlatformService {
     ...
     * @throws com.corevance.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.corevance.infrastructure.core.exception.InvalidJsonException
     */
     ...
     * @return {@code CommandProcessingResult} if successful
     * @throws com.corevance.organisation.teller.exception.TellerNotFoundException
     * @throws com.corevance.infrastructure.core.exception.PlatformApiDataValidationException
     * @throws com.corevance.infrastructure.core.exception.InvalidJsonException
     */
