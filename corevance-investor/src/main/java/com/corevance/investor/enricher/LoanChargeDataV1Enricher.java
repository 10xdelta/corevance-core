 ...
 * under the License.
 */
package com.corevance.investor.enricher;

import lombok.RequiredArgsConstructor;
import com.corevance.avro.loan.v1.LoanChargeDataV1;
import com.corevance.infrastructure.core.service.DataEnricher;
import com.corevance.infrastructure.event.external.service.serialization.mapper.support.ExternalIdMapper;
...
public class LoanChargeDataV1Enricher implements DataEnricher<LoanChargeDataV1> {
    ...
    @Override
    public Class<LoanChargeDataV1> getDataType() {
