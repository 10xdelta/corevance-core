...
import com.corevance.client.feign.support.ApiResponseDecoder;
 ...
 */
public final class CorevanceFeignClientConfig {
    ...
    private CorevanceFeignClientConfig(Builder builder) {
    ...
    public <T> T createClient(Class<T> apiType) {
        ...
        Encoder multipartEncoder = new CorevanceMultipartEncoder(jacksonEncoder);
        ...
        return Feign.builder().client(getOrCreateHttpClient()).encoder(multipartEncoder)
                ...
                .errorDecoder(new CorevanceErrorDecoder())
    ...
    public static class Builder {
        ...
        public CorevanceFeignClientConfig build() {
            ...
            return new CorevanceFeignClientConfig(this);
        }
    }
}
