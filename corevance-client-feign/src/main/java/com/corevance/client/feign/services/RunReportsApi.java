 ...
 * under the License.
 */
package com.corevance.client.feign.services;
...
public interface RunReportsApi {
     ...
     * or CSV formats. The Apache Corevance reference application uses a JQuery plugin called stretchy reporting which,
