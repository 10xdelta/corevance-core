...
/**
 * Custom multipart encoder for Corevance Feign clients. Uses Apache HttpClient's MultipartEntityBuilder to properly
 * construct multipart/form-data requests.
 */
public class CorevanceMultipartEncoder implements Encoder {

    private final Encoder delegate;

    public CorevanceMultipartEncoder(Encoder delegate) {
