...
import com.corevance.client.models.DocumentCreateResponse;
import com.corevance.client.models.DocumentData;
import com.corevance.client.models.DocumentDeleteResponse;
import com.corevance.client.models.DocumentUpdateResponse;
 ...
 * <a href="https://issues.apache.org/jira/browse/COREVANCE-1227">COREVANCE-1227</a>. If we could fix our OpenAPI /
...
public interface DocumentsApiFixed {
    ...
    DocumentCreateResponse createDocument(@Param("entityType") String entityType, @Param("entityId") Long entityId,
            com.corevance.client.feign.CorevanceMultipartEncoder.MultipartData multipartData);
    ...
    DocumentUpdateResponse updateDocument(@Param("entityType") String entityType, @Param("entityId") Long entityId,
            @Param("documentId") Long documentId, com.corevance.client.feign.CorevanceMultipartEncoder.MultipartData multipartData);
}
