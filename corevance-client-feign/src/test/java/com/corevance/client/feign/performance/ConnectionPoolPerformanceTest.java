 ...
 * under the License.
 */
package com.corevance.client.feign.performance;
...
class ConnectionPoolPerformanceTest {
    ...
    void testConnectionPoolTTL() throws Exception {
        CorevanceFeignClientConfig config = CorevanceFeignClientConfig.builder().baseUrl("http://localhost:" + wireMockServer.port())
