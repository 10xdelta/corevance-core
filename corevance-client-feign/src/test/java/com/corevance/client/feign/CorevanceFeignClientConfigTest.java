...
class CorevanceFeignClientConfigTest {

    @Test
    void testBuilderDefaults() {
        CorevanceFeignClientConfig.Builder builder = CorevanceFeignClientConfig.builder();
        CorevanceFeignClientConfig config = builder.baseUrl("http://localhost:8080").credentials("admin", "password").build();
    ...
    void testBuilderConfiguration() {
        ...
        CorevanceFeignClientConfig config = CorevanceFeignClientConfig.builder().baseUrl(baseUrl).credentials(username, password)
    ...
    void testConnectionTimeToLiveConfiguration() {
        ...
        CorevanceFeignClientConfig config = CorevanceFeignClientConfig.builder().baseUrl("http://localhost:8080")
