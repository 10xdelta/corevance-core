 ...
 * under the License.
 */
package com.corevance.infrastructure.dataqueries.api;
...
import com.corevance.infrastructure.core.service.PagedLocalRequest;
...
import com.corevance.portfolio.search.data.AdvancedQueryData;
...
@Tag(name = "Data Tables", description = """
        The datatables API allows you to plug-in your own tables (MySql) that have a relationship to a Apache Corevance \
        ...
        The Apache Corevance Reference App uses a JQuery plug-in called stretchydatatables (which in turn uses this \
...
public class DatatablesApiResource {
    ...
    @Operation(summary = "List Data Tables", description = """
            Lists registered data tables and the Apache Corevance Core application table they are registered to.

            ARGUMENTS

            apptable  - optional
            The Apache Corevance core application table.
    ...
    @Operation(summary = "Create Data Table", description = """
            Create a new data table and registers it with the Apache Corevance Core application table.
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete Data Table", description = "Deletes a data table and deregisters it from the Apache Corevance Core application table.")
    ...
    @Operation(summary = "Register Data Table", description = """
            Registers a data table with the Apache Corevance Core application table. This allows the data table to be \
    ...
    @Path("{datatable}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Data Table Details", description = "Lists a registered data table details and the Apache Corevance Core application table they are registered to.")
