...
import com.corevance.infrastructure.dataqueries.data.ReportExportType;
import com.corevance.infrastructure.dataqueries.data.ReportParameters;
...
public class RunreportsApiResource {
    ...
    @GET
    @Path("{reportName}")
    @Timed(value = "corevance.report.execution", description = "Time taken to execute reports", extraTags = { "component", "reporting" })
