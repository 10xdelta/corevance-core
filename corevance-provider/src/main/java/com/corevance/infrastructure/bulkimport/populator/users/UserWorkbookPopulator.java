 ...
 * under the License.
 */
package com.corevance.infrastructure.bulkimport.populator.users;

import java.util.List;
import com.corevance.infrastructure.bulkimport.constants.TemplatePopulateImportConstants;
import com.corevance.infrastructure.bulkimport.constants.UserConstants;
    ...
    private void setNames(Sheet usersheet, List<OfficeData> offices) {
        ...
        for (Integer i = 0; i < offices.size(); i++) {
            ...
            if (officeNameToBeginEndIndexesOfStaff != null) {
                setSanitized(userOfficeName, "Staff_" + offices.get(i).getName());
