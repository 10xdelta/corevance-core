 ...
 * under the License.
 */
package com.corevance.infrastructure.bulkimport.populator.centers;
...
public class CentersWorkbookPopulator extends AbstractWorkbookPopulator {
    ...
    private void setLookupTable(Sheet centerSheet, String dateFormat) {
        setOfficeDateLookupTable(centerSheet, officeSheetPopulator.getOffices(), CenterConstants.LOOKUP_OFFICE_NAME_COL,
                CenterConstants.LOOKUP_OFFICE_OPENING_DATE_COL, dateFormat);
        int rowIndex;
