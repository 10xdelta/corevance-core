 ...
 * under the License.
 */
package com.corevance.infrastructure.bulkimport.populator;
...
public abstract class AbstractWorkbookPopulator implements WorkbookPopulator {
    ...
    // letters/digits (\p{L}/\p{N}) are kept, matching the previous behaviour for accented names. See COREVANCE-1256.
    ...
    /**
     * See {@link Name#setNameName(String)} and https://issues.apache.org/jira/browse/COREVANCE-1256.
     */
