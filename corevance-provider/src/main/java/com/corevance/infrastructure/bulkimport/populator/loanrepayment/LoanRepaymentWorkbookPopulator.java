 ...
 * under the License.
 */
package com.corevance.infrastructure.bulkimport.populator.loanrepayment;
...
import com.corevance.infrastructure.bulkimport.constants.LoanRepaymentConstants;
...
import com.corevance.infrastructure.bulkimport.populator.comparator.LoanComparatorByStatusActive;
...
public final class LoanRepaymentWorkbookPopulator extends AbstractWorkbookPopulator {
    ...
    // COREVANCE-2668: when true, the tenant-wide client/office lookup sheets, the per-loan lookup table and the
    ...
    /** COREVANCE-2668 lean template: typed keys only, no client/office lookups; just the payment-type dropdown. */
    ...
    private void setRules(Sheet worksheet, String dateFormat) {
        ...
        // clients like "IRE'S LIMITED" (the Java sanitiser strips '\'' but this formula must too). See COREVANCE-1256.
