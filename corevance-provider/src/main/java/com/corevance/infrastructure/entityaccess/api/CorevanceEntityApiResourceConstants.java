...
public final class CorevanceEntityApiResourceConstants {

    private CorevanceEntityApiResourceConstants() {

    }

    public static final String COREVANCE_ENTITY_RESOURCE_NAME = "CorevanceEntity";
