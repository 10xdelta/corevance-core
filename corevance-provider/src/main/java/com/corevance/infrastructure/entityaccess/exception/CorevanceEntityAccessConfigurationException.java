...
public class CorevanceEntityAccessConfigurationException extends AbstractPlatformDomainRuleException {

    public CorevanceEntityAccessConfigurationException(final Long firstEntityId, final CorevanceEntityType entityType1,
            final CorevanceEntityAccessType accessType, final CorevanceEntityType entityType2) {
