 ...
 * under the License.
 */
package com.corevance.infrastructure.entityaccess.handler;
...
import com.corevance.infrastructure.entityaccess.service.CorevanceEntityAccessWriteService;
...
public class UpdateEntityToEntityMappingCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return this.corevanceEntityAccessWriteService.updateEntityToEntityMapping(command.entityId(), command);
    }
