...
import com.corevance.infrastructure.hooks.data.HookEventData;
import com.corevance.infrastructure.hooks.data.HookFieldData;
import com.corevance.infrastructure.hooks.data.HookGroupingData;
import com.corevance.infrastructure.hooks.data.HookTemplateData;
import com.corevance.infrastructure.hooks.domain.Hook;
import com.corevance.infrastructure.hooks.domain.HookEventResultSetExtractor;
...
public class HookReadPlatformServiceImpl implements HookReadPlatformService {
    ...
    @Override
    @Cacheable(value = "hooks", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('HK')")
