...
public final class ProcessorHelper {
    ...
    // Nota bene: Similar code to insecure HTTPS is also in Corevance Client's
    // com.corevance.client.util.CorevanceClient.Builder.insecure()
     ...
     */
    private final boolean insecureHttpClient = Boolean.getBoolean("corevance.insecureHttpClient");
