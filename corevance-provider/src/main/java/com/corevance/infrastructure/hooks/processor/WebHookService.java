...
public interface WebHookService {
    ...
    String ENTITY_HEADER = "X-Corevance-Entity";
    String ACTION_HEADER = "X-Corevance-Action";
    String TENANT_HEADER = "Corevance-Platform-TenantId";
    String ENDPOINT_HEADER = "X-Corevance-Endpoint";
    String API_KEY_HEADER = "X-Corevance-API-Key";
