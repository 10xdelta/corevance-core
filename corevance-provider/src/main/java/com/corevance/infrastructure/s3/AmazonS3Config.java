 ...
 * under the License.
 */
package com.corevance.infrastructure.s3;
...
import com.corevance.infrastructure.dataqueries.service.export.S3DatatableReportExportServiceImpl;
...
public class AmazonS3Config {
    ...
    public S3DatatableReportExportServiceImpl s3DatatableReportExportServiceImpl(ReadReportingService reportServiceImpl,
            ConfigurationDomainService configurationDomainService, S3Client s3Client, CorevanceProperties corevanceProperties) {
        return new S3DatatableReportExportServiceImpl(reportServiceImpl, configurationDomainService, s3Client, corevanceProperties);
    }
