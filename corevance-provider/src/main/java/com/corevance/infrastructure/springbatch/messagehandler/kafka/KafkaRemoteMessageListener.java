...
import com.corevance.infrastructure.springbatch.InputChannelInterceptor;
import com.corevance.infrastructure.springbatch.messagehandler.StepExecutionRequestHandler;
import com.corevance.infrastructure.springbatch.messagehandler.conditions.kafka.KafkaWorkerCondition;
...
public class KafkaRemoteMessageListener {
    ...
    @KafkaListener(topics = "${corevance.remote-job-message-handler.kafka.topic.name}")
