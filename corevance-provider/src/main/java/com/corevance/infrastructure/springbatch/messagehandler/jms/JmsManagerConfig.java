...
import com.corevance.infrastructure.springbatch.messagehandler.conditions.jms.JmsManagerCondition;
    ...
    public IntegrationFlow outboundFlow(ConnectionFactory connectionFactory) {
        return IntegrationFlow.from(outboundRequests) //
                ...
                .handle(Jms.outboundAdapter(connectionFactory)
                        .destination(corevanceProperties.getRemoteJobMessageHandler().getJms().getRequestQueueName()))
                .get();
    }
}
