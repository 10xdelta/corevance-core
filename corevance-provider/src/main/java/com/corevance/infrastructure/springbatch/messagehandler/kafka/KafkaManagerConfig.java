 ...
 * under the License.
 */
package com.corevance.infrastructure.springbatch.messagehandler.kafka;
...
import com.corevance.infrastructure.springbatch.ContextualMessage;
import com.corevance.infrastructure.springbatch.OutputChannelInterceptor;
import com.corevance.infrastructure.springbatch.messagehandler.conditions.kafka.KafkaManagerCondition;
...
public class KafkaManagerConfig {
    ...
    public ProducerFactory<Object, Object> producerFactory() {
        Map<String, Object> props = new HashMap<>(
                corevanceProperties.getRemoteJobMessageHandler().getKafka().getProducer().getExtraPropertiesMap());
        props.put(BOOTSTRAP_SERVERS_CONFIG, corevanceProperties.getRemoteJobMessageHandler().getKafka().getBootstrapServers());
    ...
    public IntegrationFlow outboundFlow(KafkaTemplate<?, ?> kafkaTemplate) {
        CorevanceProperties.KafkaTopicProperties topic = corevanceProperties.getRemoteJobMessageHandler().getKafka().getTopic();
