...
import com.corevance.infrastructure.core.config.CorevanceProperties.CorevanceRemoteJobMessageHandlerKafkaProperties;
...
public class KafkaWorkerConfig {
    ...
    public ConsumerFactory<Integer, Object> consumerFactory() {
        CorevanceRemoteJobMessageHandlerKafkaProperties kafkaProperties = corevanceProperties.getRemoteJobMessageHandler().getKafka();
