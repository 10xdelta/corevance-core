...
@Configuration
@ConditionalOnProperty(value = "corevance.remote-job-message-handler.jms.enabled", havingValue = "true")
public class JmsBrokerConfiguration {
    ...
    public ActiveMQConnectionFactory connectionFactory() {
        ...
        connectionFactory.setBrokerURL(corevanceProperties.getRemoteJobMessageHandler().getJms().getBrokerUrl());
        ...
        CorevanceProperties.CorevanceRemoteJobMessageHandlerJmsProperties jmsProps = corevanceProperties.getRemoteJobMessageHandler().getJms();
