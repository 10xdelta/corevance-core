 ...
 * under the License.
 */
package com.corevance.infrastructure.jobs.domain;
...
public interface ScheduledJobDetailRepository
    ...
    String GET_DATA = "select new com.corevance.infrastructure.jobs.data.JobDetailData(j.id, j.jobDisplayName, j.shortName, j.nextRunTime, "
