...
import static com.corevance.infrastructure.jobs.service.aggregationjob.JournalEntryAggregationJobConstant.JOB_SUMMARY_STEP_NAME;
import static com.corevance.infrastructure.jobs.service.aggregationjob.JournalEntryAggregationJobConstant.JOURNAL_ENTRY_AGGREGATION_JOB_NAME;
...
import com.corevance.infrastructure.jobs.service.aggregationjob.services.JournalEntryAggregationWriterService;
...
public class JournalEntryAggregationJobListener implements JobExecutionListener {
    ...
    public void beforeJob(final JobExecution jobExecution) {
        ...
        final LocalDate aggregatedOnDate = providedAggregatedOnDate != null //
                ? providedAggregatedOnDate.minusDays(corevanceProperties.getJob().getJournalEntryAggregation().getExcludeRecentNDays()) //
                : ThreadLocalContextUtil.getBusinessDateByType(BusinessDateType.BUSINESS_DATE)
                        .minusDays(corevanceProperties.getJob().getJournalEntryAggregation().getExcludeRecentNDays()); //
