 ...
 * under the License.
 */
package com.corevance.infrastructure.jobs;

import com.corevance.infrastructure.core.service.database.RoutingDataSource;
import com.corevance.infrastructure.jobs.config.CorevanceDataFieldMaxValueIncrementerFactory;
...
public class ScheduledJobRunnerConfig {
    ...
    public DataFieldMaxValueIncrementerFactory incrementerFactory(RoutingDataSource routingDataSource) {
        ...
        return new CorevanceDataFieldMaxValueIncrementerFactory(routingDataSource);
    }
