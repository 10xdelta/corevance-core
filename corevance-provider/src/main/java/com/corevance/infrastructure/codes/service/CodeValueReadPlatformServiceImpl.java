 ...
 * under the License.
 */
package com.corevance.infrastructure.codes.service;
...
public class CodeValueReadPlatformServiceImpl implements CodeValueReadPlatformService {
    ...
    @Override
    @Cacheable(value = "code_values", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#code+'cv')")
    ...
    @Override
    @Cacheable(value = "code_values", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#codeId+'cv')")
    ...
    @Override
    @Cacheable(value = "code_values", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#codeValueId+'cv_by_id')")
