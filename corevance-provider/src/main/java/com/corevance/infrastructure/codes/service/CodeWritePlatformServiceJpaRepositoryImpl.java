...
import com.corevance.infrastructure.codes.domain.Code;
import com.corevance.infrastructure.codes.domain.CodeRepository;
import com.corevance.infrastructure.codes.exception.CodeNotFoundException;
import com.corevance.infrastructure.codes.exception.SystemDefinedCodeCannotBeChangedException;
import com.corevance.infrastructure.codes.serialization.CodeCommandFromApiJsonDeserializer;
...
public class CodeWritePlatformServiceJpaRepositoryImpl implements CodeWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "codes", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
