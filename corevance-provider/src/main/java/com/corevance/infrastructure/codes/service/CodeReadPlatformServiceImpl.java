...
import com.corevance.infrastructure.codes.data.CodeData;
...
public class CodeReadPlatformServiceImpl implements CodeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "codes", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('CD')")
