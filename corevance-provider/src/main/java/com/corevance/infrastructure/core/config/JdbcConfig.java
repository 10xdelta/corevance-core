...
@Configuration
@EnableJdbcRepositories(basePackages = { "com.corevance.command.jdbc.store.domain",
        "com.corevance.infrastructure.documentmanagement.domain",
        "com.corevance.mix.domain" }, jdbcOperationsRef = "namedParameterJdbcTemplate", transactionManagerRef = "jdbcTransactionManager")
