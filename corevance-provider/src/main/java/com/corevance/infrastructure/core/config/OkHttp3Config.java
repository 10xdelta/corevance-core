...
public class OkHttp3Config {
    ...
    public OkHttpClient okHttpClient() throws Exception {
        var okBuilder = new OkHttpClient.Builder()//
                .connectTimeout(Duration.ofSeconds(corevanceProperties.getClientConnectTimeout()))//
                .readTimeout(Duration.ofSeconds(corevanceProperties.getClientReadTimeout()))//
                .writeTimeout(Duration.ofSeconds(corevanceProperties.getClientWriteTimeout())); //

        if (Boolean.TRUE.equals(corevanceProperties.getInsecureHttpClient())) {
