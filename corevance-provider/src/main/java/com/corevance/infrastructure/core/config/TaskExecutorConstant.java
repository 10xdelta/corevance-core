...
public final class TaskExecutorConstant {
    ...
    public static final String DEFAULT_TASK_EXECUTOR_BEAN_NAME = "corevanceDefaultThreadPoolTaskExecutor";
    public static final String CONFIGURABLE_TASK_EXECUTOR_BEAN_NAME = "corevanceConfigurableThreadPoolTaskExecutor";
