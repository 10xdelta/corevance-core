...
public class SpringConfig {
    ...
    @Bean(name = "corevanceEventExecutor")
    public ThreadPoolTaskExecutor corevanceEventExecutor(ThreadPoolTaskExecutorBuilder builder,
        ...
        ThreadPoolTaskExecutor executor = builder.threadNamePrefix("CorevanceEvent-").corePoolSize(coreSize).maxPoolSize(finalMaxSize)
    ...
    public SimpleApplicationEventMulticaster applicationEventMulticaster(
            @Qualifier("corevanceEventExecutor") ThreadPoolTaskExecutor taskExecutor) {
