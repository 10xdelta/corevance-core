...
import com.corevance.infrastructure.core.persistence.ExtendedDataSourceTransactionManager;
...
public class JdbcTransactionConfig {
    ...
    @Bean
    public PlatformTransactionManager jdbcTransactionManager(CorevanceProperties corevanceProperties, RoutingDataSource dataSource,
