 ...
 * under the License.
 */
package com.corevance.infrastructure.campaigns.jobs.sendmessagetosmsgateway;
...
public class SendMessageToSmsGatewayTasklet implements Tasklet {
    ...
    class SmsTask implements Runnable, ApplicationListener<ContextClosedEvent> {
        ...
        private final CorevancePlatformTenant tenant;
        private final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas;

        SmsTask(final CorevancePlatformTenant tenant, final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas) {
            this.tenant = tenant;
