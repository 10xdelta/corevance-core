 ...
 * under the License.
 */
package com.corevance.infrastructure.campaigns.email.data;
...
import com.corevance.infrastructure.campaigns.email.domain.EmailCampaignType;
...
public class EmailCampaignValidator {
    ...
    public static final Set<String> supportedParams = new HashSet<String>(
            Arrays.asList(campaignName, campaignType, localeParamName, dateFormatParamName, businessRuleId, paramValue, emailMessage,
                    recurrenceStartDate, activationDateParamName, submittedOnDateParamName, closureDateParamName, recurrenceParamName,
                    emailSubject, stretchyReportId, stretchyReportParamMap, emailAttachmentFileFormatId));

    public static final Set<String> supportedParamsForUpdate = new HashSet<>(
            Arrays.asList(campaignName, campaignType, localeParamName, dateFormatParamName, businessRuleId, paramValue, emailMessage,
                    recurrenceStartDate, activationDateParamName, recurrenceParamName));

    public static final Set<String> ACTIVATION_REQUEST_DATA_PARAMETERS = new HashSet<String>(
            Arrays.asList(localeParamName, dateFormatParamName, activationDateParamName));

    public static final Set<String> CLOSE_REQUEST_DATA_PARAMETERS = new HashSet<String>(
    ...
    public void validateCreate(String json) {
        ...
        if (campaignType.intValue() == EmailCampaignType.SCHEDULE.getValue()) {
            ...
            final String recurrenceStartDate = this.fromApiJsonHelper.extractStringNamed(EmailCampaignValidator.recurrenceStartDate,
                    element);
    ...
    public void validateActivation(String json) {
        ...
        final LocalDate activationDate = this.fromApiJsonHelper.extractLocalDateNamed(EmailCampaignValidator.activationDateParamName,
                element);
