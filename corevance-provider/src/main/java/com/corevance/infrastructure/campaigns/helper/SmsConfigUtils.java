 ...
 * under the License.
 */
package com.corevance.infrastructure.campaigns.helper;
...
public class SmsConfigUtils {
    ...
    public Map<String, Object> getMessageGateWayRequestURI(final String apiEndPoint, String apiQueueResourceDatas) {
        ...
        final CorevancePlatformTenant tenant = ThreadLocalContextUtil.getTenant();
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        headers.add(SmsCampaignConstants.COREVANCE_PLATFORM_TENANT_ID, tenant.getTenantIdentifier());
        headers.add(SmsCampaignConstants.COREVANCE_TENANT_APP_KEY, messageGatewayConfigurationData.tenantAppKey());
