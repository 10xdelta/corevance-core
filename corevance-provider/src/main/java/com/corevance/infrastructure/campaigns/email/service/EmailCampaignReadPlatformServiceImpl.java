...
import com.corevance.infrastructure.campaigns.email.data.EmailBusinessRulesData;
import com.corevance.infrastructure.campaigns.email.data.EmailCampaignData;
import com.corevance.infrastructure.campaigns.email.data.EmailCampaignTimeLine;
import com.corevance.infrastructure.campaigns.email.domain.EmailCampaignStatus;
import com.corevance.infrastructure.campaigns.email.domain.EmailCampaignStatusEnumerations;
import com.corevance.infrastructure.campaigns.email.domain.EmailCampaignType;
import com.corevance.infrastructure.campaigns.email.exception.EmailBusinessRuleNotFound;
