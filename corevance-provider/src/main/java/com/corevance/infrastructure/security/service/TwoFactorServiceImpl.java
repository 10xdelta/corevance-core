...
import com.corevance.infrastructure.core.domain.EmailDetail;
import com.corevance.infrastructure.core.service.PlatformEmailService;
...
import com.corevance.infrastructure.security.domain.OTPRequestRepository;
import com.corevance.infrastructure.security.domain.TFAccessToken;
import com.corevance.infrastructure.security.domain.TFAccessTokenRepository;
import com.corevance.infrastructure.security.exception.AccessTokenInvalidIException;
import com.corevance.infrastructure.security.exception.OTPDeliveryMethodInvalidException;
import com.corevance.infrastructure.security.exception.OTPTokenInvalidException;
...
public class TwoFactorServiceImpl implements TwoFactorService {
    ...
    @Override
    @CachePut(value = "userTFAccessToken", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil)"
    ...
    @Override
    @CacheEvict(value = "userTFAccessToken", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil)"
            + ".getTenant().getTenantIdentifier().concat(#user.username).concat(#result.token + 'tok')")
    ...
    @Override
    @Cacheable(value = "userTFAccessToken", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil)"
