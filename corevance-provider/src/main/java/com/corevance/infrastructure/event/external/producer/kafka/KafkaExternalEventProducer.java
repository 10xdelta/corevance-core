...
@Component
@Slf4j
@ConditionalOnProperty(value = "corevance.events.external.producer.kafka.enabled", havingValue = "true")
@AllArgsConstructor
public class KafkaExternalEventProducer implements ExternalEventProducer {
    ...
    public void sendEvents(Map<Long, List<byte[]>> partitions) throws AcknowledgementTimeoutException {
        CorevanceProperties.CorevanceExternalEventsProducerKafkaProperties kafkaProperties = corevanceProperties.getEvents().getExternal()
