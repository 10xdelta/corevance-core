 ...
 * under the License.
 */
package com.corevance.infrastructure.sms.scheduler;
...
import com.corevance.infrastructure.campaigns.helper.SmsConfigUtils;
...
import com.corevance.infrastructure.campaigns.sms.exception.ConnectionFailureException;
...
import com.corevance.infrastructure.gcm.service.NotificationSenderService;
import com.corevance.infrastructure.sms.data.SmsMessageApiQueueResourceData;
...
public class SmsMessageScheduledJobServiceImpl implements SmsMessageScheduledJobService {
    ...
    class SmsTask implements Runnable, ApplicationListener<ContextClosedEvent> {
        ...
        private final CorevanceContext context;
        private final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas;

        SmsTask(final Collection<SmsMessageApiQueueResourceData> apiQueueResourceDatas, final CorevanceContext context) {
