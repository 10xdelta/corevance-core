 ...
 * under the License.
 */
package com.corevance.infrastructure.configuration.domain;
...
import com.corevance.infrastructure.cache.domain.PlatformCache;
import com.corevance.infrastructure.cache.domain.PlatformCacheRepository;
...
public class ConfigurationDomainServiceJpa implements ConfigurationDomainService {
     ...
     * (non-Javadoc)
     *
     * @see com.corevance.infrastructure.configuration.domain. ConfigurationDomainService#isHolidaysEnabled()
     */
    @Override
