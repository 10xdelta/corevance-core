...
import com.corevance.notification.cache.CacheNotificationResponseHeader;
...
public class NotificationReadPlatformServiceImpl implements NotificationReadPlatformService {
    ...
    public Page<NotificationData> getAllUnreadNotifications(final SearchParameters searchParameters) {
        ...
        return toCorevancePage(springPage);
    }
    ...
    private Page<NotificationData> toCorevancePage(final org.springframework.data.domain.Page<NotificationData> springPage) {
