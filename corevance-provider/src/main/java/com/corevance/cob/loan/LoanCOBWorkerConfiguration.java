...
import com.corevance.cob.listener.ChunkProcessingLoanItemListener;
...
import com.corevance.portfolio.loanaccount.service.ProgressiveLoanModelProcessingService;
...
public class LoanCOBWorkerConfiguration {
    ...
    public ApplyLoanLockTasklet applyLock() {
        return new ApplyLoanLockTasklet(corevanceProperties, loanLockingService, retrieveIdService, requiresNewTransactionJdbcTemplate);
    }
