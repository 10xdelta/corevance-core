...
import com.corevance.cob.domain.AccountLock;
import com.corevance.cob.domain.AccountLockRepository;
...
import com.corevance.infrastructure.core.exception.PlatformInternalServerException;
import com.corevance.infrastructure.core.exception.PlatformRequestBodyItemLimitValidationException;
...
import com.corevance.infrastructure.jobs.exception.JobNotFoundException;
import com.corevance.infrastructure.jobs.service.InlineExecutorService;
import com.corevance.infrastructure.security.service.PlatformSecurityContext;
import com.corevance.infrastructure.springbatch.SpringBatchJobConstants;
...
public abstract class InlineCommonLockableCOBExecutorService<T extends AccountLock> implements InlineExecutorService<Long> {
    ...
    private List<COBIdAndLastClosedBusinessDate> getLoansToBeProcessed(List<Long> loanIds, LocalDate cobBusinessDate) {
        ...
        List<List<Long>> partitions = Lists.partition(loanIds, corevanceProperties.getQuery().getInClauseParameterSizeLimit());
    ...
    private void validateLoanIdsListSize(List<Long> loanIds) {
        int inlineLoanCobRequestItemLimit = corevanceProperties.getApi().getBodyItemSizeLimit().getInlineLoanCob();
