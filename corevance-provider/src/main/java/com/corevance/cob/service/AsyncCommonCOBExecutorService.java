...
import com.corevance.infrastructure.jobs.domain.ScheduledJobDetailRepository;
import com.corevance.infrastructure.jobs.exception.JobNotFoundException;
import com.corevance.infrastructure.jobs.service.JobStarter;
import com.corevance.infrastructure.jobs.service.SchedulerServiceConstants;
...
public abstract class AsyncCommonCOBExecutorService implements AsyncCOBExecutorService {
    ...
    public void executeLoanCOBCatchUpAsync(CorevanceContext context) {
        try {
