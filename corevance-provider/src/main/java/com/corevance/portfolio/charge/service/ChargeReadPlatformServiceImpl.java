 ...
 * under the License.
 */
package com.corevance.portfolio.charge.service;
...
import com.corevance.portfolio.charge.domain.ChargeAppliesTo;
import com.corevance.portfolio.charge.domain.ChargeTimeType;
import com.corevance.portfolio.charge.exception.ChargeNotFoundException;
...
public class ChargeReadPlatformServiceImpl implements ChargeReadPlatformService {
    ...
    @Override
    @Cacheable(value = "charges", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('ch')")
    ...
    private String addInClauseToSQL_toLimitChargesMappedToOffice_ifOfficeSpecificProductsEnabled() {
        ...
        String inClause = corevanceEntityAccessUtil
                .getSQLWhereClauseForProductIDsForUserOffice_ifGlobalConfigEnabled(CorevanceEntityType.CHARGE);
