...
import com.corevance.portfolio.loanproduct.data.AdvancedPaymentData.PaymentAllocationOrder;
import com.corevance.portfolio.loanproduct.data.CreditAllocationData;
import com.corevance.portfolio.loanproduct.data.LoanProductBorrowerCycleVariationData;
import com.corevance.portfolio.loanproduct.data.LoanProductData;
import com.corevance.portfolio.loanproduct.data.LoanProductGuaranteeData;
import com.corevance.portfolio.loanproduct.data.LoanProductInterestRecalculationData;
...
import com.corevance.portfolio.loanproduct.domain.LoanProductParamType;
...
public class LoanProductReadPlatformServiceImpl implements LoanProductReadPlatformService {
    ...
    public Collection<LoanProductData> retrieveAllLoanProducts() {
        ...
        String inClause = corevanceEntityAccessUtil
                .getSQLWhereClauseForProductIDsForUserOffice_ifGlobalConfigEnabled(CorevanceEntityType.LOAN_PRODUCT);
    ...
    public Collection<LoanProductData> retrieveRestrictedProductsForMix(final Long productId) {
        ...
        // Check if branch specific products are enabled. If yes, fetch only
        // products mapped to current user's office
        String inClause1 = corevanceEntityAccessUtil
                .getSQLWhereClauseForProductIDsForUserOffice_ifGlobalConfigEnabled(CorevanceEntityType.LOAN_PRODUCT);
        ...
        // Check if branch specific products are enabled. If yes, fetch only
        // products mapped to current user's office
        String inClause2 = corevanceEntityAccessUtil
                .getSQLWhereClauseForProductIDsForUserOffice_ifGlobalConfigEnabled(CorevanceEntityType.LOAN_PRODUCT);
