...
import com.corevance.portfolio.loanproduct.exception.LoanProductCannotBeModifiedDueToNonClosedLoansException;
import com.corevance.portfolio.loanproduct.exception.LoanProductDateException;
    ...
    public CommandProcessingResult createLoanProduct(final JsonCommand command) {
        ...
        try {
            ...
            corevanceEntityAccessUtil.checkConfigurationAndAddProductResrictionsForUserOffice(
                    CorevanceEntityAccessType.OFFICE_ACCESS_TO_LOAN_PRODUCTS, loanProduct.getId());
