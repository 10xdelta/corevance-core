...
public class ClientCollateralCreateCommandHandler implements CommandHandler<ClientCollateralCreateRequest, ClientCollateralCreateResponse> {
    ...
    @Override
    @Transactional
    public ClientCollateralCreateResponse handle(Command<ClientCollateralCreateRequest> command) {
        return writeService.createClientCollateralProduct(command.getPayload());
    }
