...
import static com.corevance.portfolio.account.AccountDetailConstants.fromAccountTypeParamName;
import static com.corevance.portfolio.account.AccountDetailConstants.toAccountIdParamName;
import static com.corevance.portfolio.account.AccountDetailConstants.toAccountTypeParamName;
import static com.corevance.portfolio.account.api.AccountTransfersApiConstants.transferAmountParamName;
import static com.corevance.portfolio.account.api.AccountTransfersApiConstants.transferDateParamName;
...
import com.corevance.portfolio.account.domain.AccountTransferTransaction;
    ...
    public void reverseTransfersWithFromAccountTransactions(final Collection<Long> fromTransactionIds,
        ...
        if (PortfolioAccountType.LOAN.equals(accountTypeId)) {
            List<List<Long>> partitions = Lists.partition(fromTransactionIds.stream().toList(),
                    corevanceProperties.getQuery().getInClauseParameterSizeLimit());
