 ...
 * under the License.
 */
package com.corevance.portfolio.fund.service;
...
public class FundWritePlatformServiceJpaRepositoryImpl implements FundWritePlatformService {
    ...
    @Transactional
    @Override
    @CacheEvict(value = "funds", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('fn')")
