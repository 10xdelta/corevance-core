...
public class ReAmortizationPreviewRequest implements Serializable {
    ...
    @NotBlank(message = "{com.corevance.reamortization.interest-handling-type.not-blank}")
    @EnumValue(enumClass = LoanReAmortizationInterestHandlingType.class, message = "{com.corevance.interest-handling-type.invalid}")
