...
public class LoanAccountDomainServiceJpaHelper {
    ...
    public LocalDate calculateRecalculateTillDate(Loan loan, LocalDate transactionDate, ScheduleGeneratorDTO scheduleGeneratorDTOForPrepay,
        ...
        try {
            if (CorevanceRequestContextHolder.isBatchRequest() && BatchRequestContextHolder.isEnclosingTransaction()) {
                ...
                // Example testcase:
                // com.corevance.integrationtests.BatchApiTest.shouldReturnOkStatusOnSuccessfulGetDatatableEntryWithNoQueryParam
            ...
            // the test-case is com.corevance.integrationtests.LoanTransactionAccrualActivityPostingTest.test in
