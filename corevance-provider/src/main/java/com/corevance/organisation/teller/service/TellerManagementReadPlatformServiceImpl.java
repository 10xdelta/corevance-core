...
import com.corevance.organisation.teller.data.CashierData;
import com.corevance.organisation.teller.data.CashierTransactionData;
import com.corevance.organisation.teller.data.CashierTransactionTypeTotalsData;
import com.corevance.organisation.teller.data.CashierTransactionsWithSummaryData;
import com.corevance.organisation.teller.data.TellerData;
import com.corevance.organisation.teller.data.TellerJournalData;
import com.corevance.organisation.teller.data.TellerTransactionData;
import com.corevance.organisation.teller.domain.CashierTxnType;
import com.corevance.organisation.teller.domain.TellerStatus;
...
public class TellerManagementReadPlatformServiceImpl implements TellerManagementReadPlatformService {
    ...
    @Cacheable(value = "tellers", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#root.target.context.authenticatedUser().getOffice().getHierarchy()+'of')")
