 ...
 * under the License.
 */
package com.corevance.template.api;
...
import com.corevance.template.command.TemplateCreateCommand;
import com.corevance.template.command.TemplateDeleteCommand;
import com.corevance.template.command.TemplateUpdateCommand;
...
import com.corevance.template.data.TemplateDetailsData;
import com.corevance.template.data.TemplateItemData;
...
import com.corevance.template.service.TemplateMergeServiceImpl;
...
@Tag(name = "templates", description = """
        ...
        User Generated Documents (and other types of templates) can aggregate data from several Apache Corevance back-end API calls via mappers. Mappers can even access non-Apache Corevance REST services from other servers. UGDs can render such data in tables, show images, etc. TBD: Please have a look at some of the Example UGDs included in Apache Corevance (or the Wiki page, for now.).
