...
/**
 * Implements {@link com.corevance.batch.command.CommandStrategy} to handle activation of a pending client. It
 * passes the contents of the body from the BatchRequest to
 * {@link com.corevance.portfolio.client.api.ClientsApiResource} and gets back the response. This class will also
 * catch any errors raised by {@link com.corevance.portfolio.client.api.ClientsApiResource} and map those errors
