...
/**
 * Implements {@link com.corevance.batch.command.CommandStrategy} to handle disbursement of a loan directly to a
 * linked savings account via the {@code disburseToSavings} command. It passes the contents of the body from the
 * BatchRequest to {@link com.corevance.portfolio.loanaccount.api.LoansApiResource} and gets back the response.
 *
