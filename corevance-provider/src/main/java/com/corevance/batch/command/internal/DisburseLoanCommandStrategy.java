...
/**
 * Implements {@link com.corevance.batch.command.CommandStrategy} to handle disburse of a loan. It passes the
 * contents of the body from the BatchRequest to {@link com.corevance.portfolio.loanaccount.api.LoansApiResource}
 * and gets back the response. This class will also catch any errors raised by
 * {@link com.corevance.portfolio.loanaccount.api.LoansApiResource} and map those errors to appropriate status
