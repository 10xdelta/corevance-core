...
import com.corevance.portfolio.client.api.ClientsApiResource;
import org.apache.http.HttpStatus;
import org.springframework.stereotype.Component;

/**
 * Implements {@link com.corevance.batch.command.CommandStrategy} to handle creation of a new client. It passes
 * the contents of the body from the BatchRequest to {@link com.corevance.portfolio.client.api.ClientsApiResource}
 * and gets back the response. This class will also catch any errors raised by
 * {@link com.corevance.portfolio.client.api.ClientsApiResource} and map those errors to appropriate status codes
 * in BatchResponse.
 *
