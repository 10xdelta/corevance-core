...
import com.corevance.spm.data.LookupTableData;
import com.corevance.spm.domain.LookupTable;
import com.corevance.spm.domain.Survey;
import com.corevance.spm.exception.LookupTableNotFoundException;
import com.corevance.spm.exception.SurveyNotFoundException;
import com.corevance.spm.service.LookupTableService;
import com.corevance.spm.service.SpmService;
import com.corevance.spm.util.LookupTableMapper;
import org.springframework.stereotype.Component;
import org.springframework.transaction.annotation.Transactional;

@Path("/v1/surveys/{surveyId}/lookuptables")
@Component
@Tag(name = "SPM API - LookUp Table", description = "The Apache Corevance SPM API provides the ability to create custom surveys to collect social performance measurentment data or any additional questionnaire a financial institute want to collect.")
