...
import com.corevance.useradministration.data.PasswordValidationPolicyData;
...
@Tag(name = "Password preferences", description = "This API enables management of password policy for user administration.\n" + "\n"
        + "There is no Apache Corevance functionality for creating a validation policy. The validation policies come pre-installed.\n" + "\n"
