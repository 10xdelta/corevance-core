 ...
 * under the License.
 */
package com.corevance.useradministration.api;
...
@Tag(name = "Permissions", description = "An API capability to support management of application permissions for user administration.\n"
        + "\n" + "There is no Apache Corevance functionality for creating or deleting permissions. Permissions come pre-installed.\n" + "\n"
...
public class PermissionsApiResource {
    ...
    @Operation(summary = "List Application Permissions", operationId = "retrieveAllPermissions", tags = {
            "Permissions" }, description = "ARGUMENTS\n" + "makerCheckerableoptional, Values are true, false. Default is false.\n"
                    ...
                    + "\n" + "Note: Each Apache Corevance transaction is associated with a permission.\n" + "\n" + "Example Requests:\n"
