...
Feature: Core Infrastructure
  ...
  @infrastructure
  Scenario: Verify that schema migration is not executed when the Corevance instance is a read instance
  ...
  @infrastructure
  Scenario: Verify that schema migration is not executed when the Corevance instance is a batch instance
    Given Set every Corevance instance type to false
  ...
  Scenario Outline: Verify empty multi exceptions
    ...
    Examples:
      ...
      | java.lang.IllegalArgumentException | java.lang.IllegalStateException | com.corevance.infrastructure.core.exception.MultiException |
