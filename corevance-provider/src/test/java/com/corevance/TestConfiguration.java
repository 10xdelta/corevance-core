...
import com.corevance.cob.internal.TestData;
...
import com.corevance.infrastructure.jobs.service.JobRegisterService;
...
@EnableWebSecurity
@EnableConfigurationProperties({ CorevanceProperties.class, LiquibaseProperties.class })
@ComponentScan(basePackages = "com.corevance", excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = "org\\.apache\\.corevance\\..*\\$TestConfig"))
...
public class TestConfiguration {
    ...
    public TenantDataSourceFactory tenantDataSourceFactory(HikariConfig hikariConfig, DatabasePasswordEncryptor databasePasswordEncryptor) {
        return new TenantDataSourceFactory(hikariConfig, null, databasePasswordEncryptor) {
            ...
            @Override
            public HikariDataSource create(CorevancePlatformTenant tenant) {
    ...
    public TenantDatabaseUpgradeService tenantDatabaseUpgradeService(TenantDetailsService tenantDetailsService,
            ...
            CorevanceProperties corevanceProperties, Environment environment,
            List<CustomTaskChange> customTaskChangesForDependencyInjection) {
        return new TenantDatabaseUpgradeService(tenantDetailsService, tenantDataSource, corevanceProperties, tenantDatabaseStateVerifier,
