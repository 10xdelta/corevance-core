...
import com.corevance.infrastructure.event.business.domain.loan.LoanStatusChangedBusinessEvent;
...
import com.corevance.portfolio.loanaccount.domain.LoanStatusChangeHistory;
import com.corevance.portfolio.loanaccount.domain.LoanStatusChangeHistoryRepository;
...
public class LoanStatusChangeHistoryListenerTest {
    ...
    public void testEventListenerShouldNotBeRegisteredWhenNONE() {
        // given
        CorevanceProperties.CorevanceLoanProperties loanProperties = Mockito.mock(CorevanceProperties.CorevanceLoanProperties.class);
        Mockito.when(corevanceProperties.getLoan()).thenReturn(loanProperties);
