...
public class LoanAccrualsProcessingServiceImplTest {
    ...
    void setUp() {
        ...
        ThreadLocalContextUtil.setTenant(new CorevancePlatformTenant(1L, "test", "Test Tenant", "America/Mexico_City", null));
        LocalDate today = LocalDate.now(ZoneId.systemDefault());
        ThreadLocalContextUtil.setBusinessDates(new HashMap<>(Map.of(
                com.corevance.infrastructure.businessdate.domain.BusinessDateType.BUSINESS_DATE, today,
                com.corevance.infrastructure.businessdate.domain.BusinessDateType.COB_DATE, today)));
    ...
    void reprocessExistingAccruals_ShouldCreateAdjustmentNotReverse_ForPostDueDateAccrual_OnCumulativeLoan() {
        ...
        com.corevance.organisation.office.domain.Office office = mock(com.corevance.organisation.office.domain.Office.class);
        when(loan.getOffice()).thenReturn(office);
        when(externalIdFactory.create()).thenReturn(com.corevance.infrastructure.core.domain.ExternalId.empty());
