...
import com.corevance.portfolio.loanaccount.domain.LoanBuilder;
...
public class LoanWritePlatformServiceJpaRepositoryImplTest {
    ...
    private void setupMoneyHelper() {
        ...
        CorevancePlatformTenant tenant = new CorevancePlatformTenant(1L, "test", "Test Tenant", "Asia/Kolkata", null);
