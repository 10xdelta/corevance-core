 ...
 * under the License.
 */
package com.corevance.portfolio.delinquency.helper;
...
class InstallmentDelinquencyAggregatorTest {
    ...
    private CorevancePlatformTenant testTenant;
    private CorevancePlatformTenant originalTenant;

    @BeforeEach
    void setUp() {
        originalTenant = ThreadLocalContextUtil.getTenant();
        testTenant = new CorevancePlatformTenant(1L, "test", "Test Tenant", "Asia/Kolkata", null);
