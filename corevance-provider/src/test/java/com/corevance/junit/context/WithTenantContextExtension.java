 ...
 * under the License.
 */
package com.corevance.junit.context;
...
public class WithTenantContextExtension implements BeforeEachCallback, AfterEachCallback {
    ...
    public void beforeEach(ExtensionContext context) throws Exception {
        ...
        if (hasAnnotation(method)) {
            ...
            ThreadLocalContextUtil
                    .setTenant(new CorevancePlatformTenant(1L, annotation.tenantName(), "Default", annotation.tenantTimeZoneId(), null));
        }
    }
    ...
    public void afterEach(ExtensionContext context) throws Exception {
        Method method = context.getTestMethod().orElse(null);
        if (hasAnnotation(method)) {
            CorevancePlatformTenant originalTenant = (CorevancePlatformTenant) context.getStore(NAMESPACE).get(ORIGINAL_TENANT_KEY);
