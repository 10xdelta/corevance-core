...
public class CommandServiceStepDefinitions implements En {
    ...
    public CommandServiceStepDefinitions() {
        Given("/^A command source write service$/", () -> {
            ...
            CorevanceRequestContextHolder contextHolder = Mockito.spy(CorevanceRequestContextHolder.class);
            ReflectionTestUtils.setField(processAndLogCommandService, "corevanceRequestContextHolder", contextHolder);
