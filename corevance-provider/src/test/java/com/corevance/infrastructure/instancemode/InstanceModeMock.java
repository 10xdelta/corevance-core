 ...
 * under the License.
 */
package com.corevance.infrastructure.instancemode;
...
public final class InstanceModeMock {
    ...
    public static CorevanceProperties.CorevanceModeProperties createModeProps(boolean readEnabled, boolean writeEnabled,
