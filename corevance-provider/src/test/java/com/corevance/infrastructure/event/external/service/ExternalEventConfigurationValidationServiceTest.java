...
public class ExternalEventConfigurationValidationServiceTest {
    ...
    public void givenAllConfigurationWhenValidatedThenValidationSuccessful() throws Exception {
        ...
        List<CorevancePlatformTenant> tenants = Arrays
                .asList(new CorevancePlatformTenant(1L, "default", "Default Tenant", "Europe/Budapest", null));
        ...
        List<String> sourcePackage = Arrays.asList("com.corevance");
