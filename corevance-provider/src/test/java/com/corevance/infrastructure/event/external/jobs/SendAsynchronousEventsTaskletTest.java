...
import com.corevance.infrastructure.event.external.exception.AcknowledgementTimeoutException;
...
class SendAsynchronousEventsTaskletTest {
    ...
    public void setUp() {
        ...
        underTest = new SendAsynchronousEventsTasklet(corevanceProperties, repository, eventProducer, messageFactory, byteBufferConverter,
    ...
    private void configureExternalEventsProducerReadBatchSizeProperty() {
        CorevanceProperties.CorevanceEventsProperties eventsProperties = new CorevanceProperties.CorevanceEventsProperties();
        CorevanceProperties.CorevanceExternalEventsProperties externalProperties = new CorevanceProperties.CorevanceExternalEventsProperties();
        CorevanceProperties.CorevanceExternalEventsProducerProperties externalEventsProducerProperties = new CorevanceProperties.CorevanceExternalEventsProducerProperties();
        CorevanceProperties.CorevanceExternalEventsProducerJmsProperties externalEventsProducerJMSProperties = new CorevanceProperties.CorevanceExternalEventsProducerJmsProperties();
        ...
        when(corevanceProperties.getEvents()).thenReturn(eventsProperties);
