...
import com.corevance.infrastructure.core.config.cache.TransactionBoundCacheManager;
...
class ExternalEventConfigurationRepositoryCacheTest {
    ...
    void shouldUseTenantScopedCacheKey() throws NoSuchMethodException {
        ...
        assertThat(cacheable.key()).isEqualTo(
                "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#externalEventType)");
    }
