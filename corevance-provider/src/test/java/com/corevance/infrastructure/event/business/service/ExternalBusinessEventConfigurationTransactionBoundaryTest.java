...
import com.corevance.infrastructure.event.external.repository.ExternalEventConfigurationRepository;
import com.corevance.infrastructure.event.external.repository.domain.ExternalEventConfiguration;
...
class ExternalBusinessEventConfigurationTransactionBoundaryTest {
    ...
    static class TestConfig {
        ...
        @Bean
        CorevanceProperties corevanceProperties() {
            CorevanceProperties corevanceProperties = new CorevanceProperties();
            ...
            corevanceProperties.setEvents(eventsProperties);
            return corevanceProperties;
        }
        ...
        @Bean
        BusinessEventNotifierServiceImpl businessEventNotifierService(CorevanceProperties corevanceProperties,
            ...
            return new BusinessEventNotifierServiceImpl(externalEventService, corevanceProperties, transactionHelper,
