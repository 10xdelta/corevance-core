 ...
 * under the License.
 */
package com.corevance.infrastructure.jobs.service.aggregationjob.services;
...
import com.corevance.infrastructure.jobs.service.aggregationjob.data.JournalEntryAggregationSummaryData;
import com.corevance.infrastructure.jobs.service.aggregationjob.data.JournalEntryAggregationTrackingData;
import com.corevance.infrastructure.jobs.service.aggregationjob.domain.JournalEntryAggregationTrackingRepository;
import com.corevance.infrastructure.jobs.service.aggregationjob.domain.JournalEntrySummary;
import com.corevance.infrastructure.jobs.service.aggregationjob.domain.JournalEntrySummaryRepository;
...
public class JournalEntryAggregationWriterServiceImplTest {
    ...
    public void testInsertJournalEntrySummaryBatchWithAmounts() {
        ...
        when(summaryData.getOriginatorExternalIds()).thenReturn("originator1, originator2");
        ...
        verify(journalSummaryRepository, times(1)).saveAll(argThat(entities -> {
            ...
            return entity.getDebitAmount().compareTo(debitAmount) == 0 && entity.getCreditAmount().compareTo(creditAmount) == 0
                    && "originator1, originator2".equals(entity.getOriginatorExternalIds());
        }));
