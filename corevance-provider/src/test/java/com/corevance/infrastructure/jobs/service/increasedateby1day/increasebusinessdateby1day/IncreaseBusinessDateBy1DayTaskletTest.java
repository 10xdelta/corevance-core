 ...
 * under the License.
 */
package com.corevance.infrastructure.jobs.service.increasedateby1day.increasebusinessdateby1day;
...
import com.corevance.infrastructure.businessdate.service.BusinessDateWritePlatformService;
...
class IncreaseBusinessDateBy1DayTaskletTest {
    ...
    public void shouldBusinessDateJobBeProcessedWhenBusinessDateIsEnabled() throws Exception {
        ...
        verify(businessDateWritePlatformService, times(1)).increaseDateByTypeByOneDay(BusinessDateType.BUSINESS_DATE);
        assertEquals(RepeatStatus.FINISHED, repeatStatus);
    }
