...
public class JournalEntryAggregationJobReaderTest {
    ...
    @Mock
    private CorevancePlatformTenantConnection corevancePlatformTenantConnection;
    @Mock
    ...
    @BeforeEach
    public void setUp() {
        tenant = new CorevancePlatformTenant(1L, "default", "Default Tenant", "default", corevancePlatformTenantConnection);
