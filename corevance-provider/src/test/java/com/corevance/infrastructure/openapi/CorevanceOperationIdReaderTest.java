 ...
 * under the License.
 */
package com.corevance.infrastructure.openapi;
...
class CorevanceOperationIdReaderTest {

    @Test
    void addsAlternativeOperationIdExtension() {
        OpenAPI openAPI = new CorevanceOperationIdReader().read(Set.of(ResourceWithAlternativeOperationId.class), Map.of());

        Object alternativeOperationId = openAPI.getPaths().get("/test").getGet().getExtensions()
                .get(CorevanceOperationIdReader.ALTERNATIVE_OPERATION_ID_EXTENSION);
    ...
    void addsAlternativeOperationIdExtensionForImplicitOperationId() {
        OpenAPI openAPI = new CorevanceOperationIdReader().read(Set.of(ResourceWithImplicitOperationIdAlternative.class), Map.of());
    ...
    void rejectsInvalidAlternativeOperationId() {
        IllegalStateException exception = assertThrows(IllegalStateException.class,
                () -> new CorevanceOperationIdReader().read(Set.of(ResourceWithInvalidAlternativeOperationId.class), Map.of()));
    ...
    void allowsAlternativeOperationIdMatchingAnotherOperationId() {
        OpenAPI openAPI = new CorevanceOperationIdReader()
    ...
    void rejectsDuplicateFinalOperationIds() {
        ...
        IllegalStateException exception = assertThrows(IllegalStateException.class,
                () -> CorevanceOperationIdReader.OperationIdValidator.validate(openAPI));
