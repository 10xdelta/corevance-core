...
import com.corevance.infrastructure.core.service.IpAddressUtils;
...
public class IpTrackingFilterTest {
    ...
    public void setup() {
        ...
        CorevanceProperties.CorevanceIpTrackingProperties props = new CorevanceProperties.CorevanceIpTrackingProperties();
        props.setEnabled(true);
        corevanceProperties.setIpTracking(props);
        underTest = new CallerIpTrackingFilter(corevanceProperties);
    }
