 ...
 * under the License.
 */
package com.corevance.infrastructure.core.persistence;
 ...
 *
 * <p>
 * This scans all {@code com.corevance} classes on the classpath (via ASM metadata, without loading them) and
...
public class NoCustomIsolationOnJpaTransactionManagerTest {
    ...
    public void noCustomIsolationLevelIsUsedWithTheJpaTransactionManager() throws IOException {
        ...
        Resource[] resources = resolver.getResources("classpath*:com/corevance/**/*.class");
