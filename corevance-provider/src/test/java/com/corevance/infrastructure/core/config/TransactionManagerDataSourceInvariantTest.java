...
import com.corevance.infrastructure.core.config.jpa.JpaTransactionConfig;
 ...
 * {@code getDataSource() != null}. Corevance deliberately leaves the JPA manager's {@code DataSource} unset, so plain
...
public class TransactionManagerDataSourceInvariantTest {
    ...
    private static CorevanceProperties writeModeProperties() {
        CorevanceProperties properties = new CorevanceProperties();
        CorevanceProperties.CorevanceModeProperties mode = new CorevanceProperties.CorevanceModeProperties();
