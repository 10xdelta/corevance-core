...
import static com.corevance.infrastructure.core.service.migration.TenantDatabaseUpgradeService.CUSTOM_CHANGELOG_CONTEXT;
import static com.corevance.infrastructure.core.service.migration.TenantDatabaseUpgradeService.INITIAL_SWITCH_CONTEXT;
import static com.corevance.infrastructure.core.service.migration.TenantDatabaseUpgradeService.TENANT_DB_CONTEXT;
import static com.corevance.infrastructure.core.service.migration.TenantDatabaseUpgradeService.TENANT_STORE_DB_CONTEXT;
...
import com.corevance.infrastructure.core.service.migration.ExtendedSpringLiquibase;
import com.corevance.infrastructure.core.service.migration.ExtendedSpringLiquibaseFactory;
import com.corevance.infrastructure.core.service.migration.TenantDataSourceFactory;
import com.corevance.infrastructure.core.service.migration.TenantDatabaseStateVerifier;
import com.corevance.infrastructure.core.service.migration.TenantDatabaseUpgradeService;
import com.corevance.infrastructure.core.service.migration.TenantPasswordEncryptionTask;
...
public class LiquibaseStepDefinitions implements En {
    ...
    private List<CorevancePlatformTenant> allTenants;
    ...
    private void initializeLiquibase(boolean liquibaseEnabled) {
        ...
        defaultTenant = mock(CorevancePlatformTenant.class);
        ...
        tenantDatabaseUpgradeService = new TenantDatabaseUpgradeService(tenantDetailsService, tenantStoreDataSource, corevanceProperties,
