...
for v in "${VIOLATIONS[@]}"; do
    ...
    short_file="${vfile#corevance-provider/src/main/resources/}"
    short_file="${short_file#corevance-loan/src/main/resources/}"
    short_file="${short_file#corevance-investor/src/main/resources/}"
    short_file="${short_file#corevance-savings/src/main/resources/}"
    short_file="${short_file#corevance-progressive-loan/src/main/resources/}"
