...
FEATURES_DIR="corevance-e2e-tests-runner/src/test/resources/features"
...
while IFS= read -r -d $'\0' file; do
  # Remove the 'corevance-e2e-tests-runner/' prefix
  rel_path="${file#corevance-e2e-tests-runner/}"
