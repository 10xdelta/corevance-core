...
import static com.corevance.portfolio.savings.SavingsApiConstants.dateFormatParamName;
...
import com.corevance.portfolio.charge.exception.SavingsAccountChargeWithoutMandatoryFieldException;
...
public class SavingsAccountCharge extends AbstractAuditableWithUTCDateTimeCustom<Long> {
    ...
    @SuppressFBWarnings(value = "NP_NULL_PARAM_DEREF_NONVIRTUAL") // https://issues.apache.org/jira/browse/COREVANCE-987
