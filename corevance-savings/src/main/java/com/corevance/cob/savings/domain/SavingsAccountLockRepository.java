 ...
 * under the License.
 */
package com.corevance.cob.savings.domain;

import java.util.List;
import java.util.Optional;
import com.corevance.cob.savings.SavingsAccountLock;
import com.corevance.cob.savings.SavingsLockOwner;
...
public interface SavingsAccountLockRepository
    ...
    @Query("""
            ...
            lck.lockOwner in (com.corevance.cob.savings.SavingsLockOwner.SAVINGS_COB_CHUNK_PROCESSING,
                              com.corevance.cob.savings.SavingsLockOwner.SAVINGS_INLINE_COB_PROCESSING)
            """)
