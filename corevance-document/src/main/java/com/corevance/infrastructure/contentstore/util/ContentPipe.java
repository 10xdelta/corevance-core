 ...
 * under the License.
 */
package com.corevance.infrastructure.contentstore.util;
...
import com.corevance.infrastructure.contentstore.exception.ContentProcessorException;
import com.corevance.infrastructure.contentstore.processor.ContentProcessor;
...
public final class ContentPipe {
    ...
    public ContentPipe(@Qualifier(BEAN_NAME_EXECUTOR) ExecutorService executor, CorevanceProperties properties) {
