 ...
 * under the License.
 */
package com.corevance.infrastructure.documentmanagement.api;

import static java.util.Objects.requireNonNull;
import static com.corevance.infrastructure.contentstore.processor.DataUrlEncoderContentProcessor.DATA_URL_ENCODE_PARAM_CONTENT_TYPE;
import static com.corevance.infrastructure.contentstore.processor.DataUrlEncoderContentProcessor.DATA_URL_ENCODE_PARAM_ENCODING;
import static com.corevance.infrastructure.contentstore.processor.ImageResizeContentProcessor.IMAGE_RESIZE_PARAM_FORMAT;
import static com.corevance.infrastructure.contentstore.processor.ImageResizeContentProcessor.IMAGE_RESIZE_PARAM_MAX_HEIGHT;
import static com.corevance.infrastructure.contentstore.processor.ImageResizeContentProcessor.IMAGE_RESIZE_PARAM_MAX_WIDTH;
import static com.corevance.infrastructure.documentmanagement.api.DocumentApiConstants.DOCUMENT_API_PARAM_ENTITY_ID;
import static com.corevance.infrastructure.documentmanagement.api.DocumentApiConstants.DOCUMENT_API_PARAM_ENTITY_TYPE;
import static com.corevance.infrastructure.documentmanagement.api.DocumentApiConstants.DOCUMENT_API_PARAM_FILE;
import static com.corevance.infrastructure.documentmanagement.api.ImageApiConstants.IMAGE_API_PARAM_MAX_HEIGHT;
import static com.corevance.infrastructure.documentmanagement.api.ImageApiConstants.IMAGE_API_PARAM_MAX_WIDTH;
import static com.corevance.infrastructure.documentmanagement.api.ImageApiConstants.IMAGE_API_PARAM_OUTPUT;
import static com.corevance.infrastructure.documentmanagement.api.ImageApiConstants.IMAGE_API_VALUE_ENCODING_BASE64;
import static com.corevance.infrastructure.documentmanagement.api.ImageApiConstants.IMAGE_API_VALUE_OUTPUT_INLINE_OCTET;
import static com.corevance.util.StreamResponseUtil.DISPOSITION_TYPE_ATTACHMENT;
import static com.corevance.util.StreamResponseUtil.DISPOSITION_TYPE_INLINE;
...
import com.corevance.infrastructure.contentstore.processor.Base64DecoderContentProcessor;
import com.corevance.infrastructure.contentstore.processor.Base64EncoderContentProcessor;
import com.corevance.infrastructure.contentstore.processor.ContentProcessorContext;
import com.corevance.infrastructure.contentstore.processor.DataUrlDecoderContentProcessor;
import com.corevance.infrastructure.contentstore.processor.DataUrlEncoderContentProcessor;
import com.corevance.infrastructure.contentstore.processor.ImageResizeContentProcessor;
import com.corevance.infrastructure.documentmanagement.command.ImageCreateCommand;
import com.corevance.infrastructure.documentmanagement.command.ImageDeleteCommand;
import com.corevance.infrastructure.documentmanagement.data.ImageCreateRequest;
import com.corevance.infrastructure.documentmanagement.data.ImageCreateResponse;
import com.corevance.infrastructure.documentmanagement.data.ImageDeleteRequest;
import com.corevance.infrastructure.documentmanagement.data.ImageDeleteResponse;
import com.corevance.infrastructure.documentmanagement.service.ImageReadPlatformService;
...
public class ImagesApiResource {
    ...
    @GET
    // COREVANCE-1265: Do NOT specify @Produces(TEXT_PLAIN) here - it may actually not (if it calls the next methods it's
    // octet-stream)
