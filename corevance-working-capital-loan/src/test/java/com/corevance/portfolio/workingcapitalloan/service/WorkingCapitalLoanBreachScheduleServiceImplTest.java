...
import com.corevance.portfolio.workingcapitalloan.mapper.WorkingCapitalLoanBreachScheduleMapper;
...
class WorkingCapitalLoanBreachScheduleServiceImplTest {
    ...
    private CorevancePlatformTenant originalTenant;

    @BeforeEach
    void setUp() {
        originalTenant = ThreadLocalContextUtil.getTenant();
        ThreadLocalContextUtil.setTenant(new CorevancePlatformTenant(1L, "default", "Default", "UTC", null));
