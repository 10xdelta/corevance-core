 ...
 * under the License.
 */
package com.corevance.portfolio.workingcapitalloanproduct.serialization;
...
import com.corevance.portfolio.workingcapitalloan.serialization.WorkingCapitalLoanApplicationDataValidator;
import com.corevance.portfolio.workingcapitalloannearbreach.validator.WorkingCapitalNearBreachParseAndValidator;
...
class WorkingCapitalLoanApplicationDataValidatorTest {
    ...
    void testHandleDataIntegrityIssues_WithDuplicateAccountNo_ShouldThrowPlatformDataIntegrityException() {
        ...
        assertThrows(com.corevance.infrastructure.core.exception.PlatformDataIntegrityException.class,
    ...
    private WorkingCapitalLoanProduct createMockProduct() {
        ...
        final com.corevance.portfolio.workingcapitalloanproduct.domain.WorkingCapitalLoanProductMinMaxConstraints minMax = new com.corevance.portfolio.workingcapitalloanproduct.domain.WorkingCapitalLoanProductMinMaxConstraints(
