...
package com.corevance.portfolio.workingcapitalloan.repository;
...
public interface WorkingCapitalLoanChargeRepository
    ...
    @Query("select new com.corevance.portfolio.workingcapitalloan.data.WorkingCapitalLoanChargeData("
