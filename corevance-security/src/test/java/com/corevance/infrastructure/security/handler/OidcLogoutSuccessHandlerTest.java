 ...
 * under the License.
 */
package com.corevance.infrastructure.security.handler;
...
class OidcLogoutSuccessHandlerTest {
    ...
    private static final String ISSUER = "https://idp.example.com/realm/corevance";
    ...
    @Mock
    private CorevanceProperties.CorevanceSecurityProperties.CorevanceSecurityOidcFederationProperties oidcProps;
    @Mock
    ...
    void setUp() {
        ...
        handler = new OidcLogoutSuccessHandler(corevanceProperties);
    ...
    private Authentication authForProvider(OidcFederationType provider) {
        ...
        CorevanceOidcUser oidcUser = new CorevanceOidcUser(List.of(), idToken, null, appUser, "acme");
    ...
    void postLogoutUriBuiltFromRequestHostWhenPropertyBlank() throws Exception {
        ...
        request.setServerName("corevance.example.com");
        ...
        assertThat(response.getRedirectedUrl()).contains("corevance.example.com");
    }
}
