...
public class OidcAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
        ...
        if (authentication.getPrincipal() instanceof CorevanceOidcUser oidcUser) {
            log.debug("OIDC login successful — user: '{}', tenant: '{}', Corevance id: {}", oidcUser.getName(), oidcUser.getTenantId(),
