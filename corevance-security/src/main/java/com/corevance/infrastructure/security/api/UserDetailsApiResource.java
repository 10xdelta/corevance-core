...
import com.corevance.infrastructure.security.data.AuthenticatedOauthUserData;
...
public class UserDetailsApiResource {
    ...
    public String fetchAuthenticatedUserData() {
        ...
        final CorevanceJwtAuthenticationToken authentication = (CorevanceJwtAuthenticationToken) context.getAuthentication();
