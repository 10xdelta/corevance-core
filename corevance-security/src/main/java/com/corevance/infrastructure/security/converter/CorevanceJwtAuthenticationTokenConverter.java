...
public class CorevanceJwtAuthenticationTokenConverter implements Converter<Jwt, CorevanceJwtAuthenticationToken> {
    ...
    public CorevanceJwtAuthenticationToken convert(@NonNull Jwt jwt) {
        try {
            ...
            return new CorevanceJwtAuthenticationToken(jwt, authorities, user);
