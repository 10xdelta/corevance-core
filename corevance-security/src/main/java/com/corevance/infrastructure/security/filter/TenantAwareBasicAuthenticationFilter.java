...
import com.corevance.infrastructure.cache.domain.CacheType;
import com.corevance.infrastructure.cache.service.CacheWritePlatformService;
...
import com.corevance.infrastructure.security.data.PlatformRequestLog;
import com.corevance.infrastructure.security.exception.InvalidTenantIdentifierException;
 ...
 * {@link CorevancePlatformTenant} and stored in a {@link ThreadLocal} variable for this request using
...
public class TenantAwareBasicAuthenticationFilter extends BasicAuthenticationFilter {
    ...
    private static final String TENANT_ID_REQUEST_HEADER = "Corevance-Platform-TenantId";
        ...
        try {
            ...
            if ("OPTIONS".equalsIgnoreCase(request.getMethod())) {
                ...
                if (requestMatcher.matches(request)) {
                    ...
                    final CorevancePlatformTenant tenant = basicAuthTenantDetailsService.loadTenantById(tenantIdentifier, isReportRequest);
            ...
            response.addHeader("WWW-Authenticate", "Basic realm=\"" + "Corevance Platform API" + "\"");
