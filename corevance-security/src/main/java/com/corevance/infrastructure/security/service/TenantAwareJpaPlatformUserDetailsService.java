...
import com.corevance.infrastructure.security.domain.PlatformUserRepository;
...
public class TenantAwareJpaPlatformUserDetailsService implements PlatformUserDetailsService {
    ...
    @Override
    @Cacheable(value = "usersByUsername", key = "T(com.corevance.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat(#username+'ubu')")
