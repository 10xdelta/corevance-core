...
import com.corevance.infrastructure.core.service.tenant.TenantMapper;
...
public class AuthTenantDetailsServiceJdbc implements AuthTenantDetailsService {
    ...
    public CorevancePlatformTenant loadTenantById(final String tenantIdentifier, final boolean isReport) {
