...
/**
 * Resolves the Corevance tenant from an incoming request and sets it in {@link ThreadLocalContextUtil} before Spring
 ...
 * <li>The {@code Corevance-Platform-TenantId} HTTP header</li>
...
public class OidcTenantAwareFilter extends OncePerRequestFilter {
    ...
    private static final String TENANT_HEADER = "Corevance-Platform-TenantId";
    ...
    private String resolveTenantId(HttpServletRequest request) {
        ...
        if (token != null) {
            try {
                ...
                if (issuer != null) {
                    var yamlIssuers = corevanceProperties.getSecurity().getOidcFederation().getIssuers();
                    if (yamlIssuers != null) {
                ...
                // Priority 3: configurable custom claim (e.g. corevance_tenant) — legacy/single-realm
