...
public class OidcLogoutSuccessHandler implements LogoutSuccessHandler {
    ...
    public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
        ...
        if (authentication != null && authentication.getPrincipal() instanceof CorevanceOidcUser oidcUser) {
            log.debug("OIDC logout initiated for user '{}' (tenant: '{}')", oidcUser.getName(), oidcUser.getTenantId());

            String provider = corevanceProperties.getSecurity().getOidcFederation().getProvider().getCode();
    ...
    private String buildLogoutUrl(String provider, CorevanceOidcUser oidcUser, HttpServletRequest request) {
    ...
    private String resolvePostLogoutUri(HttpServletRequest request) {
        String configured = corevanceProperties.getSecurity().getOidcFederation().getPostLogoutRedirectUri();
