...
import static com.corevance.portfolio.loanaccount.domain.LoanRepaymentScheduleProcessingWrapper.findInPeriod;
...
public class ProgressiveLoanScheduleGenerator implements LoanScheduleGenerator {
    ...
    public ProgressiveLoanScheduleGenerator(ScheduledDateGenerator scheduledDateGenerator, InstalmentCalculator emiCalculator,
    ...
    public OutstandingAmountsDTO calculatePrepaymentAmount(MonetaryCurrency currency, LocalDate onDate,
        ...
        if (!(loanRepaymentScheduleTransactionProcessor instanceof PhasedSettlementScheduleProcessor processor)) {
            throw new IllegalStateException("Expected an PhasedSettlementScheduleProcessor");
        }
    ...
    public Money getPeriodInterestTillDate(@NotNull LoanRepaymentScheduleInstallment installment, @NotNull LocalDate targetDate) {
        ...
        if (!(transactionProcessor instanceof PhasedSettlementScheduleProcessor)) {
            throw new IllegalStateException("Expected an PhasedSettlementScheduleProcessor");
        }
