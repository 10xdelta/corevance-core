 ...
 * under the License.
 */
package com.corevance.portfolio.loanaccount.repository;

import java.math.BigDecimal;
import java.util.List;
import com.corevance.portfolio.loanaccount.data.AmortizationAllocationBaseTransactionDTO;
...
public interface LoanCapitalizedIncomeBalanceRepository extends JpaRepository<LoanCapitalizedIncomeBalance, Long>,
    ...
    String FIND_BALANCE_REPAYMENT_SCHEDULE_DATA = "SELECT new com.corevance.portfolio.loanaccount.domain.LoanTransactionRepaymentPeriodData(lcib.loanTransaction.id, lcib.loan.id, lcib.loanTransaction.dateOf, lcib.loanTransaction.reversed, lcib.amount, lcib.unrecognizedAmount, lcib.loanTransaction.feeChargesPortion) FROM LoanCapitalizedIncomeBalance lcib ";
    ...
    @Query("""
            SELECT new com.corevance.portfolio.loanaccount.data.AmortizationAllocationBaseTransactionDTO(
