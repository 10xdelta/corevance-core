...
import com.corevance.portfolio.loanaccount.service.ProgressiveLoanInterestScheduleModelParserServiceGsonImpl;
...
class TieredInstalmentCalculatorTest {

    private static TieredInstalmentCalculator emiCalculator = new TieredInstalmentCalculator(new DefaultScheduledDateGenerator());
