 ...
 * under the License.
 */
package com.corevance.oauth2tests;
...
public class OAuth2AuthenticationTest {
    ...
    public void testActuatorAccess() {
        performServerGet(requestSpec, responseSpec, "/corevance-provider/actuator/info", null);
    }

    @Test
    public void testApiDocsAccess() {
        performServerGet(requestSpec, responseSpec, "/corevance-provider/legacy-docs/apiLive.htm", null);
    }

    @Test
    public void testAccessWithoutAuthentication() {
        performServerGet(requestSpec, responseSpec401, "/corevance-provider/api/v1/offices/1?" + TENANT_IDENTIFIER, null);
    }
    ...
    public void testGetOAuth2UserDetails() throws IOException, InterruptedException {
        ...
        String token = loginAndClaimToken(
                "https://localhost:8443/corevance-provider/oauth2/authorize" + "?response_type=code&client_id=frontend-client"
        ...
        Boolean authenticationCheck = performServerGet(requestSpecWithToken, responseSpec,
                "/corevance-provider/api/v1/userdetails?" + TENANT_IDENTIFIER, "authenticated");
    ...
    private String claimTokenOnCallback(RequestSpecification requestSpec, HttpExchange exchange) {
        ...
        return performServerPost(requestSpec, responseSpec, "/corevance-provider/oauth2/token", formParams, "access_token");
    }
