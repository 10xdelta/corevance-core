...
import static com.corevance.test.data.DaysInYearType.DAYS365;
import static com.corevance.test.factory.LoanProductsRequestFactory.CURRENCY_CODE;
import static com.corevance.test.factory.LoanProductsRequestFactory.CURRENCY_CODE_USD;
import static com.corevance.test.factory.LoanProductsRequestFactory.DATE_FORMAT;
import static com.corevance.test.factory.LoanProductsRequestFactory.DAYS_IN_MONTH_TYPE_30;
import static com.corevance.test.factory.LoanProductsRequestFactory.DAYS_IN_YEAR_TYPE_360;
import static com.corevance.test.factory.LoanProductsRequestFactory.FUND_ID;
...
import com.corevance.test.data.workingcapitalproduct.WorkingCapitalBreachCalculationType;
...
public class WorkingCapitalRequestFactory {
    ...
    private Long getWCBreachIdByName(String breachName) {
        try {
            List<WorkingCapitalBreachData> breaches = corevanceClient.workingCapitalBreaches().retrieveAllWorkingCapitalBreaches(Map.of());
    ...
    private Long getWCNearBreachIdByName(String breachName) {
        try {
            List<WorkingCapitalNearBreachData> breaches = corevanceClient.workingCapitalNearBreaches()
