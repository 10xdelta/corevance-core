...
import com.corevance.client.models.ConfiguredJobNamesDTO;
...
public class WorkFlowJobHelper {
    ...
    public void setWorkflowJobs() {
        ...
        executeVoid(() -> corevanceClient.businessStepConfiguration().updateJobBusinessStepConfig(WORKFLOW_NAME_LOAN_CLOSE_OF_BUSINESS,
                request, Map.of()));
        logChanges();
    }
    ...
    public ConfiguredJobNamesDTO getConfiguredBusinessJobs() {
        return ok(() -> corevanceClient.businessStepConfiguration().retrieveAllConfiguredBusinessJobs(Map.of()));
    }
    ...
    public JobBusinessStepConfigData getConfiguredWorkflowSteps(String jobName) {
        return ok(() -> corevanceClient.businessStepConfiguration().retrieveAllConfiguredBusinessStep(jobName, Map.of()));
    }
    ...
    public JobBusinessStepDetail getAvailableWorkflowSteps(String jobName) {
        return ok(() -> corevanceClient.businessStepConfiguration().retrieveAllAvailableBusinessStep(jobName, Map.of()));
    }
    ...
    public void updateWorkflowSteps(String jobName, List<BusinessStep> steps) {
        ...
        executeVoid(() -> corevanceClient.businessStepConfiguration().updateJobBusinessStepConfig(jobName, request, Map.of()));
    }

    private void logChanges() {
        JobBusinessStepConfigData changesResponse = ok(() -> corevanceClient.businessStepConfiguration()
