 ...
 * under the License.
 */
package com.corevance.test.config;
...
public class TestDatabaseConfiguration {
    ...
    @Value("${corevance-test.db.protocol}")
    private String protocol;

    @Value("${corevance-test.db.hostname}")
    private String hostname;

    @Value("${corevance-test.db.port}")
    private String port;

    @Value("${corevance-test.db.name}")
    private String dbName;

    @Value("${corevance-test.db.username}")
    private String username;

    @Value("${corevance-test.db.password}")
