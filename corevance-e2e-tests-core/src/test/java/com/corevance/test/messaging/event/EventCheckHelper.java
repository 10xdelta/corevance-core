 ...
 * under the License.
 */
package com.corevance.test.messaging.event;

import static com.corevance.client.feign.util.FeignCalls.ok;
import static com.corevance.test.stepdef.loan.LoanRepaymentStepDef.DATE_FORMAT;
...
import com.corevance.avro.loan.v1.DelinquencyPausePeriodV1;
...
import com.corevance.avro.loan.v1.LoanOwnershipTransferDataV1;
...
import com.corevance.client.models.GetLoansLoanIdDelinquencyPausePeriod;
...
import com.corevance.test.data.AssetExternalizationTransferStatus;
import com.corevance.test.data.AssetExternalizationTransferStatusReason;
import com.corevance.test.data.TransactionType;
import com.corevance.test.helper.ErrorMessageHelper;
import com.corevance.test.helper.GlobalConfigurationHelper;
import com.corevance.test.messaging.EventAssertion;
import com.corevance.test.messaging.event.assetexternalization.LoanAccountSnapshotEvent;
import com.corevance.test.messaging.event.assetexternalization.LoanOwnershipTransferEvent;
import com.corevance.test.messaging.event.client.ClientActivatedEvent;
import com.corevance.test.messaging.event.client.ClientCreatedEvent;
import com.corevance.test.messaging.event.loan.AbstractLoanEvent;
import com.corevance.test.messaging.event.loan.LoanApprovedEvent;
import com.corevance.test.messaging.event.loan.LoanBalanceChangedEvent;
import com.corevance.test.messaging.event.loan.LoanCreatedEvent;
import com.corevance.test.messaging.event.loan.LoanDisbursalEvent;
import com.corevance.test.messaging.event.loan.LoanRejectedEvent;
import com.corevance.test.messaging.event.loan.LoanStatusChangedEvent;
import com.corevance.test.messaging.event.loan.LoanUndoApprovalEvent;
import com.corevance.test.messaging.event.loan.delinquency.LoanDelinquencyPauseChangedEvent;
import com.corevance.test.messaging.event.loan.delinquency.LoanDelinquencyRangeChangeEvent;
import com.corevance.test.messaging.event.loan.transaction.AbstractLoanTransactionEvent;
...
import com.corevance.test.messaging.event.loan.transaction.LoanRefundPostBusinessEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionGoodwillCreditPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionInterestPaymentWaiverPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionInterestRefundPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionMakeRepaymentPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionMerchantIssuedRefundPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanTransactionPayoutRefundPostEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanUndoContractTerminationBusinessEvent;
import com.corevance.test.messaging.event.workingcapitalloan.transaction.WorkingCapitalLoanCreditBalanceRefundTransactionBusinessEvent;
import com.corevance.test.messaging.event.workingcapitalloan.transaction.WorkingCapitalLoanDisbursalTransactionBusinessEvent;
import com.corevance.test.messaging.event.workingcapitalloan.transaction.WorkingCapitalLoanDiscountFeeAdjustmentTransactionBusinessEvent;
import com.corevance.test.messaging.event.workingcapitalloan.transaction.WorkingCapitalLoanDiscountFeeTransactionBusinessEvent;
import com.corevance.test.messaging.event.workingcapitalloan.transaction.WorkingCapitalLoanUndoDisbursalTransactionBusinessEvent;
...
public class EventCheckHelper {
    ...
    @Autowired
    private com.corevance.test.messaging.config.EventProperties eventProperties;
    ...
    public void clientEventCheck(PostClientsResponse clientCreationResponse) {
        ...
        GetClientsClientIdResponse body = ok(() -> corevanceClient.clients().retrieveOneClient(clientCreationResponse.getClientId(),
    ...
    public void undoApproveLoanEventCheck(PostLoansLoanIdResponse loanUndoApproveResponse) {
        waitForTransactionCommit();
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(loanUndoApproveResponse.getLoanId(),
    ...
    public void loanRejectedEventCheck(PostLoansLoanIdResponse loanRejectedResponse) {
        waitForTransactionCommit();
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(loanRejectedResponse.getLoanId(),
                Map.of("staffInSelectedOfficeOnly", false, "associations", "", "exclude", "", "fields", "")));
    ...
    private void loanAccountDataV1Check(Class<? extends AbstractLoanEvent> eventClazz, Long loanId) {
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(loanId,
    ...
    public GetLoansLoanIdTransactions findNthTransaction(String nthItemStr, String transactionType, String transactionDate, long loanId) {
        GetLoansLoanIdResponse loanResponse = ok(() -> corevanceClient.loans().retrieveOneLoan(loanId,
    ...
    public void loanDisbursalTransactionEventCheck(PostLoansLoanIdResponse loanDisburseResponse) {
        ...
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(loanDisburseResponse.getLoanId(),
                Map.of("staffInSelectedOfficeOnly", false, "associations", "transactions", "exclude", "", "fields", "")));
    ...
    public void loanOwnershipTransferBusinessEventCheck(Long loanId, Long transferId) {
        waitForTransactionCommit();
        PageExternalTransferData response = ok(() -> corevanceClient.externalAssetOwners().getTransfers(Map.of("loanId", loanId)));
    ...
    public void createLoanEventCheck(PostLoansResponse createLoanResponse) {
        waitForTransactionCommit();
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(createLoanResponse.getLoanId(),
                Map.of("staffInSelectedOfficeOnly", false, "associations", "all", "exclude", "", "fields", "")));
    ...
    public void approveLoanEventCheck(PostLoansLoanIdResponse loanApproveResponse) {
        waitForTransactionCommit();
        GetLoansLoanIdResponse body = ok(() -> corevanceClient.loans().retrieveOneLoan(loanApproveResponse.getLoanId(),
                Map.of("staffInSelectedOfficeOnly", false, "associations", "", "exclude", "", "fields", "")));
