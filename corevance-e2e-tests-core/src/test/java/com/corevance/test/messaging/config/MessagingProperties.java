 ...
 * under the License.
 */
package com.corevance.test.messaging.config;
...
public class MessagingProperties implements InitializingBean {
    ...
    @Value("${corevance-test.messaging.jms.broker-url}")
    private String brokerUrl;
    @Value("${corevance-test.messaging.jms.broker-username}")
    private String brokerUsername;
    @Value("${corevance-test.messaging.jms.broker-password}")
    private String brokerPassword;
    @Value("${corevance-test.messaging.jms.topic-name}")
