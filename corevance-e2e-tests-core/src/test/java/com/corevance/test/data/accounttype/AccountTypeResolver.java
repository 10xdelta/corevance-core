 ...
 * under the License.
 */
package com.corevance.test.data.accounttype;
...
public class AccountTypeResolver {
    ...
    public long resolve(AccountType accountType) {
        ...
        List<GetGLAccountsResponse> accountTypeResponses = ok(() -> corevanceClient.generalLedgerAccount().retrieveAllAccountsUniversal(
