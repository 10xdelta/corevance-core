 ...
 * under the License.
 */
package com.corevance.test.data.loanproduct;
...
public class LoanProductResolver {
    ...
    public long resolve(LoanProduct loanProduct) {
        ...
        List<GetLoanProductsResponse> loanProductsResponses = ok(() -> corevanceClient.loanProducts().retrieveAllLoanProducts(Map.of()));
