 ...
 * under the License.
 */
package com.corevance.test.data.codevalue;
...
public class CodeValueResolver {
    ...
    public long resolve(Long codeId, CodeValue codeValue) {
        ...
        List<GetCodeValuesDataResponse> codeValuesResponses = ok(() -> corevanceClient.codeValues().retrieveAllCodeValues(codeId, Map.of()));
    ...
    public long resolve(String codeName, String codeValue) {
        ...
        List<GetCodeValuesDataResponse> codeValuesResponses = ok(
                () -> corevanceClient.codeValues().retrieveAllCodeValuesByCodeName(codeName, Map.of()));
