 ...
 * under the License.
 */
package com.corevance.test.data.paymenttype;
...
public class PaymentTypeResolver {
    ...
    public long resolve(PaymentType paymentType) {
        ...
        List<PaymentTypeData> paymentTypesResponses = ok(() -> corevanceClient.paymentType().getAllPaymentTypesUniversal(Map.of()));
