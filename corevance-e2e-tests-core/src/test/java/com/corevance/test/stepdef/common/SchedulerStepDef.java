...
import com.corevance.test.data.job.DefaultJob;
import com.corevance.test.service.JobService;
...
public class SchedulerStepDef extends AbstractStepDef {
    ...
    public void verifyJobDisplayName(String shortName, String expectedDisplayName) {
        GetJobsResponse response = ok(() -> corevanceClient.schedulerJob().retrieveByShortName(shortName, Map.of()));
