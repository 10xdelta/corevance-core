...
import com.corevance.client.models.DelinquencyRangeData;
...
import com.corevance.client.models.GetLoansLoanIdLoanInstallmentLevelDelinquency;
...
import com.corevance.test.data.DelinquencyRange;
...
public class LoanDelinquencyStepDef extends AbstractStepDef {
    ...
    public void checkDelinquencyRange(String range, String delinquentDateExpected) {
        ...
        GetLoansLoanIdResponse loanDetails = ok(() -> corevanceClient.loans().retrieveOneLoan(loanId, Map.of("associations", "collection")));
    ...
    public void checkDelinquencyRange(String nthInList, String range, String addedOnDate, String delinquentDateExpected) {
        ...
        List<GetDelinquencyTagHistoryResponse> delinquencyHistoryDetails = ok(
                () -> corevanceClient.loans().retrieveDelinquencyTagHistoryLoan(loanId));
    ...
    public void delinquencyHistoryCheck(DataTable table) {
        ...
        List<GetDelinquencyTagHistoryResponse> body = ok(() -> corevanceClient.loans().retrieveDelinquencyTagHistoryLoan(loanId));
    ...
    public void delinquencyPause(String startDate, String endDate) {
        ...
        PostLoansDelinquencyActionResponse response = ok(() -> corevanceClient.loans().createDelinquencyActionLoan(loanId, request));
    ...
    public void delinquencyPauseWithCreatedUser(String startDate, String endDate) {
        ...
        CorevanceFeignClient userClient = corevanceClientConfiguration.corevanceFeignClientForUser(username, password);
    ...
    public void delinquencyPauseByLoanExternalId(String startDate, String endDate) {
        ...
        PostLoansDelinquencyActionResponse response = ok(
                () -> corevanceClient.loans().createDelinquencyActionLoanByExternalId(loanExternalId, request));
        testContext().set(TestContextKey.LOAN_DELINQUENCY_ACTION_RESPONSE, response);
        eventCheckHelper.loanAccountDelinquencyPauseChangedBusinessEventCheck(loanId);
    }
    ...
    public void getDelinquencyActionData(DataTable table) {
        ...
        List<GetDelinquencyActionsResponse> response = ok(() -> corevanceClient.loans().retrieveDelinquencyActionsLoan(loanId));
    ...
    private void errorMessageAssertationFeign(long loanId, PostLoansDelinquencyActionRequest request, int errorCodeExpected,
        ...
        CallFailedRuntimeException exception = fail(() -> corevanceClient.loans().createDelinquencyActionLoan(loanId, request));
