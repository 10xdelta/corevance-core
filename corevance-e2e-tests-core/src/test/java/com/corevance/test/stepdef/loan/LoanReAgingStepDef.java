...
import com.corevance.test.messaging.event.loan.LoanReAgeEvent;
import com.corevance.test.messaging.event.loan.transaction.LoanReAgeTransactionEvent;
...
public class LoanReAgingStepDef extends AbstractStepDef {
    ...
    public void createReAgingTransaction(DataTable table) throws IOException {
        ...
        PostLoansLoanIdTransactionsResponse response = ok(
                () -> corevanceClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAgingRequest, Map.of("command", "reAge")));
    ...
    public void createReAgingPreview(DataTable table) {
        ...
        LoanScheduleData response = ok(() -> corevanceClient.loanTransactions().previewReAgeLoanSchedule(loanId, queryParams));
    ...
    public LoanScheduleData reAgingPreviewByLoanExternalId(DataTable table) {
        ...
        LoanScheduleData result = ok(
                () -> corevanceClient.loanTransactions().previewReAgeLoanScheduleByLoanExternalId(loanExternalId, queryParams));
    ...
    public void adminCreatesALoanReAgingTransactionByLoanExternalIDWithTheFollowingDataButFailsWithErrorCode(int errorCode,
        ...
        CallFailedRuntimeException response = fail(() -> corevanceClient.loanTransactions()
                .handleCommandsLoanTransactionByLoanExternalId(loanExternalId, reAgingRequest, Map.of("command", "reAge")));
