...
public class WorkingCapitalDelinquencyStepDef extends AbstractStepDef {
    ...
    public void initiateDelinquencyResumeResultsAnErrorWithDetails(final String startDate, final DataTable table) {
        ...
        final CallFailedRuntimeException exception = fail(
                () -> corevanceClient.workingCapitalLoanDelinquencyActions().createDelinquencyAction(loanId, request));
    ...
    private String retrieveLoanExternalId(Long loanId) {
        return ok(() -> corevanceClient.workingCapitalLoans().retrieveWorkingCapitalLoanById(loanId)).getExternalId();
    }
    ...
    private PostWorkingCapitalLoansDelinquencyActionResponse createDelinquencyActionById(Long loanId,
        ...
        return ok(() -> corevanceClient.workingCapitalLoanDelinquencyActions().createDelinquencyAction(loanId, request));
    }

    private PostWorkingCapitalLoansDelinquencyActionResponse createDelinquencyActionByExternalId(String loanExternalId,
            PostWorkingCapitalLoansDelinquencyActionRequest request) {
        return ok(() -> corevanceClient.workingCapitalLoanDelinquencyActions().createDelinquencyActionByExternalId(loanExternalId, request));
    }
    ...
    private List<WorkingCapitalLoanDelinquencyActionData> retrieveDelinquencyActions(Long loanId) {
        List<WorkingCapitalLoanDelinquencyActionData> actions = ok(
                () -> corevanceClient.workingCapitalLoanDelinquencyActions().retrieveDelinquencyActions(loanId));
    ...
    private List<WorkingCapitalLoanDelinquencyActionData> retrieveDelinquencyActionsByExternalId(String loanExternalId) {
        List<WorkingCapitalLoanDelinquencyActionData> actions = ok(
                () -> corevanceClient.workingCapitalLoanDelinquencyActions().retrieveDelinquencyActionsByExternalId(loanExternalId));
    ...
    private List<WorkingCapitalLoanDelinquencyRangeScheduleData> retrieveRangeSchedule(Long loanId) {
        List<WorkingCapitalLoanDelinquencyRangeScheduleData> rangeSchedule = ok(
                () -> corevanceClient.workingCapitalLoanDelinquencyRangeSchedule().retrieveDelinquencyRangeSchedule(loanId));
    ...
    public void initiateDelinquencyDisableWithoutPermissionResultsAnError(String startDate) {
        ...
        final CorevanceFeignClient userClient = userClient();
    ...
    private CorevanceFeignClient userClient() {
