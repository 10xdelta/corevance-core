...
import static com.corevance.client.feign.util.FeignCalls.failVoid;
...
import com.corevance.client.models.GetLoansLoanIdOriginatorData;
...
import com.corevance.test.api.CorevanceClientConfiguration;
...
import com.corevance.test.messaging.event.loan.repayment.LoanRepaymentDueEvent;
...
public class LoanOriginationStepDef extends AbstractStepDef {
    ...
    private final CorevanceClientConfiguration corevanceClientConfiguration;
    ...
    public void createOriginatorWithAllFields(String name) {
        GetLoanOriginatorTemplateResponse template = ok(() -> corevanceClient.loanOriginators().retrieveLoanOriginatorTemplate());
    ...
    public void verifyOriginatorStatus(String expectedStatus) {
        ...
        GetLoanOriginatorsResponse originator = ok(() -> corevanceClient.loanOriginators().retrieveOneLoanOriginator(originatorId));
    ...
    public void detachOriginatorFromLoan() {
        ...
        executeVoid(() -> corevanceClient.loanOriginators().detachOriginatorFromLoan(loanId, originatorId));
    ...
    public void verifyOriginatorWithAllFieldsInLoanDetails(String association) {
        ...
        GetLoanOriginatorsResponse originatorDetails = ok(() -> corevanceClient.loanOriginators().retrieveOneLoanOriginator(originatorId));
    ...
    public void attachOriginatorShouldFail() {
        ...
        failVoid(() -> corevanceClient.loanOriginators().attachOriginatorToLoan(loanId, originatorId));
    ...
    public void attachNonExistentOriginatorShouldFail(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = failVoid(
                () -> corevanceClient.loanOriginators().attachOriginatorToLoan(loanId, NON_EXISTENT_ID));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void attachOriginatorToNonExistentLoanShouldFail(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = failVoid(
                () -> corevanceClient.loanOriginators().attachOriginatorToLoan(NON_EXISTENT_ID, originatorId));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void createOriginatorWithoutNameShouldFail(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = fail(() -> corevanceClient.loanOriginators().createLoanOriginator(request));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void userWithoutAttachPermissionFails() {
        long loanId = getLoanId();
        long originatorId = getOriginatorId();
        CorevanceFeignClient userClient = createClientForUser();
    ...
    public void retrieveOriginatorByExternalIdWithAllFields() {
        ...
        GetLoanOriginatorsResponse originator = ok(() -> corevanceClient.loanOriginators().retrieveByExternalId(expectedExternalId));
    ...
    public void verifyOriginatorInList() {
        ...
        List<GetLoanOriginatorsResponse> allOriginators = ok(() -> corevanceClient.loanOriginators().retrieveAllLoanOriginators());
    ...
    public void updateOriginatorById(String newName, String newStatus) {
        ...
        PutLoanOriginatorsResponse updateResponse = ok(
                () -> corevanceClient.loanOriginators().updateLoanOriginator(originatorId, updateRequest));
    ...
    public void updateOriginatorByExternalId(String newName) {
        ...
        PutLoanOriginatorsResponse updateResponse = ok(
                () -> corevanceClient.loanOriginators().updateByExternalId(externalId, updateRequest));
    ...
    public void verifyOriginatorByExternalIdHasName(String expectedName) {
        ...
        GetLoanOriginatorsResponse originator = ok(() -> corevanceClient.loanOriginators().retrieveByExternalId(externalId));
    ...
    public void deleteOriginatorById() {
        ...
        DeleteLoanOriginatorsResponse deleteResponse = ok(() -> corevanceClient.loanOriginators().deleteLoanOriginator(originatorId));
    ...
    public void deleteOriginatorByExternalId() {
        ...
        DeleteLoanOriginatorsResponse deleteResponse = ok(() -> corevanceClient.loanOriginators().deleteByExternalId(externalId));
    ...
    public void retrieveDeletedOriginatorByIdShouldFail(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = fail(() -> corevanceClient.loanOriginators().retrieveOneLoanOriginator(originatorId));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void retrieveDeletedOriginatorByExternalIdShouldFail(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = fail(() -> corevanceClient.loanOriginators().retrieveByExternalId(externalId));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void deleteOriginatorShouldFailWithStatus(int expectedStatus) {
        ...
        CallFailedRuntimeException exception = fail(() -> corevanceClient.loanOriginators().deleteLoanOriginator(originatorId));
        assertExpectedStatus(exception, expectedStatus);
    ...
    public void makeLoanRepaymentUndoWithoutEventCheck(String transactionDate) {
        ...
        ok(() -> corevanceClient.loanTransactions().adjustLoanTransaction(loanId, originalTransactionId, repaymentUndoRequest,
    ...
    public void adjustLoanRepaymentWithoutEventCheck(String transactionDate, double transactionAmount) {
        ...
        PostLoansLoanIdTransactionsResponse repaymentAdjustmentResponse = ok(() -> corevanceClient.loanTransactions()
    ...
    public void reverseWaiverTransaction(String transactionDate) {
        ...
        GetLoansLoanIdResponse loanDetails = ok(
                () -> corevanceClient.loans().retrieveOneLoan(loanId, Map.<String, Object>of("associations", "transactions")));
        ...
        ok(() -> corevanceClient.loanTransactions().adjustLoanTransaction(loanId, waiveTransactionId, undoRequest,
                Map.<String, Object>of()));
    ...
    private void attachOriginatorInternal(String originatorContextKey) {
        ...
        executeVoid(() -> corevanceClient.loanOriginators().attachOriginatorToLoan(loanId, originatorId));
    ...
    private CorevanceFeignClient createClientForUser() {
        ...
        return corevanceClientConfiguration.corevanceFeignClientForUser(username, password);
    }
