...
public class WorkingCapitalLoanActionTemplateStepDef extends AbstractStepDef {
    ...
    public void retrieveWcLoanActionTemplate(final String templateType) {
        ...
        final WorkingCapitalLoanCommandTemplateData response = ok(
                () -> corevanceClient.workingCapitalLoanTransactions().retrieveWorkingCapitalLoanActionTemplate(loanId, templateType));
    ...
    public void retrieveTemplateWithoutType() {
        ...
        final CallFailedRuntimeException exception = fail(
                () -> corevanceClient.workingCapitalLoanTransactions().retrieveWorkingCapitalLoanActionTemplate(loanId, (String) null));
    ...
    public void retrieveTemplateForNonExistentLoan(final Long loanId) {
        final CallFailedRuntimeException exception = fail(
                () -> corevanceClient.workingCapitalLoanTransactions().retrieveWorkingCapitalLoanActionTemplate(loanId, "approve"));
