...
import com.corevance.test.helper.WorkingCapitalLoanTestHelper;
...
public class WorkingCapitalLoanCobStepDef extends AbstractStepDef {
    ...
    public void runWorkingCapitalInlineCOB() {
        ...
        ok(() -> corevanceClient.inlineJob().executeInlineJob("WC_LOAN_COB", inlineJobRequest));
    }
    ...
    public void placeChunkLockWithoutErrorOnLastWcLoan() {
        ...
        executeVoid(() -> corevanceClient.workingCapitalLoanAccountLock().placeLockOnWorkingCapitalLoanAccount(loanId,
    ...
    public void runWorkingCapitalLoanCOBCatchUp() {
        try {
            executeVoid(() -> corevanceClient.workingCapitalLoanCobCatchUpApi().executeLoanCOBCatchUp1());
    ...
    public void checkWCLoanCOBCatchUpRunningUntilCOBBusinessDate() {
        ...
        await() //
                ...
                .until(() -> {
                    IsCatchUpRunningDTO statusResponse = ok(() -> corevanceClient.workingCapitalLoanCobCatchUpApi().isCatchUpRunning1());
                    ...
                    OldestCOBProcessedLoanDTO catchUpStatus = ok(
                            () -> corevanceClient.workingCapitalLoanCobCatchUpApi().getOldestCOBProcessedLoan1());
    ...
    public void adminClearsInternalWorkingCapitalCOBLastRunData(String isEmpty) {
        Map<String, Object> ok = ok(() -> corevanceClient.workingCapitalLoanInternalCobApi().getLastCobRun());
    ...
    public void adminClearsInternalWorkingCapitalCOBLastRunData() {
        ok(() -> corevanceClient.workingCapitalLoanInternalCobApi().deleteLastCobRun());
    }
