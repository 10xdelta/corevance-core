...
import com.corevance.test.messaging.event.assetexternalization.LoanAccountCustomSnapshotEvent;
...
import com.corevance.test.messaging.event.loan.repayment.LoanRepaymentOverdueEvent;
...
public class InlineCOBStepDef extends AbstractStepDef {
    ...
    public void runInlineCOB() throws IOException {
        ...
        ok(() -> corevanceClient.inlineJob().executeInlineJob("LOAN_COB", inlineJobRequest));
    }
