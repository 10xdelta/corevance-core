...
import com.corevance.client.models.LoanSchedulePeriodData;
...
import com.corevance.test.messaging.event.loan.LoanReAmortizeEvent;
...
public class LoanReAmortizationStepDef extends AbstractStepDef {
    ...
    public void createLoanReAmortization() {
        ...
        PostLoansLoanIdTransactionsResponse response = ok(() -> corevanceClient.loanTransactions().handleCommandsLoanTransaction(loanId,
    ...
    public void createLoanReAmortizationWithInterestHandlingShouldFail(final String reAmortizationInterestHandling) {
        ...
        fail(() -> corevanceClient.loanTransactions().handleCommandsLoanTransaction(loanId, reAmortizationRequest,
    ...
    public void createLoanReAmortizationWithInterestHandling(final String reAmortizationInterestHandling) {
        ...
        final PostLoansLoanIdTransactionsResponse response = ok(() -> corevanceClient.loanTransactions()
    ...
    public void createLoanReAmortizationByLoanExternalId() {
        ...
        PostLoansLoanIdTransactionsResponse response = ok(() -> corevanceClient.loanTransactions()
    ...
    public void createReAmortizedPreviewByLoanExternalIdFailsWithErrorCode(int errorCode, final DataTable table) {
        ...
        CallFailedRuntimeException exception = fail(
                () -> corevanceClient.loanTransactions().previewReAmortizeLoanScheduleByLoanExternalId(loanExternalId, queryParams));
    ...
    private LoanScheduleData reAmortizedPreviewByLoanExternalId(final DataTable table) {
        ...
        final Map<String, Object> queryParams = Map.of("reAmortizationInterestHandling", reAmortizationInterestHandling);
        return ok(() -> corevanceClient.loanTransactions().previewReAmortizeLoanScheduleByLoanExternalId(loanExternalId, queryParams));
    }
