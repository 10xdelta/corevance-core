...
import com.corevance.client.models.GetWorkingCapitalLoansLoanIdOriginatorData;
...
import com.corevance.client.models.PostWorkingCapitalLoansOriginatorData;
...
public class WorkingCapitalLoanOriginationStepDef extends AbstractStepDef {
    ...
    public void detachOriginator() {
        ...
        executeVoid(() -> corevanceClient.workingCapitalLoanOriginators().detachOriginatorFromWorkingCapitalLoan(loanId, originatorId));
    }
    ...
    public void createWorkingCapitalLoanWithInlineOriginatorShouldFail(final int expectedStatus, final DataTable table) {
        ...
        assertCallFails(() -> corevanceClient.workingCapitalLoans().submitWorkingCapitalLoanApplication(request), expectedStatus);
    }
    ...
    public void retrieveByLoanId(final int expectedCount) {
        ...
        final LoanOriginatorsResponse response = ok(
                () -> corevanceClient.workingCapitalLoanOriginators().retrieveOriginatorsByWorkingCapitalLoanId(loanId));
    ...
    public void retrieveByLoanExternalId(final int expectedCount) {
        ...
        final LoanOriginatorsResponse response = ok(
                () -> corevanceClient.workingCapitalLoanOriginators().retrieveOriginatorsByWorkingCapitalLoanExternalId(loanExternalId));
    ...
    public void attachShouldFail(final int expectedStatus) {
        final long loanId = getLoanId();
        final long originatorId = getOriginatorId(TestContextKey.ORIGINATOR_CREATE_RESPONSE);
        assertVoidCallFails(() -> corevanceClient.workingCapitalLoanOriginators().attachOriginatorToWorkingCapitalLoan(loanId, originatorId),
                expectedStatus);
    }
    ...
    public void detachShouldFail(final int expectedStatus) {
        ...
        final long originatorId = getOriginatorId(TestContextKey.ORIGINATOR_CREATE_RESPONSE);
        assertVoidCallFails(
                () -> corevanceClient.workingCapitalLoanOriginators().detachOriginatorFromWorkingCapitalLoan(loanId, originatorId),
                expectedStatus);
    }
    ...
    public void attachNonExistentOriginatorShouldFail(final int expectedStatus) {
        final long loanId = getLoanId();
        assertVoidCallFails(
                () -> corevanceClient.workingCapitalLoanOriginators().attachOriginatorToWorkingCapitalLoan(loanId, NON_EXISTENT_ID),
                expectedStatus);
    }
    ...
    public void attachToNonExistentLoanShouldFail(final int expectedStatus) {
        assertVoidCallFails(
                () -> corevanceClient.workingCapitalLoanOriginators().attachOriginatorToWorkingCapitalLoan(NON_EXISTENT_ID, NON_EXISTENT_ID),
                expectedStatus);
    }
    ...
    public void detachFromNonExistentLoanShouldFail(final int expectedStatus) {
        assertVoidCallFails(() -> corevanceClient.workingCapitalLoanOriginators().detachOriginatorFromWorkingCapitalLoan(NON_EXISTENT_ID,
    ...
    public void detachNonExistentOriginatorShouldFail(final int expectedStatus) {
        final long loanId = getLoanId();
        assertVoidCallFails(
                () -> corevanceClient.workingCapitalLoanOriginators().detachOriginatorFromWorkingCapitalLoan(loanId, NON_EXISTENT_ID),
                expectedStatus);
    }
    ...
    public void retrieveByNonExistentLoanShouldFail(final int expectedStatus) {
        assertCallFails(() -> corevanceClient.workingCapitalLoanOriginators().retrieveOriginatorsByWorkingCapitalLoanId(NON_EXISTENT_ID),
                expectedStatus);
    }
    ...
    public void retrieveByNonExistentExternalIdShouldFail(final int expectedStatus) {
        ...
        assertCallFails(() -> corevanceClient.workingCapitalLoanOriginators()
    ...
    public void attachOriginatorByOriginatorExternalId() {
        final long loanId = getLoanId();
        final String originatorExternalId = getExternalId(TestContextKey.ORIGINATOR_EXTERNAL_ID);
        executeVoid(() -> corevanceClient.workingCapitalLoanOriginators().attachOriginatorToWorkingCapitalLoanByOriginatorExternalId(loanId,
    ...
    public void attachOriginatorByLoanExternalId() {
        final String loanExternalId = retrieveLoanDetails().getExternalId();
        final long originatorId = getOriginatorId(TestContextKey.ORIGINATOR_CREATE_RESPONSE);
        executeVoid(() -> corevanceClient.workingCapitalLoanOriginators()
    ...
    private void attachOriginatorById(final String originatorContextKey) {
        ...
        executeVoid(() -> corevanceClient.workingCapitalLoanOriginators().attachOriginatorToWorkingCapitalLoan(loanId, originatorId));
    }
