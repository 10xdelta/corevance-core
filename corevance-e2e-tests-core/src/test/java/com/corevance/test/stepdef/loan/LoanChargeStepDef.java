...
import com.corevance.avro.loan.v1.LoanChargeDataV1;
...
import com.corevance.test.data.ErrorMessageType;
import com.corevance.test.factory.LoanChargeRequestFactory;
...
import com.corevance.test.messaging.event.loan.charge.LoanAddChargeEvent;
...
public class LoanChargeStepDef extends AbstractStepDef {
    ...
    public void addChargeDueDate(String chargeType, String transactionDate, double transactionAmount) throws IOException {
        ...
        PostLoansLoanIdChargesResponse loanChargeResponse = ok(
                () -> corevanceClient.loanCharges().createOrPayLoanCharge(loanId, loanIdChargesRequest, Map.<String, Object>of()));
    ...
    public void waiveCharge() throws IOException {
        ...
        PostLoansLoanIdChargesChargeIdResponse waiveResponse = ok(() -> corevanceClient.loanCharges()
    ...
    public void undoWaiveForCharge() throws IOException {
        ...
        PutChargeTransactionChangesResponse undoWaiveResponse = ok(
                () -> corevanceClient.loanTransactions().undoWaiveChargeLoanTransaction(loanId, transactionId, undoWaiveRequest));
    ...
    public void checkLoanChargeAmount(float chargeAmount) throws IOException {
        ...
        GetLoansLoanIdChargesChargeIdResponse loanChargeAmount = ok(
                () -> corevanceClient.loanCharges().retrieveOneLoanCharge(response.getLoanId(), Long.valueOf(response.getResourceId())));
    ...
    private void addChargeEventCheck(PostLoansLoanIdChargesResponse loanChargeResponse) throws IOException {
        ...
        GetLoansLoanIdChargesChargeIdResponse chargeDetails = ok(() -> corevanceClient.loanCharges()
