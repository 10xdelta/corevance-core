...
import com.corevance.test.api.ApiProperties;
...
public class ConnectionPoolDiagnosticsHook {
    ...
    private static final String TENANT_PREFIX = "corevance_tenants_";
    ...
    public void stopConnectionPoolDiagnostics(Scenario scenario) {
        ...
        int recoveryTimeoutSeconds = Integer.getInteger("corevance-test.connection-pool.recovery-timeout-seconds", 30);
    ...
    private URI prometheusUri() {
        ...
        return URI.create(baseUrl + "/corevance-provider/actuator/prometheus");
    }
