...
import com.corevance.client.models.CurrencyUpdateResponse;
...
public class CurrencyStepDef extends AbstractStepDef {
    ...
    public void adminRetrievesCurrencyConfiguration() {
        ...
        CurrencyConfigurationData response = ok(() -> corevanceClient.currency().retrieveCurrencies());
    ...
    public void adminUpdatesSelectedCurrencies(String currencyCodes) {
        ...
        CurrencyUpdateResponse response = ok(() -> corevanceClient.currency().updateCurrencies(request, Map.of()));
    ...
    public void adminResetsSelectedCurrenciesToDefault() {
        ...
        ok(() -> corevanceClient.currency().updateCurrencies(request, Map.of()));
