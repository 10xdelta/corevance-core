...
import com.corevance.avro.loan.v1.LoanTransactionEnumDataV1;
...
import com.corevance.client.models.GetLoansType;
...
import com.corevance.test.messaging.event.loan.transaction.LoanChargebackTransactionEvent;
...
public class LoanChargeBackStepDef extends AbstractStepDef {
    ...
    private void makeChargebackCall(Long loanId, Long transactionId, String repaymentType, double transactionAmount) throws IOException {
        ...
        PostLoansLoanIdTransactionsResponse chargebackResponse = ok(() -> corevanceClient.loanTransactions().adjustLoanTransaction(loanId,
