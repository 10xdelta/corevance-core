...
import com.corevance.client.models.PostWorkingCapitalLoansBreachActionResponse;
...
public class WorkingCapitalBreachActionStepDef extends AbstractStepDef {
    ...
    public void retrieveBreachActionsForNonExistentLoanResultsInNotFound() {
        final CallFailedRuntimeException exception = fail(
                () -> corevanceClient.workingCapitalLoanBreachActions().retrieveBreachActions(NON_EXISTENT_LOAN_ID));
    ...
    public void initiateBreachResumeResultsAnError(final String startDate, final DataTable table) {
        ...
        final CallFailedRuntimeException exception = fail(
                () -> corevanceClient.workingCapitalLoanBreachActions().createBreachAction(loanId, request));
    ...
    public void initiateBreachUndoResetResultsAnError(final DataTable table) {
        ...
        final CallFailedRuntimeException exception = fail(() -> corevanceClient.workingCapitalLoanBreachActions().createBreachAction(loanId,
    ...
    private PostWorkingCapitalLoansBreachActionResponse createBreachAction(final Long loanId,
        ...
        return corevanceClient.workingCapitalLoanBreachActions().createBreachAction(loanId, request);
    }
    ...
    private PostWorkingCapitalLoansBreachActionResponse createBreachActionById(final Long loanId,
            final PostWorkingCapitalLoansBreachActionRequest request) {
        return ok(() -> corevanceClient.workingCapitalLoanBreachActions().createBreachAction(loanId, request));
    }

    private PostWorkingCapitalLoansBreachActionResponse createBreachActionByExternalId(final String loanExternalId,
            final PostWorkingCapitalLoansBreachActionRequest request) {
        return ok(() -> corevanceClient.workingCapitalLoanBreachActions().createBreachActionByExternalId(loanExternalId, request));
    }
    ...
    private List<WorkingCapitalLoanBreachActionData> retrieveBreachActions(final Long loanId) {
        final List<WorkingCapitalLoanBreachActionData> actions = ok(
                () -> corevanceClient.workingCapitalLoanBreachActions().retrieveBreachActions(loanId));
    ...
    private List<WorkingCapitalLoanBreachActionData> retrieveBreachActionsByExternalId(final String loanExternalId) {
        final List<WorkingCapitalLoanBreachActionData> actions = ok(
                () -> corevanceClient.workingCapitalLoanBreachActions().retrieveBreachActionsByExternalId(loanExternalId));
