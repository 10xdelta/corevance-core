...
import com.corevance.test.messaging.event.loan.LoanScheduleVariationsAddedEvent;
import com.corevance.test.messaging.event.loan.LoanScheduleVariationsDeletedEvent;
...
public class LoanInterestPauseStepDef extends AbstractStepDef {
    ...
    public void interestPauseCreate(final String startDate, final String endDate) throws IOException {
        ...
        final CommandProcessingResult interestPauseResponse = ok(
                () -> corevanceClient.loanInterestPause().createLoanInterestPause(loanId, interestPauseRequest));
    ...
    public void interestPauseDelete() throws IOException {
        ...
        executeVoid(() -> corevanceClient.loanInterestPause().deleteLoanInterestPause(loanId, variationId));
    }
    ...
    public void interestPauseUpdate(final String startDate, final String endDate) throws IOException {
        ...
        final InterestPauseRequestDto interestPauseRequest = loanRequestFactory.defaultInterestPauseRequest().startDate(startDate)
                .endDate(endDate);
        ok(() -> corevanceClient.loanInterestPause().updateLoanInterestPause(loanId, variationId, interestPauseRequest));
    }
    ...
    private boolean isInterestPauseWithDates(final com.corevance.avro.loan.v1.LoanTermVariationsDataV1 variation,
