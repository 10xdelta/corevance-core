 ...
 * under the License.
 */
package com.corevance.test.stepdef.account;
...
import com.corevance.client.models.PostAccountTransfersResponse;
...
public class AccountTransferStepDef extends AbstractStepDef {
    ...
    public void undoAccountTransfer() {
        ...
        ok(() -> corevanceClient.accountTransfers().accountTransferOperation(response.getResourceId(), "undo"));
    }
    ...
    public void undoAccountTransferFail() {
        ...
        CallFailedRuntimeException exception = fail(
                () -> corevanceClient.accountTransfers().accountTransferOperation(response.getResourceId(), "undo"));
    ...
    private void createAccountTransfer(long clientId, long fromAccountId, String fromAccountType, long toAccountId, String toAccountType,
        ...
        PostAccountTransfersResponse response = ok(() -> corevanceClient.accountTransfers().createAccountTransfer(request));
