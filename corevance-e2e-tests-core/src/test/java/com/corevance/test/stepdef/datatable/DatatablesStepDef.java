 ...
 * under the License.
 */
package com.corevance.test.stepdef.datatable;
...
import com.corevance.client.models.GetDataTablesResponse;
import com.corevance.client.models.PostColumnHeaderData;
import com.corevance.client.models.PostDataTablesAppTableIdResponse;
import com.corevance.client.models.PostDataTablesRequest;
import com.corevance.client.models.PostDataTablesResponse;
...
import com.corevance.client.models.PutDataTablesRequest;
import com.corevance.client.models.PutDataTablesRequestAddColumns;
import com.corevance.client.models.PutDataTablesRequestChangeColumns;
import com.corevance.client.models.PutDataTablesRequestDropColumns;
import com.corevance.client.models.ResultsetColumnHeaderData;
import com.corevance.test.data.datatable.DatatableColumnType;
import com.corevance.test.data.datatable.DatatableEntityType;
import com.corevance.test.data.datatable.DatatableNameGenerator;
...
public class DatatablesStepDef extends AbstractStepDef {
    ...
    public void whenDatatableCreated(final String entityTypeStr) {
        ...
        final PostDataTablesResponse response = ok(() -> corevanceClient.dataTables().createDatatable(request, Map.of()));
    ...
    public void thenCreateDatatableWithReservedColumnRejected(final String entityTypeStr, final String columnName,
        ...
        final CallFailedRuntimeException ex = fail(() -> corevanceClient.dataTables().createDatatable(request, Map.of()));
    ...
    public void thenColumnsMatch(final DataTable dataTable) {
        ...
        final GetDataTablesResponse response = ok(() -> corevanceClient.dataTables().getDatatable(datatableName, Map.of()));
    ...
    public void whenQueryEndpointCalled(final String columnFilter, final String valueFilter) {
        try {
            corevanceClient.dataTables().queryValues(currentDatatable(),
    ...
    public void thenListingByApptableIncludesCreated(final String apptable) {
        final String datatableName = currentDatatable();
        final List<GetDataTablesResponse> response = ok(() -> corevanceClient.dataTables().getDatatables(apptable, Map.of()));
    ...
    public void whenDatatableDeregistered() {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().deregisterDatatable(datatableName, Map.of()));
    }
    ...
    public void whenDatatableRegisteredAgainstApptable(final String apptable) {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().registerDatatable(datatableName, apptable, Map.of(), Map.of()));
    }

    @When("The datatable is deleted")
    public void whenDatatableDeleted() {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().deleteDatatable(datatableName, Map.of()));
    }
    ...
    public void whenColumnAdded(final String columnName, final String columnType) {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().updateDatatable(datatableName, addColumnRequest(columnName, columnType), Map.of()));
    }
    ...
    public void whenColumnRenamed(final String oldName, final String newName) {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().updateDatatable(datatableName, renameColumnRequest(oldName, newName), Map.of()));
    }

    @When("Column {string} is dropped from the datatable")
    public void whenColumnDropped(final String columnName) {
        final String datatableName = currentDatatable();
        ok(() -> corevanceClient.dataTables().updateDatatable(datatableName, dropColumnRequest(columnName), Map.of()));
    }
    ...
    public void thenAddColumnRejected(final String columnName, final String columnType, final int expectedStatus) {
        ...
        final CallFailedRuntimeException ex = fail(
                () -> corevanceClient.dataTables().updateDatatable(datatableName, addColumnRequest(columnName, columnType), Map.of()));
    ...
    public void thenRenameColumnRejected(final String oldName, final String newName, final int expectedStatus) {
        final String datatableName = currentDatatable();
        final CallFailedRuntimeException ex = fail(
                () -> corevanceClient.dataTables().updateDatatable(datatableName, renameColumnRequest(oldName, newName), Map.of()));
    ...
    public void thenDropColumnRejected(final String columnName, final int expectedStatus) {
        final String datatableName = currentDatatable();
        final CallFailedRuntimeException ex = fail(
                () -> corevanceClient.dataTables().updateDatatable(datatableName, dropColumnRequest(columnName), Map.of()));
    ...
    private void createDatatableEntry(final String entityTypeStr, final String columnName, final String value) {
        ...
        final PostDataTablesAppTableIdResponse response = ok(
                () -> corevanceClient.dataTables().createDatatableEntry(datatableName, entityId, body, Map.of()));
    ...
    public void whenEntryUpdated(final String entityTypeStr, final String value, final String columnName) {
        ...
        final Long entityId = resolveEntityId(entityType);
        final String body = buildEntryBodyJson(columnName, value);
        ok(() -> corevanceClient.dataTables().updateDatatableEntryOnetoOne(datatableName, entityId, body, Map.of()));
    }
    ...
    public void whenEntryDeleted(final String entityTypeStr) {
        ...
        final String datatableName = currentDatatable();
        final Long entityId = resolveEntityId(entityType);
        ok(() -> corevanceClient.dataTables().deleteDatatableEntries(datatableName, entityId, Map.of()));
    }
    ...
    public void whenMultirowEntryUpdatedById(final String entityTypeStr, final String value, final String columnName) {
        ...
        final String body = buildEntryBodyJson(columnName, value);
        ok(() -> corevanceClient.dataTables().updateDatatableEntryOneToMany(datatableName, entityId, entryId, body, Map.of()));
    }
    ...
    public void whenMultirowEntryDeletedById(final String entityTypeStr) {
        ...
        final Long entityId = resolveEntityId(entityType);
        final Long entryId = testContext().get(DATATABLE_ENTRY_ID);
        ok(() -> corevanceClient.dataTables().deleteDatatableEntry(datatableName, entityId, entryId, Map.of()));
    }
    ...
    public void thenMultirowEntryByIdHasValue(final String entityTypeStr, final String expectedValue, final String columnName) {
        ...
        final Object response = ok(
                () -> corevanceClient.dataTables().getDatatableManyEntry(datatableName, entityId, entryId, null, false, Map.of()));
    ...
    private List<Map<?, ?>> fetchEntryRows(final DatatableEntityType entityType) {
        final String datatableName = currentDatatable();
        final Long entityId = resolveEntityId(entityType);
        final Object response = ok(() -> corevanceClient.dataTables().getDatatableEntries(datatableName, entityId, (String) null, Map.of()));
