 ...
 * under the License.
 */
package com.corevance.command.jdbc.store;

import static java.nio.charset.StandardCharsets.UTF_8;
import static java.util.Objects.isNull;
import static com.corevance.command.core.CommandConstants.COMMAND_JSON_CLASS_ATTRIBUTE;
import static com.corevance.command.core.CommandState.UNKNOWN;
...
import com.corevance.command.core.CommandState;
import com.corevance.command.core.CommandStore;
import com.corevance.command.jdbc.JdbcCommandProperties;
import com.corevance.command.jdbc.store.domain.CommandEntity;
import com.corevance.command.jdbc.store.domain.CommandRepository;
...
public class JdbcCommandStore implements CommandStore {
    ...
    @Override
    public com.corevance.command.core.CommandState getStateById(Long id) {
